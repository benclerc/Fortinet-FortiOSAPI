...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://172.16.177.65/api/v2/cmdb';
    ...
    {
        $report  = 'PHP SDK (Fortigate\FortiOS) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://172.16.177.65/api/v2/cmdb",
