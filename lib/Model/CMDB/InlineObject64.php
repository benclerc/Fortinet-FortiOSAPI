 ...
 */
class InlineObject64 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject64., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject64., must be smaller than or equal to 255.');
        }
    ...
    public function setReplacemsgGroup($replacemsg_group)
    {
        if (!is_null($replacemsg_group) && (mb_strlen($replacemsg_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $replacemsg_group when calling InlineObject64., must be smaller than or equal to 35.');
        }
    ...
    public function setRules($rules)
    {
        ...
        if (!is_null($rules) && (count($rules) > 2000)) {
            throw new \InvalidArgumentException('invalid value for $rules when calling InlineObject64., number of items must be less than or equal to 2000.');
        }
