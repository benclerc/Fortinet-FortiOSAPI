...
/**
 * WafProfileNameParamLength Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class WafProfileNameParamLength implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_waf_profile__name__param_length';
     ...
     * Sets length
     *
     * @param int|null $length Maximum length of parameter in URL, HTTP POST request or HTTP body in bytes (0 to 2147483647).
     *
     * @return self
     */
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $length when calling WafProfileNameParamLength., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($length) && ($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling WafProfileNameParamLength., must be bigger than or equal to 0.');
        }
