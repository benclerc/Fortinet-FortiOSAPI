...
/**
 * InlineObject81 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject81 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_81';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject81., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject81., must be smaller than or equal to 255.');
        }
    ...
    public function setReplacemsgGroup($replacemsg_group)
    {
        if (!is_null($replacemsg_group) && (mb_strlen($replacemsg_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $replacemsg_group when calling InlineObject81., must be smaller than or equal to 35.');
        }
    ...
    public function setEntries($entries)
    {
        ...
        if (!is_null($entries) && (count($entries) > 0)) {
            throw new \InvalidArgumentException('invalid value for $entries when calling InlineObject81., number of items must be less than or equal to 0.');
        }
