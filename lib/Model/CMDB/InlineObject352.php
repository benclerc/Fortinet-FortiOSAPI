...
/**
 * InlineObject352 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject352 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_352';
    ...
    const APPLY_TO_ADMIN_PASSWORD = 'admin-password';
    const APPLY_TO_IPSEC_PRESHARED_KEY = 'ipsec-preshared-key';
    ...
    {
        return [
            self::APPLY_TO_ADMIN_PASSWORD,
            self::APPLY_TO_IPSEC_PRESHARED_KEY,
        ];
    }
     ...
     * Sets apply_to
     *
     * @param string|null $apply_to Apply password policy to administrator passwords or IPsec pre-shared keys or both. Separate entries with a space.    admin-password:Apply to administrator passwords.    ipsec-preshared-key:Apply to IPsec pre-shared keys.
     *
     * @return self
     */
    ...
    public function setMinimumLength($minimum_length)
    {
        ...
        if (!is_null($minimum_length) && ($minimum_length > 128)) {
            throw new \InvalidArgumentException('invalid value for $minimum_length when calling InlineObject352., must be smaller than or equal to 128.');
        }
        if (!is_null($minimum_length) && ($minimum_length < 8)) {
            throw new \InvalidArgumentException('invalid value for $minimum_length when calling InlineObject352., must be bigger than or equal to 8.');
        }
    ...
    public function setMinLowerCaseLetter($min_lower_case_letter)
    {
        ...
        if (!is_null($min_lower_case_letter) && ($min_lower_case_letter > 128)) {
            throw new \InvalidArgumentException('invalid value for $min_lower_case_letter when calling InlineObject352., must be smaller than or equal to 128.');
        }
        if (!is_null($min_lower_case_letter) && ($min_lower_case_letter < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_lower_case_letter when calling InlineObject352., must be bigger than or equal to 0.');
        }
    ...
    public function setMinUpperCaseLetter($min_upper_case_letter)
    {
        ...
        if (!is_null($min_upper_case_letter) && ($min_upper_case_letter > 128)) {
            throw new \InvalidArgumentException('invalid value for $min_upper_case_letter when calling InlineObject352., must be smaller than or equal to 128.');
        }
        if (!is_null($min_upper_case_letter) && ($min_upper_case_letter < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_upper_case_letter when calling InlineObject352., must be bigger than or equal to 0.');
        }
    ...
    public function setMinNonAlphanumeric($min_non_alphanumeric)
    {
        ...
        if (!is_null($min_non_alphanumeric) && ($min_non_alphanumeric > 128)) {
            throw new \InvalidArgumentException('invalid value for $min_non_alphanumeric when calling InlineObject352., must be smaller than or equal to 128.');
        }
        if (!is_null($min_non_alphanumeric) && ($min_non_alphanumeric < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_non_alphanumeric when calling InlineObject352., must be bigger than or equal to 0.');
        }
    ...
    public function setMinNumber($min_number)
    {
        ...
        if (!is_null($min_number) && ($min_number > 128)) {
            throw new \InvalidArgumentException('invalid value for $min_number when calling InlineObject352., must be smaller than or equal to 128.');
        }
        if (!is_null($min_number) && ($min_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_number when calling InlineObject352., must be bigger than or equal to 0.');
        }
    ...
    public function setExpireDay($expire_day)
    {
        ...
        if (!is_null($expire_day) && ($expire_day > 999)) {
            throw new \InvalidArgumentException('invalid value for $expire_day when calling InlineObject352., must be smaller than or equal to 999.');
        }
        if (!is_null($expire_day) && ($expire_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $expire_day when calling InlineObject352., must be bigger than or equal to 1.');
        }
