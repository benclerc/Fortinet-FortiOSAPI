...
/**
 * InlineObject428 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject428 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_428';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject428., must be smaller than or equal to 35.');
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject428., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject428., must be bigger than or equal to 0.');
        }
    ...
    public function setAuthtimeout($authtimeout)
    {
        ...
        if (!is_null($authtimeout) && ($authtimeout > 43200)) {
            throw new \InvalidArgumentException('invalid value for $authtimeout when calling InlineObject428., must be smaller than or equal to 43200.');
        }
        if (!is_null($authtimeout) && ($authtimeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $authtimeout when calling InlineObject428., must be bigger than or equal to 0.');
        }
    ...
    public function setAuthConcurrentValue($auth_concurrent_value)
    {
        ...
        if (!is_null($auth_concurrent_value) && ($auth_concurrent_value > 100)) {
            throw new \InvalidArgumentException('invalid value for $auth_concurrent_value when calling InlineObject428., must be smaller than or equal to 100.');
        }
        if (!is_null($auth_concurrent_value) && ($auth_concurrent_value < 0)) {
            throw new \InvalidArgumentException('invalid value for $auth_concurrent_value when calling InlineObject428., must be bigger than or equal to 0.');
        }
    ...
    public function setHttpDigestRealm($http_digest_realm)
    {
        if (!is_null($http_digest_realm) && (mb_strlen($http_digest_realm) > 35)) {
            throw new \InvalidArgumentException('invalid length for $http_digest_realm when calling InlineObject428., must be smaller than or equal to 35.');
        }
    ...
    public function setSsoAttributeValue($sso_attribute_value)
    {
        if (!is_null($sso_attribute_value) && (mb_strlen($sso_attribute_value) > 511)) {
            throw new \InvalidArgumentException('invalid length for $sso_attribute_value when calling InlineObject428., must be smaller than or equal to 511.');
        }
    ...
    public function setMember($member)
    {
        ...
        if (!is_null($member) && (count($member) > 3000)) {
            throw new \InvalidArgumentException('invalid value for $member when calling InlineObject428., number of items must be less than or equal to 3000.');
        }
    ...
    public function setMatch($match)
    {
        ...
        if (!is_null($match) && (count($match) > 0)) {
            throw new \InvalidArgumentException('invalid value for $match when calling InlineObject428., number of items must be less than or equal to 0.');
        }
    ...
    public function setSmsCustomServer($sms_custom_server)
    {
        if (!is_null($sms_custom_server) && (mb_strlen($sms_custom_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sms_custom_server when calling InlineObject428., must be smaller than or equal to 35.');
        }
    ...
    public function setExpire($expire)
    {
        ...
        if (!is_null($expire) && ($expire > 31536000)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling InlineObject428., must be smaller than or equal to 31536000.');
        }
        if (!is_null($expire) && ($expire < 1)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling InlineObject428., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxAccounts($max_accounts)
    {
        ...
        if (!is_null($max_accounts) && ($max_accounts > 500)) {
            throw new \InvalidArgumentException('invalid value for $max_accounts when calling InlineObject428., must be smaller than or equal to 500.');
        }
        if (!is_null($max_accounts) && ($max_accounts < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_accounts when calling InlineObject428., must be bigger than or equal to 0.');
        }
    ...
    public function setGuest($guest)
    {
        ...
        if (!is_null($guest) && (count($guest) > 500)) {
            throw new \InvalidArgumentException('invalid value for $guest when calling InlineObject428., number of items must be less than or equal to 500.');
        }
