...
/**
 * AntivirusProfileNameSmtp Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class AntivirusProfileNameSmtp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_antivirus_profile__name__smtp';
     ...
     * Sets options
     *
     * @param string|null $options Enable/disable SMTP AntiVirus scanning, monitoring, and quarantine.    scan:Enable SMTP antivirus scanning.    avmonitor:Enable SMTP antivirus logging.    quarantine:Enable SMTP antivirus quarantine. Files are quarantined depending on quarantine settings.
     *
     * @return self
     */
