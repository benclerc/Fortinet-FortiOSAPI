...
/**
 * InlineObject427 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject427 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_427';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject427., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject427., must be bigger than or equal to 0.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject427., must be smaller than or equal to 63.');
        }
    ...
    public function setDefaultDomain($default_domain)
    {
        if (!is_null($default_domain) && (mb_strlen($default_domain) > 35)) {
            throw new \InvalidArgumentException('invalid length for $default_domain when calling InlineObject427., must be smaller than or equal to 35.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject427., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject427., must be bigger than or equal to 0.');
        }
    ...
    public function setUser($user)
    {
        if (!is_null($user) && (mb_strlen($user) > 35)) {
            throw new \InvalidArgumentException('invalid length for $user when calling InlineObject427., must be smaller than or equal to 35.');
        }
    ...
    public function setLdapServer($ldap_server)
    {
        if (!is_null($ldap_server) && (mb_strlen($ldap_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ldap_server when calling InlineObject427., must be smaller than or equal to 35.');
        }
    ...
    public function setLogonHistory($logon_history)
    {
        ...
        if (!is_null($logon_history) && ($logon_history > 48)) {
            throw new \InvalidArgumentException('invalid value for $logon_history when calling InlineObject427., must be smaller than or equal to 48.');
        }
        if (!is_null($logon_history) && ($logon_history < 0)) {
            throw new \InvalidArgumentException('invalid value for $logon_history when calling InlineObject427., must be bigger than or equal to 0.');
        }
    ...
    public function setPollingFrequency($polling_frequency)
    {
        ...
        if (!is_null($polling_frequency) && ($polling_frequency > 30)) {
            throw new \InvalidArgumentException('invalid value for $polling_frequency when calling InlineObject427., must be smaller than or equal to 30.');
        }
        if (!is_null($polling_frequency) && ($polling_frequency < 1)) {
            throw new \InvalidArgumentException('invalid value for $polling_frequency when calling InlineObject427., must be bigger than or equal to 1.');
        }
    ...
    public function setAdgrp($adgrp)
    {
        ...
        if (!is_null($adgrp) && (count($adgrp) > 0)) {
            throw new \InvalidArgumentException('invalid value for $adgrp when calling InlineObject427., number of items must be less than or equal to 0.');
        }
