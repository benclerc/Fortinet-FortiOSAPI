...
class InlineObject62 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 19)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject62., must be smaller than or equal to 19.');
        }
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 19)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineObject62., must be smaller than or equal to 19.');
        }
    ...
    public function setExtName($ext_name)
    {
        if (!is_null($ext_name) && (mb_strlen($ext_name) > 31)) {
            throw new \InvalidArgumentException('invalid length for $ext_name when calling InlineObject62., must be smaller than or equal to 31.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject62., must be smaller than or equal to 255.');
        }
    ...
    public function setVdom($vdom)
    {
        ...
        if (!is_null($vdom) && ($vdom > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $vdom when calling InlineObject62., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($vdom) && ($vdom < 0)) {
            throw new \InvalidArgumentException('invalid value for $vdom when calling InlineObject62., must be bigger than or equal to 0.');
        }
    ...
    public function setControllerReport($controller_report)
    {
        ...
        if (!is_null($controller_report) && (count($controller_report) > 0)) {
            throw new \InvalidArgumentException('invalid value for $controller_report when calling InlineObject62., number of items must be less than or equal to 0.');
        }
    ...
    public function setModem1($modem1)
    {
        ...
        if (!is_null($modem1) && (count($modem1) > 0)) {
            throw new \InvalidArgumentException('invalid value for $modem1 when calling InlineObject62., number of items must be less than or equal to 0.');
        }
    ...
    public function setModem2($modem2)
    {
        ...
        if (!is_null($modem2) && (count($modem2) > 0)) {
            throw new \InvalidArgumentException('invalid value for $modem2 when calling InlineObject62., number of items must be less than or equal to 0.');
        }
