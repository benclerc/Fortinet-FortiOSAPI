...
/**
 * InlineObject569 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject569 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_569';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject569., must be smaller than or equal to 35.');
        }
    ...
    public function setUplinkSpeed($uplink_speed)
    {
        ...
        if (!is_null($uplink_speed) && ($uplink_speed > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $uplink_speed when calling InlineObject569., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($uplink_speed) && ($uplink_speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $uplink_speed when calling InlineObject569., must be bigger than or equal to 0.');
        }
    ...
    public function setDownlinkSpeed($downlink_speed)
    {
        ...
        if (!is_null($downlink_speed) && ($downlink_speed > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $downlink_speed when calling InlineObject569., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($downlink_speed) && ($downlink_speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $downlink_speed when calling InlineObject569., must be bigger than or equal to 0.');
        }
    ...
    public function setUplinkLoad($uplink_load)
    {
        ...
        if (!is_null($uplink_load) && ($uplink_load > 255)) {
            throw new \InvalidArgumentException('invalid value for $uplink_load when calling InlineObject569., must be smaller than or equal to 255.');
        }
        if (!is_null($uplink_load) && ($uplink_load < 0)) {
            throw new \InvalidArgumentException('invalid value for $uplink_load when calling InlineObject569., must be bigger than or equal to 0.');
        }
    ...
    public function setDownlinkLoad($downlink_load)
    {
        ...
        if (!is_null($downlink_load) && ($downlink_load > 255)) {
            throw new \InvalidArgumentException('invalid value for $downlink_load when calling InlineObject569., must be smaller than or equal to 255.');
        }
        if (!is_null($downlink_load) && ($downlink_load < 0)) {
            throw new \InvalidArgumentException('invalid value for $downlink_load when calling InlineObject569., must be bigger than or equal to 0.');
        }
    ...
    public function setLoadMeasurementDuration($load_measurement_duration)
    {
        ...
        if (!is_null($load_measurement_duration) && ($load_measurement_duration > 65535)) {
            throw new \InvalidArgumentException('invalid value for $load_measurement_duration when calling InlineObject569., must be smaller than or equal to 65535.');
        }
        if (!is_null($load_measurement_duration) && ($load_measurement_duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $load_measurement_duration when calling InlineObject569., must be bigger than or equal to 0.');
        }
