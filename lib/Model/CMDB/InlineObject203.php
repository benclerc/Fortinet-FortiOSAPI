 ...
 */
class InlineObject203 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSwitchId($switch_id)
    {
        if (!is_null($switch_id) && (mb_strlen($switch_id) > 16)) {
            throw new \InvalidArgumentException('invalid length for $switch_id when calling InlineObject203., must be smaller than or equal to 16.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject203., must be smaller than or equal to 35.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 63)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject203., must be smaller than or equal to 63.');
        }
    ...
    public function setSwitchProfile($switch_profile)
    {
        if (!is_null($switch_profile) && (mb_strlen($switch_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $switch_profile when calling InlineObject203., must be smaller than or equal to 35.');
        }
    ...
    public function setAccessProfile($access_profile)
    {
        if (!is_null($access_profile) && (mb_strlen($access_profile) > 31)) {
            throw new \InvalidArgumentException('invalid length for $access_profile when calling InlineObject203., must be smaller than or equal to 31.');
        }
    ...
    public function setFswWan1Peer($fsw_wan1_peer)
    {
        if (!is_null($fsw_wan1_peer) && (mb_strlen($fsw_wan1_peer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $fsw_wan1_peer when calling InlineObject203., must be smaller than or equal to 35.');
        }
    ...
    public function setPoeDetectionType($poe_detection_type)
    {
        ...
        if (!is_null($poe_detection_type) && ($poe_detection_type > 255)) {
            throw new \InvalidArgumentException('invalid value for $poe_detection_type when calling InlineObject203., must be smaller than or equal to 255.');
        }
        if (!is_null($poe_detection_type) && ($poe_detection_type < 0)) {
            throw new \InvalidArgumentException('invalid value for $poe_detection_type when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setDirectlyConnected($directly_connected)
    {
        ...
        if (!is_null($directly_connected) && ($directly_connected > 1)) {
            throw new \InvalidArgumentException('invalid value for $directly_connected when calling InlineObject203., must be smaller than or equal to 1.');
        }
        if (!is_null($directly_connected) && ($directly_connected < 0)) {
            throw new \InvalidArgumentException('invalid value for $directly_connected when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setVersion($version)
    {
        ...
        if (!is_null($version) && ($version > 255)) {
            throw new \InvalidArgumentException('invalid value for $version when calling InlineObject203., must be smaller than or equal to 255.');
        }
        if (!is_null($version) && ($version < 0)) {
            throw new \InvalidArgumentException('invalid value for $version when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxAllowedTrunkMembers($max_allowed_trunk_members)
    {
        ...
        if (!is_null($max_allowed_trunk_members) && ($max_allowed_trunk_members > 255)) {
            throw new \InvalidArgumentException('invalid value for $max_allowed_trunk_members when calling InlineObject203., must be smaller than or equal to 255.');
        }
        if (!is_null($max_allowed_trunk_members) && ($max_allowed_trunk_members < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_allowed_trunk_members when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setPreProvisioned($pre_provisioned)
    {
        ...
        if (!is_null($pre_provisioned) && ($pre_provisioned > 255)) {
            throw new \InvalidArgumentException('invalid value for $pre_provisioned when calling InlineObject203., must be smaller than or equal to 255.');
        }
        if (!is_null($pre_provisioned) && ($pre_provisioned < 0)) {
            throw new \InvalidArgumentException('invalid value for $pre_provisioned when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setL3Discovered($l3_discovered)
    {
        ...
        if (!is_null($l3_discovered) && ($l3_discovered > 1)) {
            throw new \InvalidArgumentException('invalid value for $l3_discovered when calling InlineObject203., must be smaller than or equal to 1.');
        }
        if (!is_null($l3_discovered) && ($l3_discovered < 0)) {
            throw new \InvalidArgumentException('invalid value for $l3_discovered when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setTdrSupported($tdr_supported)
    {
        if (!is_null($tdr_supported) && (mb_strlen($tdr_supported) > 31)) {
            throw new \InvalidArgumentException('invalid length for $tdr_supported when calling InlineObject203., must be smaller than or equal to 31.');
        }
    ...
    public function setSwitchDeviceTag($switch_device_tag)
    {
        if (!is_null($switch_device_tag) && (mb_strlen($switch_device_tag) > 32)) {
            throw new \InvalidArgumentException('invalid length for $switch_device_tag when calling InlineObject203., must be smaller than or equal to 32.');
        }
    ...
    public function setSwitchDhcpOpt43Key($switch_dhcp_opt43_key)
    {
        if (!is_null($switch_dhcp_opt43_key) && (mb_strlen($switch_dhcp_opt43_key) > 63)) {
            throw new \InvalidArgumentException('invalid length for $switch_dhcp_opt43_key when calling InlineObject203., must be smaller than or equal to 63.');
        }
    ...
    public function setDynamicallyDiscovered($dynamically_discovered)
    {
        ...
        if (!is_null($dynamically_discovered) && ($dynamically_discovered > 1)) {
            throw new \InvalidArgumentException('invalid value for $dynamically_discovered when calling InlineObject203., must be smaller than or equal to 1.');
        }
        if (!is_null($dynamically_discovered) && ($dynamically_discovered < 0)) {
            throw new \InvalidArgumentException('invalid value for $dynamically_discovered when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setOwnerVdom($owner_vdom)
    {
        if (!is_null($owner_vdom) && (mb_strlen($owner_vdom) > 31)) {
            throw new \InvalidArgumentException('invalid length for $owner_vdom when calling InlineObject203., must be smaller than or equal to 31.');
        }
    ...
    public function setStagedImageVersion($staged_image_version)
    {
        if (!is_null($staged_image_version) && (mb_strlen($staged_image_version) > 127)) {
            throw new \InvalidArgumentException('invalid length for $staged_image_version when calling InlineObject203., must be smaller than or equal to 127.');
        }
    ...
    public function setDelayedRestartTrigger($delayed_restart_trigger)
    {
        ...
        if (!is_null($delayed_restart_trigger) && ($delayed_restart_trigger > 255)) {
            throw new \InvalidArgumentException('invalid value for $delayed_restart_trigger when calling InlineObject203., must be smaller than or equal to 255.');
        }
        if (!is_null($delayed_restart_trigger) && ($delayed_restart_trigger < 0)) {
            throw new \InvalidArgumentException('invalid value for $delayed_restart_trigger when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setPorts($ports)
    {
        ...
        if (!is_null($ports) && (count($ports) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ports when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setIpSourceGuard($ip_source_guard)
    {
        ...
        if (!is_null($ip_source_guard) && (count($ip_source_guard) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ip_source_guard when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setStpSettings($stp_settings)
    {
        ...
        if (!is_null($stp_settings) && (count($stp_settings) > 0)) {
            throw new \InvalidArgumentException('invalid value for $stp_settings when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setStpInstance($stp_instance)
    {
        ...
        if (!is_null($stp_instance) && (count($stp_instance) > 0)) {
            throw new \InvalidArgumentException('invalid value for $stp_instance when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setSnmpSysinfo($snmp_sysinfo)
    {
        ...
        if (!is_null($snmp_sysinfo) && (count($snmp_sysinfo) > 0)) {
            throw new \InvalidArgumentException('invalid value for $snmp_sysinfo when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setSnmpTrapThreshold($snmp_trap_threshold)
    {
        ...
        if (!is_null($snmp_trap_threshold) && (count($snmp_trap_threshold) > 0)) {
            throw new \InvalidArgumentException('invalid value for $snmp_trap_threshold when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setSnmpCommunity($snmp_community)
    {
        ...
        if (!is_null($snmp_community) && (count($snmp_community) > 0)) {
            throw new \InvalidArgumentException('invalid value for $snmp_community when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setSnmpUser($snmp_user)
    {
        ...
        if (!is_null($snmp_user) && (count($snmp_user) > 0)) {
            throw new \InvalidArgumentException('invalid value for $snmp_user when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setQosRedProbability($qos_red_probability)
    {
        ...
        if (!is_null($qos_red_probability) && ($qos_red_probability > 100)) {
            throw new \InvalidArgumentException('invalid value for $qos_red_probability when calling InlineObject203., must be smaller than or equal to 100.');
        }
        if (!is_null($qos_red_probability) && ($qos_red_probability < 0)) {
            throw new \InvalidArgumentException('invalid value for $qos_red_probability when calling InlineObject203., must be bigger than or equal to 0.');
        }
    ...
    public function setSwitchLog($switch_log)
    {
        ...
        if (!is_null($switch_log) && (count($switch_log) > 0)) {
            throw new \InvalidArgumentException('invalid value for $switch_log when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setRemoteLog($remote_log)
    {
        ...
        if (!is_null($remote_log) && (count($remote_log) > 0)) {
            throw new \InvalidArgumentException('invalid value for $remote_log when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setStormControl($storm_control)
    {
        ...
        if (!is_null($storm_control) && (count($storm_control) > 0)) {
            throw new \InvalidArgumentException('invalid value for $storm_control when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setMirror($mirror)
    {
        ...
        if (!is_null($mirror) && (count($mirror) > 0)) {
            throw new \InvalidArgumentException('invalid value for $mirror when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setStaticMac($static_mac)
    {
        ...
        if (!is_null($static_mac) && (count($static_mac) > 0)) {
            throw new \InvalidArgumentException('invalid value for $static_mac when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setCustomCommand($custom_command)
    {
        ...
        if (!is_null($custom_command) && (count($custom_command) > 0)) {
            throw new \InvalidArgumentException('invalid value for $custom_command when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function setIgmpSnooping($igmp_snooping)
    {
        ...
        if (!is_null($igmp_snooping) && (count($igmp_snooping) > 0)) {
            throw new \InvalidArgumentException('invalid value for $igmp_snooping when calling InlineObject203., number of items must be less than or equal to 0.');
        }
    ...
    public function set8021XSettings($_802_1_x_settings)
    {
        ...
        if (!is_null($_802_1_x_settings) && (count($_802_1_x_settings) > 0)) {
            throw new \InvalidArgumentException('invalid value for $_802_1_x_settings when calling InlineObject203., number of items must be less than or equal to 0.');
        }
