...
/**
 * InlineObject525 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject525 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_525';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject525., must be smaller than or equal to 63.');
        }
    ...
    public function setHeaders($headers)
    {
        ...
        if (!is_null($headers) && (count($headers) > 0)) {
            throw new \InvalidArgumentException('invalid value for $headers when calling InlineObject525., number of items must be less than or equal to 0.');
        }
