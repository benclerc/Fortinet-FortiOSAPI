<?php
/**
 * WirelessControllerWtpWtpIdRadio1
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * WirelessControllerWtpWtpIdRadio1 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class WirelessControllerWtpWtpIdRadio1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_wireless_controller_wtp__wtp_id__radio_1';
    ...
    public function setAutoPowerHigh($auto_power_high)
    {
        ...
        if (!is_null($auto_power_high) && ($auto_power_high > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_high when calling WirelessControllerWtpWtpIdRadio1., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_power_high) && ($auto_power_high < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_high when calling WirelessControllerWtpWtpIdRadio1., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoPowerLow($auto_power_low)
    {
        ...
        if (!is_null($auto_power_low) && ($auto_power_low > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_low when calling WirelessControllerWtpWtpIdRadio1., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_power_low) && ($auto_power_low < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_low when calling WirelessControllerWtpWtpIdRadio1., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoPowerTarget($auto_power_target)
    {
        if (!is_null($auto_power_target) && (mb_strlen($auto_power_target) > 7)) {
            throw new \InvalidArgumentException('invalid length for $auto_power_target when calling WirelessControllerWtpWtpIdRadio1., must be smaller than or equal to 7.');
        }
    ...
    public function setPowerLevel($power_level)
    {
        ...
        if (!is_null($power_level) && ($power_level > 100)) {
            throw new \InvalidArgumentException('invalid value for $power_level when calling WirelessControllerWtpWtpIdRadio1., must be smaller than or equal to 100.');
        }
        if (!is_null($power_level) && ($power_level < 0)) {
            throw new \InvalidArgumentException('invalid value for $power_level when calling WirelessControllerWtpWtpIdRadio1., must be bigger than or equal to 0.');
        }
    ...
    public function setVaps($vaps)
    {
        ...
        if (!is_null($vaps) && (count($vaps) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vaps when calling WirelessControllerWtpWtpIdRadio1., number of items must be less than or equal to 0.');
        }
    ...
    public function setChannel($channel)
    {
        ...
        if (!is_null($channel) && (count($channel) > 0)) {
            throw new \InvalidArgumentException('invalid value for $channel when calling WirelessControllerWtpWtpIdRadio1., number of items must be less than or equal to 0.');
        }
