...
/**
 * InlineObject484 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject484 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_484';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject484., must be smaller than or equal to 35.');
        }
    ...
    public function setPhase1name($phase1name)
    {
        if (!is_null($phase1name) && (mb_strlen($phase1name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $phase1name when calling InlineObject484., must be smaller than or equal to 15.');
        }
    ...
    public function setKeylifeseconds($keylifeseconds)
    {
        ...
        if (!is_null($keylifeseconds) && ($keylifeseconds > 172800)) {
            throw new \InvalidArgumentException('invalid value for $keylifeseconds when calling InlineObject484., must be smaller than or equal to 172800.');
        }
        if (!is_null($keylifeseconds) && ($keylifeseconds < 120)) {
            throw new \InvalidArgumentException('invalid value for $keylifeseconds when calling InlineObject484., must be bigger than or equal to 120.');
        }
    ...
    public function setKeylifekbs($keylifekbs)
    {
        ...
        if (!is_null($keylifekbs) && ($keylifekbs > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $keylifekbs when calling InlineObject484., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($keylifekbs) && ($keylifekbs < 5120)) {
            throw new \InvalidArgumentException('invalid value for $keylifekbs when calling InlineObject484., must be bigger than or equal to 5120.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject484., must be smaller than or equal to 255.');
        }
    ...
    public function setProtocol($protocol)
    {
        ...
        if (!is_null($protocol) && ($protocol > 255)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject484., must be smaller than or equal to 255.');
        }
        if (!is_null($protocol) && ($protocol < 0)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject484., must be bigger than or equal to 0.');
        }
    ...
    public function setSrcName($src_name)
    {
        if (!is_null($src_name) && (mb_strlen($src_name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $src_name when calling InlineObject484., must be smaller than or equal to 79.');
        }
    ...
    public function setSrcName6($src_name6)
    {
        if (!is_null($src_name6) && (mb_strlen($src_name6) > 79)) {
            throw new \InvalidArgumentException('invalid length for $src_name6 when calling InlineObject484., must be smaller than or equal to 79.');
        }
    ...
    public function setSrcPort($src_port)
    {
        ...
        if (!is_null($src_port) && ($src_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $src_port when calling InlineObject484., must be smaller than or equal to 65535.');
        }
        if (!is_null($src_port) && ($src_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $src_port when calling InlineObject484., must be bigger than or equal to 0.');
        }
    ...
    public function setDstName($dst_name)
    {
        if (!is_null($dst_name) && (mb_strlen($dst_name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $dst_name when calling InlineObject484., must be smaller than or equal to 79.');
        }
    ...
    public function setDstName6($dst_name6)
    {
        if (!is_null($dst_name6) && (mb_strlen($dst_name6) > 79)) {
            throw new \InvalidArgumentException('invalid length for $dst_name6 when calling InlineObject484., must be smaller than or equal to 79.');
        }
    ...
    public function setDstPort($dst_port)
    {
        ...
        if (!is_null($dst_port) && ($dst_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $dst_port when calling InlineObject484., must be smaller than or equal to 65535.');
        }
        if (!is_null($dst_port) && ($dst_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $dst_port when calling InlineObject484., must be bigger than or equal to 0.');
        }
