...
class InlineObject9 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject9., must be smaller than or equal to 63.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject9., must be smaller than or equal to 255.');
        }
    ...
    public function setApplication($application)
    {
        ...
        if (!is_null($application) && (count($application) > 0)) {
            throw new \InvalidArgumentException('invalid value for $application when calling InlineObject9., number of items must be less than or equal to 0.');
        }
    ...
    public function setCategory($category)
    {
        ...
        if (!is_null($category) && (count($category) > 0)) {
            throw new \InvalidArgumentException('invalid value for $category when calling InlineObject9., number of items must be less than or equal to 0.');
        }
