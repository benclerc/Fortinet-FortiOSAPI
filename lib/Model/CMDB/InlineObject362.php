...
/**
 * InlineObject362 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject362 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_362';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject362., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject362., must be smaller than or equal to 255.');
        }
    ...
    public function setMail($mail)
    {
        ...
        if (!is_null($mail) && (count($mail) > 0)) {
            throw new \InvalidArgumentException('invalid value for $mail when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setHttp($http)
    {
        ...
        if (!is_null($http) && (count($http) > 0)) {
            throw new \InvalidArgumentException('invalid value for $http when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setWebproxy($webproxy)
    {
        ...
        if (!is_null($webproxy) && (count($webproxy) > 0)) {
            throw new \InvalidArgumentException('invalid value for $webproxy when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setFtp($ftp)
    {
        ...
        if (!is_null($ftp) && (count($ftp) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ftp when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setFortiguardWf($fortiguard_wf)
    {
        ...
        if (!is_null($fortiguard_wf) && (count($fortiguard_wf) > 0)) {
            throw new \InvalidArgumentException('invalid value for $fortiguard_wf when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setSpam($spam)
    {
        ...
        if (!is_null($spam) && (count($spam) > 0)) {
            throw new \InvalidArgumentException('invalid value for $spam when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setAlertmail($alertmail)
    {
        ...
        if (!is_null($alertmail) && (count($alertmail) > 0)) {
            throw new \InvalidArgumentException('invalid value for $alertmail when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setAdmin($admin)
    {
        ...
        if (!is_null($admin) && (count($admin) > 0)) {
            throw new \InvalidArgumentException('invalid value for $admin when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setAuth($auth)
    {
        ...
        if (!is_null($auth) && (count($auth) > 0)) {
            throw new \InvalidArgumentException('invalid value for $auth when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setSslvpn($sslvpn)
    {
        ...
        if (!is_null($sslvpn) && (count($sslvpn) > 0)) {
            throw new \InvalidArgumentException('invalid value for $sslvpn when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setNacQuar($nac_quar)
    {
        ...
        if (!is_null($nac_quar) && (count($nac_quar) > 0)) {
            throw new \InvalidArgumentException('invalid value for $nac_quar when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setTrafficQuota($traffic_quota)
    {
        ...
        if (!is_null($traffic_quota) && (count($traffic_quota) > 0)) {
            throw new \InvalidArgumentException('invalid value for $traffic_quota when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setUtm($utm)
    {
        ...
        if (!is_null($utm) && (count($utm) > 0)) {
            throw new \InvalidArgumentException('invalid value for $utm when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setCustomMessage($custom_message)
    {
        ...
        if (!is_null($custom_message) && (count($custom_message) > 0)) {
            throw new \InvalidArgumentException('invalid value for $custom_message when calling InlineObject362., number of items must be less than or equal to 0.');
        }
    ...
    public function setIcap($icap)
    {
        ...
        if (!is_null($icap) && (count($icap) > 0)) {
            throw new \InvalidArgumentException('invalid value for $icap when calling InlineObject362., number of items must be less than or equal to 0.');
        }
