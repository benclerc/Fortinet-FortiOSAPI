...
/**
 * InlineObject423 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject423 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_423';
    ...
    public function setSerialNumber($serial_number)
    {
        if (!is_null($serial_number) && (mb_strlen($serial_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling InlineObject423., must be smaller than or equal to 16.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject423., must be smaller than or equal to 255.');
        }
    ...
    public function setLicense($license)
    {
        if (!is_null($license) && (mb_strlen($license) > 31)) {
            throw new \InvalidArgumentException('invalid length for $license when calling InlineObject423., must be smaller than or equal to 31.');
        }
    ...
    public function setActivationCode($activation_code)
    {
        if (!is_null($activation_code) && (mb_strlen($activation_code) > 32)) {
            throw new \InvalidArgumentException('invalid length for $activation_code when calling InlineObject423., must be smaller than or equal to 32.');
        }
    ...
    public function setActivationExpire($activation_expire)
    {
        ...
        if (!is_null($activation_expire) && ($activation_expire > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $activation_expire when calling InlineObject423., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($activation_expire) && ($activation_expire < 0)) {
            throw new \InvalidArgumentException('invalid value for $activation_expire when calling InlineObject423., must be bigger than or equal to 0.');
        }
    ...
    public function setRegId($reg_id)
    {
        if (!is_null($reg_id) && (mb_strlen($reg_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $reg_id when calling InlineObject423., must be smaller than or equal to 256.');
        }
    ...
    public function setOsVer($os_ver)
    {
        if (!is_null($os_ver) && (mb_strlen($os_ver) > 15)) {
            throw new \InvalidArgumentException('invalid length for $os_ver when calling InlineObject423., must be smaller than or equal to 15.');
        }
