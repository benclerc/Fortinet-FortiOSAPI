 ...
 */
class InlineObject206 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject206., must be smaller than or equal to 35.');
        }
    ...
    public function setInactiveTimer($inactive_timer)
    {
        ...
        if (!is_null($inactive_timer) && ($inactive_timer > 1440)) {
            throw new \InvalidArgumentException('invalid value for $inactive_timer when calling InlineObject206., must be smaller than or equal to 1440.');
        }
        if (!is_null($inactive_timer) && ($inactive_timer < 0)) {
            throw new \InvalidArgumentException('invalid value for $inactive_timer when calling InlineObject206., must be bigger than or equal to 0.');
        }
    ...
    public function setOnboardingVlan($onboarding_vlan)
    {
        if (!is_null($onboarding_vlan) && (mb_strlen($onboarding_vlan) > 15)) {
            throw new \InvalidArgumentException('invalid length for $onboarding_vlan when calling InlineObject206., must be smaller than or equal to 15.');
        }
