...
/**
 * InlineObject94 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject94 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_94';
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 127)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject94., must be smaller than or equal to 127.');
        }
    ...
    public function setSerial($serial)
    {
        ...
        if (!is_null($serial) && (count($serial) > 8)) {
            throw new \InvalidArgumentException('invalid value for $serial when calling InlineObject94., number of items must be less than or equal to 8.');
        }
    ...
    public function setConnTimeout($conn_timeout)
    {
        ...
        if (!is_null($conn_timeout) && ($conn_timeout > 3600)) {
            throw new \InvalidArgumentException('invalid value for $conn_timeout when calling InlineObject94., must be smaller than or equal to 3600.');
        }
        if (!is_null($conn_timeout) && ($conn_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $conn_timeout when calling InlineObject94., must be bigger than or equal to 1.');
        }
    ...
    public function setMonitorKeepalivePeriod($monitor_keepalive_period)
    {
        ...
        if (!is_null($monitor_keepalive_period) && ($monitor_keepalive_period > 120)) {
            throw new \InvalidArgumentException('invalid value for $monitor_keepalive_period when calling InlineObject94., must be smaller than or equal to 120.');
        }
        if (!is_null($monitor_keepalive_period) && ($monitor_keepalive_period < 1)) {
            throw new \InvalidArgumentException('invalid value for $monitor_keepalive_period when calling InlineObject94., must be bigger than or equal to 1.');
        }
    ...
    public function setMonitorFailureRetryPeriod($monitor_failure_retry_period)
    {
        ...
        if (!is_null($monitor_failure_retry_period) && ($monitor_failure_retry_period > 86400)) {
            throw new \InvalidArgumentException('invalid value for $monitor_failure_retry_period when calling InlineObject94., must be smaller than or equal to 86400.');
        }
        if (!is_null($monitor_failure_retry_period) && ($monitor_failure_retry_period < 1)) {
            throw new \InvalidArgumentException('invalid value for $monitor_failure_retry_period when calling InlineObject94., must be bigger than or equal to 1.');
        }
    ...
    public function setCertificate($certificate)
    {
        if (!is_null($certificate) && (mb_strlen($certificate) > 35)) {
            throw new \InvalidArgumentException('invalid length for $certificate when calling InlineObject94., must be smaller than or equal to 35.');
        }
    ...
    public function setSourceIp($source_ip)
    {
        if (!is_null($source_ip) && (mb_strlen($source_ip) > 63)) {
            throw new \InvalidArgumentException('invalid length for $source_ip when calling InlineObject94., must be smaller than or equal to 63.');
        }
    ...
    public function setMaxLogRate($max_log_rate)
    {
        ...
        if (!is_null($max_log_rate) && ($max_log_rate > 100000)) {
            throw new \InvalidArgumentException('invalid value for $max_log_rate when calling InlineObject94., must be smaller than or equal to 100000.');
        }
        if (!is_null($max_log_rate) && ($max_log_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_log_rate when calling InlineObject94., must be bigger than or equal to 0.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject94., must be smaller than or equal to 15.');
        }
