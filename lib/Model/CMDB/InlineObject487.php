...
/**
 * InlineObject487 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject487 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_487';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject487., must be smaller than or equal to 35.');
        }
    ...
    public function setIpPools($ip_pools)
    {
        ...
        if (!is_null($ip_pools) && (count($ip_pools) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ip_pools when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setSplitTunnelingRoutingAddress($split_tunneling_routing_address)
    {
        ...
        if (!is_null($split_tunneling_routing_address) && (count($split_tunneling_routing_address) > 0)) {
            throw new \InvalidArgumentException('invalid value for $split_tunneling_routing_address when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setDnsSuffix($dns_suffix)
    {
        if (!is_null($dns_suffix) && (mb_strlen($dns_suffix) > 253)) {
            throw new \InvalidArgumentException('invalid length for $dns_suffix when calling InlineObject487., must be smaller than or equal to 253.');
        }
    ...
    public function setIpv6Pools($ipv6_pools)
    {
        ...
        if (!is_null($ipv6_pools) && (count($ipv6_pools) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ipv6_pools when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setIpv6SplitTunnelingRoutingAddress($ipv6_split_tunneling_routing_address)
    {
        ...
        if (!is_null($ipv6_split_tunneling_routing_address) && (count($ipv6_split_tunneling_routing_address) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ipv6_split_tunneling_routing_address when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setBookmarkGroup($bookmark_group)
    {
        ...
        if (!is_null($bookmark_group) && (count($bookmark_group) > 0)) {
            throw new \InvalidArgumentException('invalid value for $bookmark_group when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setHeading($heading)
    {
        if (!is_null($heading) && (mb_strlen($heading) > 31)) {
            throw new \InvalidArgumentException('invalid length for $heading when calling InlineObject487., must be smaller than or equal to 31.');
        }
    ...
    public function setRedirUrl($redir_url)
    {
        if (!is_null($redir_url) && (mb_strlen($redir_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $redir_url when calling InlineObject487., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomLang($custom_lang)
    {
        if (!is_null($custom_lang) && (mb_strlen($custom_lang) > 35)) {
            throw new \InvalidArgumentException('invalid length for $custom_lang when calling InlineObject487., must be smaller than or equal to 35.');
        }
    ...
    public function setHostCheckInterval($host_check_interval)
    {
        ...
        if (!is_null($host_check_interval) && ($host_check_interval > 259200)) {
            throw new \InvalidArgumentException('invalid value for $host_check_interval when calling InlineObject487., must be smaller than or equal to 259200.');
        }
        if (!is_null($host_check_interval) && ($host_check_interval < 120)) {
            throw new \InvalidArgumentException('invalid value for $host_check_interval when calling InlineObject487., must be bigger than or equal to 120.');
        }
    ...
    public function setHostCheckPolicy($host_check_policy)
    {
        ...
        if (!is_null($host_check_policy) && (count($host_check_policy) > 0)) {
            throw new \InvalidArgumentException('invalid value for $host_check_policy when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setMacAddrCheckRule($mac_addr_check_rule)
    {
        ...
        if (!is_null($mac_addr_check_rule) && (count($mac_addr_check_rule) > 0)) {
            throw new \InvalidArgumentException('invalid value for $mac_addr_check_rule when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setOsCheckList($os_check_list)
    {
        ...
        if (!is_null($os_check_list) && (count($os_check_list) > 0)) {
            throw new \InvalidArgumentException('invalid value for $os_check_list when calling InlineObject487., number of items must be less than or equal to 0.');
        }
    ...
    public function setWindowsForticlientDownloadUrl($windows_forticlient_download_url)
    {
        if (!is_null($windows_forticlient_download_url) && (mb_strlen($windows_forticlient_download_url) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $windows_forticlient_download_url when calling InlineObject487., must be smaller than or equal to 1023.');
        }
    ...
    public function setMacosForticlientDownloadUrl($macos_forticlient_download_url)
    {
        if (!is_null($macos_forticlient_download_url) && (mb_strlen($macos_forticlient_download_url) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $macos_forticlient_download_url when calling InlineObject487., must be smaller than or equal to 1023.');
        }
    ...
    public function setSplitDns($split_dns)
    {
        ...
        if (!is_null($split_dns) && (count($split_dns) > 0)) {
            throw new \InvalidArgumentException('invalid value for $split_dns when calling InlineObject487., number of items must be less than or equal to 0.');
        }
