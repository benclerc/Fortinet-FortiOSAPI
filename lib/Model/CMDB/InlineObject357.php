...
/**
 * InlineObject357 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject357 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_357';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject357., must be smaller than or equal to 15.');
        }
    ...
    public function setDevice($device)
    {
        if (!is_null($device) && (mb_strlen($device) > 15)) {
            throw new \InvalidArgumentException('invalid length for $device when calling InlineObject357., must be smaller than or equal to 15.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject357., must be smaller than or equal to 64.');
        }
    ...
    public function setIdleTimeout($idle_timeout)
    {
        ...
        if (!is_null($idle_timeout) && ($idle_timeout > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $idle_timeout when calling InlineObject357., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($idle_timeout) && ($idle_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $idle_timeout when calling InlineObject357., must be bigger than or equal to 0.');
        }
    ...
    public function setDiscRetryTimeout($disc_retry_timeout)
    {
        ...
        if (!is_null($disc_retry_timeout) && ($disc_retry_timeout > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $disc_retry_timeout when calling InlineObject357., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($disc_retry_timeout) && ($disc_retry_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $disc_retry_timeout when calling InlineObject357., must be bigger than or equal to 0.');
        }
    ...
    public function setPadtRetryTimeout($padt_retry_timeout)
    {
        ...
        if (!is_null($padt_retry_timeout) && ($padt_retry_timeout > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $padt_retry_timeout when calling InlineObject357., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($padt_retry_timeout) && ($padt_retry_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $padt_retry_timeout when calling InlineObject357., must be bigger than or equal to 0.');
        }
    ...
    public function setServiceName($service_name)
    {
        if (!is_null($service_name) && (mb_strlen($service_name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $service_name when calling InlineObject357., must be smaller than or equal to 63.');
        }
    ...
    public function setAcName($ac_name)
    {
        if (!is_null($ac_name) && (mb_strlen($ac_name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $ac_name when calling InlineObject357., must be smaller than or equal to 63.');
        }
    ...
    public function setLcpEchoInterval($lcp_echo_interval)
    {
        ...
        if (!is_null($lcp_echo_interval) && ($lcp_echo_interval > 32767)) {
            throw new \InvalidArgumentException('invalid value for $lcp_echo_interval when calling InlineObject357., must be smaller than or equal to 32767.');
        }
        if (!is_null($lcp_echo_interval) && ($lcp_echo_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $lcp_echo_interval when calling InlineObject357., must be bigger than or equal to 0.');
        }
    ...
    public function setLcpMaxEchoFails($lcp_max_echo_fails)
    {
        ...
        if (!is_null($lcp_max_echo_fails) && ($lcp_max_echo_fails > 32767)) {
            throw new \InvalidArgumentException('invalid value for $lcp_max_echo_fails when calling InlineObject357., must be smaller than or equal to 32767.');
        }
        if (!is_null($lcp_max_echo_fails) && ($lcp_max_echo_fails < 0)) {
            throw new \InvalidArgumentException('invalid value for $lcp_max_echo_fails when calling InlineObject357., must be bigger than or equal to 0.');
        }
