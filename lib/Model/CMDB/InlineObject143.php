...
class InlineObject143 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 71)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject143., must be smaller than or equal to 71.');
        }
    ...
    public function setFontSize($font_size)
    {
        if (!is_null($font_size) && (mb_strlen($font_size) > 15)) {
            throw new \InvalidArgumentException('invalid length for $font_size when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setLineHeight($line_height)
    {
        if (!is_null($line_height) && (mb_strlen($line_height) > 15)) {
            throw new \InvalidArgumentException('invalid length for $line_height when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setFgColor($fg_color)
    {
        if (!is_null($fg_color) && (mb_strlen($fg_color) > 15)) {
            throw new \InvalidArgumentException('invalid length for $fg_color when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setBgColor($bg_color)
    {
        if (!is_null($bg_color) && (mb_strlen($bg_color) > 15)) {
            throw new \InvalidArgumentException('invalid length for $bg_color when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setWidth($width)
    {
        if (!is_null($width) && (mb_strlen($width) > 15)) {
            throw new \InvalidArgumentException('invalid length for $width when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setHeight($height)
    {
        if (!is_null($height) && (mb_strlen($height) > 15)) {
            throw new \InvalidArgumentException('invalid length for $height when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setMarginTop($margin_top)
    {
        if (!is_null($margin_top) && (mb_strlen($margin_top) > 15)) {
            throw new \InvalidArgumentException('invalid length for $margin_top when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setMarginRight($margin_right)
    {
        if (!is_null($margin_right) && (mb_strlen($margin_right) > 15)) {
            throw new \InvalidArgumentException('invalid length for $margin_right when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setMarginBottom($margin_bottom)
    {
        if (!is_null($margin_bottom) && (mb_strlen($margin_bottom) > 15)) {
            throw new \InvalidArgumentException('invalid length for $margin_bottom when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setMarginLeft($margin_left)
    {
        if (!is_null($margin_left) && (mb_strlen($margin_left) > 15)) {
            throw new \InvalidArgumentException('invalid length for $margin_left when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setPaddingTop($padding_top)
    {
        if (!is_null($padding_top) && (mb_strlen($padding_top) > 15)) {
            throw new \InvalidArgumentException('invalid length for $padding_top when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setPaddingRight($padding_right)
    {
        if (!is_null($padding_right) && (mb_strlen($padding_right) > 15)) {
            throw new \InvalidArgumentException('invalid length for $padding_right when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setPaddingBottom($padding_bottom)
    {
        if (!is_null($padding_bottom) && (mb_strlen($padding_bottom) > 15)) {
            throw new \InvalidArgumentException('invalid length for $padding_bottom when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setPaddingLeft($padding_left)
    {
        if (!is_null($padding_left) && (mb_strlen($padding_left) > 15)) {
            throw new \InvalidArgumentException('invalid length for $padding_left when calling InlineObject143., must be smaller than or equal to 15.');
        }
    ...
    public function setColumnGap($column_gap)
    {
        if (!is_null($column_gap) && (mb_strlen($column_gap) > 15)) {
            throw new \InvalidArgumentException('invalid length for $column_gap when calling InlineObject143., must be smaller than or equal to 15.');
        }
