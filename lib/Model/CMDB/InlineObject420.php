...
/**
 * InlineObject420 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject420 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_420';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject420., must be smaller than or equal to 35.');
        }
    ...
    public function setServerName($server_name)
    {
        if (!is_null($server_name) && (mb_strlen($server_name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server_name when calling InlineObject420., must be smaller than or equal to 63.');
        }
    ...
    public function setDomainName($domain_name)
    {
        if (!is_null($domain_name) && (mb_strlen($domain_name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $domain_name when calling InlineObject420., must be smaller than or equal to 79.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject420., must be smaller than or equal to 64.');
        }
    ...
    public function setKdcIp($kdc_ip)
    {
        ...
        if (!is_null($kdc_ip) && (count($kdc_ip) > 0)) {
            throw new \InvalidArgumentException('invalid value for $kdc_ip when calling InlineObject420., number of items must be less than or equal to 0.');
        }
