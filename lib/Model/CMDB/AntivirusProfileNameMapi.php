...
/**
 * AntivirusProfileNameMapi Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class AntivirusProfileNameMapi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_antivirus_profile__name__mapi';
     ...
     * Sets options
     *
     * @param string|null $options Enable/disable MAPI AntiVirus scanning, monitoring, and quarantine.    scan:Enable MAPI antivirus scanning.    avmonitor:Enable MAPI antivirus logging.    quarantine:Enable MAPI antivirus quarantine. Files are quarantined depending on quarantine settings.
     *
     * @return self
     */
