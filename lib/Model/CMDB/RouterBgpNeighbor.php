...
/**
 * RouterBgpNeighbor Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class RouterBgpNeighbor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_router_bgp_neighbor';
    ...
    protected static $openAPITypes = [
        ...
        'password' => 'string',
        'conditional_advertise' => '\Fortigate\FortiOS\Model\CMDB\RouterBgpConditionalAdvertise[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'password' => 'password',
        'conditional_advertise' => 'conditional-advertise'
    ];
    ...
    protected static $setters = [
        ...
        'conditional_advertise' => 'setConditionalAdvertise'
    ];
    ...
    protected static $getters = [
        ...
        'conditional_advertise' => 'getConditionalAdvertise'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['conditional_advertise'] = $data['conditional_advertise'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['conditional_advertise']) && (count($this->container['conditional_advertise']) > 0)) {
            $invalidProperties[] = "invalid value for 'conditional_advertise', number of items must be less than or equal to 0.";
        }
    ...
    public function setIp($ip)
    {
        if (!is_null($ip) && (mb_strlen($ip) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling RouterBgpNeighbor., must be smaller than or equal to 45.');
        }
    ...
    public function setAdvertisementInterval($advertisement_interval)
    {
        ...
        if (!is_null($advertisement_interval) && ($advertisement_interval > 600)) {
            throw new \InvalidArgumentException('invalid value for $advertisement_interval when calling RouterBgpNeighbor., must be smaller than or equal to 600.');
        }
        if (!is_null($advertisement_interval) && ($advertisement_interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $advertisement_interval when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setAllowasIn($allowas_in)
    {
        ...
        if (!is_null($allowas_in) && ($allowas_in > 10)) {
            throw new \InvalidArgumentException('invalid value for $allowas_in when calling RouterBgpNeighbor., must be smaller than or equal to 10.');
        }
        if (!is_null($allowas_in) && ($allowas_in < 1)) {
            throw new \InvalidArgumentException('invalid value for $allowas_in when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setAllowasIn6($allowas_in6)
    {
        ...
        if (!is_null($allowas_in6) && ($allowas_in6 > 10)) {
            throw new \InvalidArgumentException('invalid value for $allowas_in6 when calling RouterBgpNeighbor., must be smaller than or equal to 10.');
        }
        if (!is_null($allowas_in6) && ($allowas_in6 < 1)) {
            throw new \InvalidArgumentException('invalid value for $allowas_in6 when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setDefaultOriginateRoutemap($default_originate_routemap)
    {
        if (!is_null($default_originate_routemap) && (mb_strlen($default_originate_routemap) > 35)) {
            throw new \InvalidArgumentException('invalid length for $default_originate_routemap when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setDefaultOriginateRoutemap6($default_originate_routemap6)
    {
        if (!is_null($default_originate_routemap6) && (mb_strlen($default_originate_routemap6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $default_originate_routemap6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 63)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RouterBgpNeighbor., must be smaller than or equal to 63.');
        }
    ...
    public function setDistributeListIn($distribute_list_in)
    {
        if (!is_null($distribute_list_in) && (mb_strlen($distribute_list_in) > 35)) {
            throw new \InvalidArgumentException('invalid length for $distribute_list_in when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setDistributeListIn6($distribute_list_in6)
    {
        if (!is_null($distribute_list_in6) && (mb_strlen($distribute_list_in6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $distribute_list_in6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setDistributeListOut($distribute_list_out)
    {
        if (!is_null($distribute_list_out) && (mb_strlen($distribute_list_out) > 35)) {
            throw new \InvalidArgumentException('invalid length for $distribute_list_out when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setDistributeListOut6($distribute_list_out6)
    {
        if (!is_null($distribute_list_out6) && (mb_strlen($distribute_list_out6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $distribute_list_out6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setEbgpMultihopTtl($ebgp_multihop_ttl)
    {
        ...
        if (!is_null($ebgp_multihop_ttl) && ($ebgp_multihop_ttl > 255)) {
            throw new \InvalidArgumentException('invalid value for $ebgp_multihop_ttl when calling RouterBgpNeighbor., must be smaller than or equal to 255.');
        }
        if (!is_null($ebgp_multihop_ttl) && ($ebgp_multihop_ttl < 1)) {
            throw new \InvalidArgumentException('invalid value for $ebgp_multihop_ttl when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setFilterListIn($filter_list_in)
    {
        if (!is_null($filter_list_in) && (mb_strlen($filter_list_in) > 35)) {
            throw new \InvalidArgumentException('invalid length for $filter_list_in when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setFilterListIn6($filter_list_in6)
    {
        if (!is_null($filter_list_in6) && (mb_strlen($filter_list_in6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $filter_list_in6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setFilterListOut($filter_list_out)
    {
        if (!is_null($filter_list_out) && (mb_strlen($filter_list_out) > 35)) {
            throw new \InvalidArgumentException('invalid length for $filter_list_out when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setFilterListOut6($filter_list_out6)
    {
        if (!is_null($filter_list_out6) && (mb_strlen($filter_list_out6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $filter_list_out6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling RouterBgpNeighbor., must be smaller than or equal to 15.');
        }
    ...
    public function setMaximumPrefix($maximum_prefix)
    {
        ...
        if (!is_null($maximum_prefix) && ($maximum_prefix > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix when calling RouterBgpNeighbor., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($maximum_prefix) && ($maximum_prefix < 1)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setMaximumPrefix6($maximum_prefix6)
    {
        ...
        if (!is_null($maximum_prefix6) && ($maximum_prefix6 > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix6 when calling RouterBgpNeighbor., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($maximum_prefix6) && ($maximum_prefix6 < 1)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix6 when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setMaximumPrefixThreshold($maximum_prefix_threshold)
    {
        ...
        if (!is_null($maximum_prefix_threshold) && ($maximum_prefix_threshold > 100)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix_threshold when calling RouterBgpNeighbor., must be smaller than or equal to 100.');
        }
        if (!is_null($maximum_prefix_threshold) && ($maximum_prefix_threshold < 1)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix_threshold when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setMaximumPrefixThreshold6($maximum_prefix_threshold6)
    {
        ...
        if (!is_null($maximum_prefix_threshold6) && ($maximum_prefix_threshold6 > 100)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix_threshold6 when calling RouterBgpNeighbor., must be smaller than or equal to 100.');
        }
        if (!is_null($maximum_prefix_threshold6) && ($maximum_prefix_threshold6 < 1)) {
            throw new \InvalidArgumentException('invalid value for $maximum_prefix_threshold6 when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setPrefixListIn($prefix_list_in)
    {
        if (!is_null($prefix_list_in) && (mb_strlen($prefix_list_in) > 35)) {
            throw new \InvalidArgumentException('invalid length for $prefix_list_in when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setPrefixListIn6($prefix_list_in6)
    {
        if (!is_null($prefix_list_in6) && (mb_strlen($prefix_list_in6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $prefix_list_in6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setPrefixListOut($prefix_list_out)
    {
        if (!is_null($prefix_list_out) && (mb_strlen($prefix_list_out) > 35)) {
            throw new \InvalidArgumentException('invalid length for $prefix_list_out when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setPrefixListOut6($prefix_list_out6)
    {
        if (!is_null($prefix_list_out6) && (mb_strlen($prefix_list_out6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $prefix_list_out6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setRemoteAs($remote_as)
    {
        ...
        if (!is_null($remote_as) && ($remote_as > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $remote_as when calling RouterBgpNeighbor., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($remote_as) && ($remote_as < 1)) {
            throw new \InvalidArgumentException('invalid value for $remote_as when calling RouterBgpNeighbor., must be bigger than or equal to 1.');
        }
    ...
    public function setLocalAs($local_as)
    {
        ...
        if (!is_null($local_as) && ($local_as > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $local_as when calling RouterBgpNeighbor., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($local_as) && ($local_as < 0)) {
            throw new \InvalidArgumentException('invalid value for $local_as when calling RouterBgpNeighbor., must be bigger than or equal to 0.');
        }
    ...
    public function setRetainStaleTime($retain_stale_time)
    {
        ...
        if (!is_null($retain_stale_time) && ($retain_stale_time > 65535)) {
            throw new \InvalidArgumentException('invalid value for $retain_stale_time when calling RouterBgpNeighbor., must be smaller than or equal to 65535.');
        }
        if (!is_null($retain_stale_time) && ($retain_stale_time < 0)) {
            throw new \InvalidArgumentException('invalid value for $retain_stale_time when calling RouterBgpNeighbor., must be bigger than or equal to 0.');
        }
    ...
    public function setRouteMapIn($route_map_in)
    {
        if (!is_null($route_map_in) && (mb_strlen($route_map_in) > 35)) {
            throw new \InvalidArgumentException('invalid length for $route_map_in when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setRouteMapIn6($route_map_in6)
    {
        if (!is_null($route_map_in6) && (mb_strlen($route_map_in6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $route_map_in6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setRouteMapOut($route_map_out)
    {
        if (!is_null($route_map_out) && (mb_strlen($route_map_out) > 35)) {
            throw new \InvalidArgumentException('invalid length for $route_map_out when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setRouteMapOutPreferable($route_map_out_preferable)
    {
        if (!is_null($route_map_out_preferable) && (mb_strlen($route_map_out_preferable) > 35)) {
            throw new \InvalidArgumentException('invalid length for $route_map_out_preferable when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setRouteMapOut6($route_map_out6)
    {
        if (!is_null($route_map_out6) && (mb_strlen($route_map_out6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $route_map_out6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setRouteMapOut6Preferable($route_map_out6_preferable)
    {
        if (!is_null($route_map_out6_preferable) && (mb_strlen($route_map_out6_preferable) > 35)) {
            throw new \InvalidArgumentException('invalid length for $route_map_out6_preferable when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setKeepAliveTimer($keep_alive_timer)
    {
        ...
        if (!is_null($keep_alive_timer) && ($keep_alive_timer > 65535)) {
            throw new \InvalidArgumentException('invalid value for $keep_alive_timer when calling RouterBgpNeighbor., must be smaller than or equal to 65535.');
        }
        if (!is_null($keep_alive_timer) && ($keep_alive_timer < 0)) {
            throw new \InvalidArgumentException('invalid value for $keep_alive_timer when calling RouterBgpNeighbor., must be bigger than or equal to 0.');
        }
    ...
    public function setHoldtimeTimer($holdtime_timer)
    {
        ...
        if (!is_null($holdtime_timer) && ($holdtime_timer > 65535)) {
            throw new \InvalidArgumentException('invalid value for $holdtime_timer when calling RouterBgpNeighbor., must be smaller than or equal to 65535.');
        }
        if (!is_null($holdtime_timer) && ($holdtime_timer < 3)) {
            throw new \InvalidArgumentException('invalid value for $holdtime_timer when calling RouterBgpNeighbor., must be bigger than or equal to 3.');
        }
    ...
    public function setConnectTimer($connect_timer)
    {
        ...
        if (!is_null($connect_timer) && ($connect_timer > 65535)) {
            throw new \InvalidArgumentException('invalid value for $connect_timer when calling RouterBgpNeighbor., must be smaller than or equal to 65535.');
        }
        if (!is_null($connect_timer) && ($connect_timer < 0)) {
            throw new \InvalidArgumentException('invalid value for $connect_timer when calling RouterBgpNeighbor., must be bigger than or equal to 0.');
        }
    ...
    public function setUnsuppressMap($unsuppress_map)
    {
        if (!is_null($unsuppress_map) && (mb_strlen($unsuppress_map) > 35)) {
            throw new \InvalidArgumentException('invalid length for $unsuppress_map when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setUnsuppressMap6($unsuppress_map6)
    {
        if (!is_null($unsuppress_map6) && (mb_strlen($unsuppress_map6) > 35)) {
            throw new \InvalidArgumentException('invalid length for $unsuppress_map6 when calling RouterBgpNeighbor., must be smaller than or equal to 35.');
        }
    ...
    public function setUpdateSource($update_source)
    {
        if (!is_null($update_source) && (mb_strlen($update_source) > 15)) {
            throw new \InvalidArgumentException('invalid length for $update_source when calling RouterBgpNeighbor., must be smaller than or equal to 15.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight > 65535)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling RouterBgpNeighbor., must be smaller than or equal to 65535.');
        }
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling RouterBgpNeighbor., must be bigger than or equal to 0.');
        }
    ...
    public function setRestartTime($restart_time)
    {
        ...
        if (!is_null($restart_time) && ($restart_time > 3600)) {
            throw new \InvalidArgumentException('invalid value for $restart_time when calling RouterBgpNeighbor., must be smaller than or equal to 3600.');
        }
        if (!is_null($restart_time) && ($restart_time < 0)) {
            throw new \InvalidArgumentException('invalid value for $restart_time when calling RouterBgpNeighbor., must be bigger than or equal to 0.');
        }
    ...
    public function setAdvAdditionalPath($adv_additional_path)
    {
        ...
        if (!is_null($adv_additional_path) && ($adv_additional_path > 255)) {
            throw new \InvalidArgumentException('invalid value for $adv_additional_path when calling RouterBgpNeighbor., must be smaller than or equal to 255.');
        }
        if (!is_null($adv_additional_path) && ($adv_additional_path < 2)) {
            throw new \InvalidArgumentException('invalid value for $adv_additional_path when calling RouterBgpNeighbor., must be bigger than or equal to 2.');
        }
    ...
    public function setAdvAdditionalPath6($adv_additional_path6)
    {
        ...
        if (!is_null($adv_additional_path6) && ($adv_additional_path6 > 255)) {
            throw new \InvalidArgumentException('invalid value for $adv_additional_path6 when calling RouterBgpNeighbor., must be smaller than or equal to 255.');
        }
        if (!is_null($adv_additional_path6) && ($adv_additional_path6 < 2)) {
            throw new \InvalidArgumentException('invalid value for $adv_additional_path6 when calling RouterBgpNeighbor., must be bigger than or equal to 2.');
        }
     ...
     * Sets password
     *
     * @param string|null $password Password used in MD5 authentication.
     *
     * @return self
     */
    ...
    /**
     * Gets conditional_advertise
     *
     * @return \Fortigate\FortiOS\Model\CMDB\RouterBgpConditionalAdvertise[]|null
     */
    public function getConditionalAdvertise()
    {
        return $this->container['conditional_advertise'];
    }

    /**
     * Sets conditional_advertise
     *
     * @param \Fortigate\FortiOS\Model\CMDB\RouterBgpConditionalAdvertise[]|null $conditional_advertise Conditional advertisement.
     *
     * @return self
     */
    public function setConditionalAdvertise($conditional_advertise)
    {

        if (!is_null($conditional_advertise) && (count($conditional_advertise) > 0)) {
            throw new \InvalidArgumentException('invalid value for $conditional_advertise when calling RouterBgpNeighbor., number of items must be less than or equal to 0.');
        }
        $this->container['conditional_advertise'] = $conditional_advertise;
