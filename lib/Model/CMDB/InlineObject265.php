...
/**
 * InlineObject265 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject265 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_265';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject265., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject265., must be smaller than or equal to 255.');
        }
    ...
    public function setNetgrpPermission($netgrp_permission)
    {
        ...
        if (!is_null($netgrp_permission) && (count($netgrp_permission) > 0)) {
            throw new \InvalidArgumentException('invalid value for $netgrp_permission when calling InlineObject265., number of items must be less than or equal to 0.');
        }
    ...
    public function setSysgrpPermission($sysgrp_permission)
    {
        ...
        if (!is_null($sysgrp_permission) && (count($sysgrp_permission) > 0)) {
            throw new \InvalidArgumentException('invalid value for $sysgrp_permission when calling InlineObject265., number of items must be less than or equal to 0.');
        }
    ...
    public function setFwgrpPermission($fwgrp_permission)
    {
        ...
        if (!is_null($fwgrp_permission) && (count($fwgrp_permission) > 0)) {
            throw new \InvalidArgumentException('invalid value for $fwgrp_permission when calling InlineObject265., number of items must be less than or equal to 0.');
        }
    ...
    public function setLoggrpPermission($loggrp_permission)
    {
        ...
        if (!is_null($loggrp_permission) && (count($loggrp_permission) > 0)) {
            throw new \InvalidArgumentException('invalid value for $loggrp_permission when calling InlineObject265., number of items must be less than or equal to 0.');
        }
    ...
    public function setUtmgrpPermission($utmgrp_permission)
    {
        ...
        if (!is_null($utmgrp_permission) && (count($utmgrp_permission) > 0)) {
            throw new \InvalidArgumentException('invalid value for $utmgrp_permission when calling InlineObject265., number of items must be less than or equal to 0.');
        }
    ...
    public function setAdmintimeout($admintimeout)
    {
        ...
        if (!is_null($admintimeout) && ($admintimeout > 480)) {
            throw new \InvalidArgumentException('invalid value for $admintimeout when calling InlineObject265., must be smaller than or equal to 480.');
        }
        if (!is_null($admintimeout) && ($admintimeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $admintimeout when calling InlineObject265., must be bigger than or equal to 1.');
        }
