...
/**
 * RouterRipngInterface Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class RouterRipngInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_router_ripng_interface';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RouterRipngInterface., must be smaller than or equal to 35.');
        }
    ...
    public function setFlags($flags)
    {
        ...
        if (!is_null($flags) && ($flags > 255)) {
            throw new \InvalidArgumentException('invalid value for $flags when calling RouterRipngInterface., must be smaller than or equal to 255.');
        }
        if (!is_null($flags) && ($flags < 0)) {
            throw new \InvalidArgumentException('invalid value for $flags when calling RouterRipngInterface., must be bigger than or equal to 0.');
        }
