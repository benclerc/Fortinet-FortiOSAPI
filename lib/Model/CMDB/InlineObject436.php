...
/**
 * InlineObject436 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject436 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_436';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject436., must be smaller than or equal to 63.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 63)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject436., must be smaller than or equal to 63.');
        }
    ...
    public function setMac($mac)
    {
        if (!is_null($mac) && (mb_strlen($mac) > 17)) {
            throw new \InvalidArgumentException('invalid length for $mac when calling InlineObject436., must be smaller than or equal to 17.');
        }
    ...
    public function setHwVendor($hw_vendor)
    {
        if (!is_null($hw_vendor) && (mb_strlen($hw_vendor) > 15)) {
            throw new \InvalidArgumentException('invalid length for $hw_vendor when calling InlineObject436., must be smaller than or equal to 15.');
        }
    ...
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 15)) {
            throw new \InvalidArgumentException('invalid length for $type when calling InlineObject436., must be smaller than or equal to 15.');
        }
    ...
    public function setFamily($family)
    {
        if (!is_null($family) && (mb_strlen($family) > 31)) {
            throw new \InvalidArgumentException('invalid length for $family when calling InlineObject436., must be smaller than or equal to 31.');
        }
    ...
    public function setOs($os)
    {
        if (!is_null($os) && (mb_strlen($os) > 31)) {
            throw new \InvalidArgumentException('invalid length for $os when calling InlineObject436., must be smaller than or equal to 31.');
        }
    ...
    public function setHwVersion($hw_version)
    {
        if (!is_null($hw_version) && (mb_strlen($hw_version) > 15)) {
            throw new \InvalidArgumentException('invalid length for $hw_version when calling InlineObject436., must be smaller than or equal to 15.');
        }
    ...
    public function setSwVersion($sw_version)
    {
        if (!is_null($sw_version) && (mb_strlen($sw_version) > 15)) {
            throw new \InvalidArgumentException('invalid length for $sw_version when calling InlineObject436., must be smaller than or equal to 15.');
        }
    ...
    public function setHost($host)
    {
        if (!is_null($host) && (mb_strlen($host) > 64)) {
            throw new \InvalidArgumentException('invalid length for $host when calling InlineObject436., must be smaller than or equal to 64.');
        }
    ...
    public function setUser($user)
    {
        if (!is_null($user) && (mb_strlen($user) > 64)) {
            throw new \InvalidArgumentException('invalid length for $user when calling InlineObject436., must be smaller than or equal to 64.');
        }
    ...
    public function setSrc($src)
    {
        if (!is_null($src) && (mb_strlen($src) > 15)) {
            throw new \InvalidArgumentException('invalid length for $src when calling InlineObject436., must be smaller than or equal to 15.');
        }
    ...
    public function setUserGroup($user_group)
    {
        if (!is_null($user_group) && (mb_strlen($user_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $user_group when calling InlineObject436., must be smaller than or equal to 35.');
        }
    ...
    public function setEmsTag($ems_tag)
    {
        if (!is_null($ems_tag) && (mb_strlen($ems_tag) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ems_tag when calling InlineObject436., must be smaller than or equal to 79.');
        }
    ...
    public function setSwitchFortilink($switch_fortilink)
    {
        if (!is_null($switch_fortilink) && (mb_strlen($switch_fortilink) > 15)) {
            throw new \InvalidArgumentException('invalid length for $switch_fortilink when calling InlineObject436., must be smaller than or equal to 15.');
        }
    ...
    public function setSwitchScope($switch_scope)
    {
        ...
        if (!is_null($switch_scope) && (count($switch_scope) > 0)) {
            throw new \InvalidArgumentException('invalid value for $switch_scope when calling InlineObject436., number of items must be less than or equal to 0.');
        }
    ...
    public function setSwitchPortPolicy($switch_port_policy)
    {
        if (!is_null($switch_port_policy) && (mb_strlen($switch_port_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $switch_port_policy when calling InlineObject436., must be smaller than or equal to 63.');
        }
    ...
    public function setSwitchMacPolicy($switch_mac_policy)
    {
        if (!is_null($switch_mac_policy) && (mb_strlen($switch_mac_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $switch_mac_policy when calling InlineObject436., must be smaller than or equal to 63.');
        }
