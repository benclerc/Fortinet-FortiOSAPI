...
/**
 * InlineObject221 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject221 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_221';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject221., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject221., must be bigger than or equal to 0.');
        }
    ...
    public function setVendor($vendor)
    {
        if (!is_null($vendor) && (mb_strlen($vendor) > 35)) {
            throw new \InvalidArgumentException('invalid length for $vendor when calling InlineObject221., must be smaller than or equal to 35.');
        }
    ...
    public function setModel($model)
    {
        if (!is_null($model) && (mb_strlen($model) > 35)) {
            throw new \InvalidArgumentException('invalid length for $model when calling InlineObject221., must be smaller than or equal to 35.');
        }
    ...
    public function setInitString($init_string)
    {
        if (!is_null($init_string) && (mb_strlen($init_string) > 127)) {
            throw new \InvalidArgumentException('invalid length for $init_string when calling InlineObject221., must be smaller than or equal to 127.');
        }
    ...
    public function setModeswitchString($modeswitch_string)
    {
        if (!is_null($modeswitch_string) && (mb_strlen($modeswitch_string) > 127)) {
            throw new \InvalidArgumentException('invalid length for $modeswitch_string when calling InlineObject221., must be smaller than or equal to 127.');
        }
