...
class InlineObject2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject2., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject2., must be smaller than or equal to 255.');
        }
    ...
    public function setReplacemsgGroup($replacemsg_group)
    {
        if (!is_null($replacemsg_group) && (mb_strlen($replacemsg_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $replacemsg_group when calling InlineObject2., must be smaller than or equal to 35.');
        }
    ...
    public function setAnalyticsMaxUpload($analytics_max_upload)
    {
        ...
        if (!is_null($analytics_max_upload) && ($analytics_max_upload > 383)) {
            throw new \InvalidArgumentException('invalid value for $analytics_max_upload when calling InlineObject2., must be smaller than or equal to 383.');
        }
        if (!is_null($analytics_max_upload) && ($analytics_max_upload < 1)) {
            throw new \InvalidArgumentException('invalid value for $analytics_max_upload when calling InlineObject2., must be bigger than or equal to 1.');
        }
    ...
    public function setAnalyticsWlFiletype($analytics_wl_filetype)
    {
        ...
        if (!is_null($analytics_wl_filetype) && ($analytics_wl_filetype > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $analytics_wl_filetype when calling InlineObject2., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($analytics_wl_filetype) && ($analytics_wl_filetype < 0)) {
            throw new \InvalidArgumentException('invalid value for $analytics_wl_filetype when calling InlineObject2., must be bigger than or equal to 0.');
        }
    ...
    public function setAnalyticsBlFiletype($analytics_bl_filetype)
    {
        ...
        if (!is_null($analytics_bl_filetype) && ($analytics_bl_filetype > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $analytics_bl_filetype when calling InlineObject2., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($analytics_bl_filetype) && ($analytics_bl_filetype < 0)) {
            throw new \InvalidArgumentException('invalid value for $analytics_bl_filetype when calling InlineObject2., must be bigger than or equal to 0.');
        }
    ...
    public function setHttp($http)
    {
        ...
        if (!is_null($http) && (count($http) > 0)) {
            throw new \InvalidArgumentException('invalid value for $http when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setFtp($ftp)
    {
        ...
        if (!is_null($ftp) && (count($ftp) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ftp when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setImap($imap)
    {
        ...
        if (!is_null($imap) && (count($imap) > 0)) {
            throw new \InvalidArgumentException('invalid value for $imap when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setPop3($pop3)
    {
        ...
        if (!is_null($pop3) && (count($pop3) > 0)) {
            throw new \InvalidArgumentException('invalid value for $pop3 when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setSmtp($smtp)
    {
        ...
        if (!is_null($smtp) && (count($smtp) > 0)) {
            throw new \InvalidArgumentException('invalid value for $smtp when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setMapi($mapi)
    {
        ...
        if (!is_null($mapi) && (count($mapi) > 0)) {
            throw new \InvalidArgumentException('invalid value for $mapi when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setNntp($nntp)
    {
        ...
        if (!is_null($nntp) && (count($nntp) > 0)) {
            throw new \InvalidArgumentException('invalid value for $nntp when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setCifs($cifs)
    {
        ...
        if (!is_null($cifs) && (count($cifs) > 0)) {
            throw new \InvalidArgumentException('invalid value for $cifs when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setSsh($ssh)
    {
        ...
        if (!is_null($ssh) && (count($ssh) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ssh when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setNacQuar($nac_quar)
    {
        ...
        if (!is_null($nac_quar) && (count($nac_quar) > 0)) {
            throw new \InvalidArgumentException('invalid value for $nac_quar when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setOutbreakPrevention($outbreak_prevention)
    {
        ...
        if (!is_null($outbreak_prevention) && (count($outbreak_prevention) > 0)) {
            throw new \InvalidArgumentException('invalid value for $outbreak_prevention when calling InlineObject2., number of items must be less than or equal to 0.');
        }
    ...
    public function setContentDisarm($content_disarm)
    {
        ...
        if (!is_null($content_disarm) && (count($content_disarm) > 0)) {
            throw new \InvalidArgumentException('invalid value for $content_disarm when calling InlineObject2., number of items must be less than or equal to 0.');
        }
