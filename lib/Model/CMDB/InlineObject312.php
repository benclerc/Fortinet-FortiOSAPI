...
/**
 * InlineObject312 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject312 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_312';
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 2)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineObject312., must be smaller than or equal to 2.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject312., must be smaller than or equal to 63.');
        }
