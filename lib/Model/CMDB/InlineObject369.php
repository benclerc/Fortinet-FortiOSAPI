...
/**
 * InlineObject369 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject369 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_369';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject369., must be smaller than or equal to 35.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 127)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setServerList($server_list)
    {
        ...
        if (!is_null($server_list) && (count($server_list) > 0)) {
            throw new \InvalidArgumentException('invalid value for $server_list when calling InlineObject369., number of items must be less than or equal to 0.');
        }
    ...
    public function setServerPort($server_port)
    {
        ...
        if (!is_null($server_port) && ($server_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $server_port when calling InlineObject369., must be smaller than or equal to 65535.');
        }
        if (!is_null($server_port) && ($server_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $server_port when calling InlineObject369., must be bigger than or equal to 0.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject369., must be smaller than or equal to 64.');
        }
    ...
    public function setVcenterServer($vcenter_server)
    {
        if (!is_null($vcenter_server) && (mb_strlen($vcenter_server) > 127)) {
            throw new \InvalidArgumentException('invalid length for $vcenter_server when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setVcenterUsername($vcenter_username)
    {
        if (!is_null($vcenter_username) && (mb_strlen($vcenter_username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $vcenter_username when calling InlineObject369., must be smaller than or equal to 64.');
        }
    ...
    public function setAccessKey($access_key)
    {
        if (!is_null($access_key) && (mb_strlen($access_key) > 31)) {
            throw new \InvalidArgumentException('invalid length for $access_key when calling InlineObject369., must be smaller than or equal to 31.');
        }
    ...
    public function setRegion($region)
    {
        if (!is_null($region) && (mb_strlen($region) > 31)) {
            throw new \InvalidArgumentException('invalid length for $region when calling InlineObject369., must be smaller than or equal to 31.');
        }
    ...
    public function setVpcId($vpc_id)
    {
        if (!is_null($vpc_id) && (mb_strlen($vpc_id) > 31)) {
            throw new \InvalidArgumentException('invalid length for $vpc_id when calling InlineObject369., must be smaller than or equal to 31.');
        }
    ...
    public function setTenantId($tenant_id)
    {
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) > 127)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setClientId($client_id)
    {
        if (!is_null($client_id) && (mb_strlen($client_id) > 63)) {
            throw new \InvalidArgumentException('invalid length for $client_id when calling InlineObject369., must be smaller than or equal to 63.');
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        if (!is_null($subscription_id) && (mb_strlen($subscription_id) > 63)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling InlineObject369., must be smaller than or equal to 63.');
        }
    ...
    public function setResourceGroup($resource_group)
    {
        if (!is_null($resource_group) && (mb_strlen($resource_group) > 63)) {
            throw new \InvalidArgumentException('invalid length for $resource_group when calling InlineObject369., must be smaller than or equal to 63.');
        }
    ...
    public function setLoginEndpoint($login_endpoint)
    {
        if (!is_null($login_endpoint) && (mb_strlen($login_endpoint) > 127)) {
            throw new \InvalidArgumentException('invalid length for $login_endpoint when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setResourceUrl($resource_url)
    {
        if (!is_null($resource_url) && (mb_strlen($resource_url) > 127)) {
            throw new \InvalidArgumentException('invalid length for $resource_url when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setNic($nic)
    {
        ...
        if (!is_null($nic) && (count($nic) > 0)) {
            throw new \InvalidArgumentException('invalid value for $nic when calling InlineObject369., number of items must be less than or equal to 0.');
        }
    ...
    public function setRouteTable($route_table)
    {
        ...
        if (!is_null($route_table) && (count($route_table) > 0)) {
            throw new \InvalidArgumentException('invalid value for $route_table when calling InlineObject369., number of items must be less than or equal to 0.');
        }
    ...
    public function setUserId($user_id)
    {
        if (!is_null($user_id) && (mb_strlen($user_id) > 127)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setCompartmentId($compartment_id)
    {
        if (!is_null($compartment_id) && (mb_strlen($compartment_id) > 127)) {
            throw new \InvalidArgumentException('invalid length for $compartment_id when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setOciRegion($oci_region)
    {
        if (!is_null($oci_region) && (mb_strlen($oci_region) > 31)) {
            throw new \InvalidArgumentException('invalid length for $oci_region when calling InlineObject369., must be smaller than or equal to 31.');
        }
    ...
    public function setOciCert($oci_cert)
    {
        if (!is_null($oci_cert) && (mb_strlen($oci_cert) > 63)) {
            throw new \InvalidArgumentException('invalid length for $oci_cert when calling InlineObject369., must be smaller than or equal to 63.');
        }
    ...
    public function setOciFingerprint($oci_fingerprint)
    {
        if (!is_null($oci_fingerprint) && (mb_strlen($oci_fingerprint) > 63)) {
            throw new \InvalidArgumentException('invalid length for $oci_fingerprint when calling InlineObject369., must be smaller than or equal to 63.');
        }
    ...
    public function setExternalIp($external_ip)
    {
        ...
        if (!is_null($external_ip) && (count($external_ip) > 0)) {
            throw new \InvalidArgumentException('invalid value for $external_ip when calling InlineObject369., number of items must be less than or equal to 0.');
        }
    ...
    public function setRoute($route)
    {
        ...
        if (!is_null($route) && (count($route) > 0)) {
            throw new \InvalidArgumentException('invalid value for $route when calling InlineObject369., number of items must be less than or equal to 0.');
        }
    ...
    public function setGcpProject($gcp_project)
    {
        if (!is_null($gcp_project) && (mb_strlen($gcp_project) > 127)) {
            throw new \InvalidArgumentException('invalid length for $gcp_project when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setServiceAccount($service_account)
    {
        if (!is_null($service_account) && (mb_strlen($service_account) > 127)) {
            throw new \InvalidArgumentException('invalid length for $service_account when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 127)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setGroupName($group_name)
    {
        if (!is_null($group_name) && (mb_strlen($group_name) > 127)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling InlineObject369., must be smaller than or equal to 127.');
        }
    ...
    public function setComputeGeneration($compute_generation)
    {
        ...
        if (!is_null($compute_generation) && ($compute_generation > 2)) {
            throw new \InvalidArgumentException('invalid value for $compute_generation when calling InlineObject369., must be smaller than or equal to 2.');
        }
        if (!is_null($compute_generation) && ($compute_generation < 1)) {
            throw new \InvalidArgumentException('invalid value for $compute_generation when calling InlineObject369., must be bigger than or equal to 1.');
        }
    ...
    public function setUpdateInterval($update_interval)
    {
        ...
        if (!is_null($update_interval) && ($update_interval > 3600)) {
            throw new \InvalidArgumentException('invalid value for $update_interval when calling InlineObject369., must be smaller than or equal to 3600.');
        }
        if (!is_null($update_interval) && ($update_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $update_interval when calling InlineObject369., must be bigger than or equal to 0.');
        }
