<?php
/**
 * WirelessControllerAccessControlListNameLayer3Ipv4Rules
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * WirelessControllerAccessControlListNameLayer3Ipv4Rules Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class WirelessControllerAccessControlListNameLayer3Ipv4Rules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_wireless_controller_access_control_list__name__layer3_ipv4_rules';
    ...
    public function setRuleId($rule_id)
    {
        ...
        if (!is_null($rule_id) && ($rule_id > 65535)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be smaller than or equal to 65535.');
        }
        if (!is_null($rule_id) && ($rule_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be bigger than or equal to 1.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 63)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be smaller than or equal to 63.');
        }
     ...
     * Sets srcaddr
     *
     * @param string|null $srcaddr Source IP address (any | local-LAN | IPv4 address[/<network mask | mask length>], default = any).
     *
     * @return self
     */
    ...
    public function setSrcport($srcport)
    {
        ...
        if (!is_null($srcport) && ($srcport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $srcport when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be smaller than or equal to 65535.');
        }
        if (!is_null($srcport) && ($srcport < 0)) {
            throw new \InvalidArgumentException('invalid value for $srcport when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be bigger than or equal to 0.');
        }
     ...
     * Sets dstaddr
     *
     * @param string|null $dstaddr Destination IP address (any | local-LAN | IPv4 address[/<network mask | mask length>], default = any).
     *
     * @return self
     */
    ...
    public function setDstport($dstport)
    {
        ...
        if (!is_null($dstport) && ($dstport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $dstport when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be smaller than or equal to 65535.');
        }
        if (!is_null($dstport) && ($dstport < 0)) {
            throw new \InvalidArgumentException('invalid value for $dstport when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be bigger than or equal to 0.');
        }
    ...
    public function setProtocol($protocol)
    {
        ...
        if (!is_null($protocol) && ($protocol > 255)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be smaller than or equal to 255.');
        }
        if (!is_null($protocol) && ($protocol < 0)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling WirelessControllerAccessControlListNameLayer3Ipv4Rules., must be bigger than or equal to 0.');
        }
