 ...
 */
class InlineObject59 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject59., must be smaller than or equal to 35.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 255)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject59., must be smaller than or equal to 255.');
        }
    ...
    public function setHttpsPort($https_port)
    {
        ...
        if (!is_null($https_port) && ($https_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $https_port when calling InlineObject59., must be smaller than or equal to 65535.');
        }
        if (!is_null($https_port) && ($https_port < 1)) {
            throw new \InvalidArgumentException('invalid value for $https_port when calling InlineObject59., must be bigger than or equal to 1.');
        }
    ...
    public function setCallTimeout($call_timeout)
    {
        ...
        if (!is_null($call_timeout) && ($call_timeout > 180)) {
            throw new \InvalidArgumentException('invalid value for $call_timeout when calling InlineObject59., must be smaller than or equal to 180.');
        }
        if (!is_null($call_timeout) && ($call_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $call_timeout when calling InlineObject59., must be bigger than or equal to 1.');
        }
    ...
    public function setStatusCheckInterval($status_check_interval)
    {
        ...
        if (!is_null($status_check_interval) && ($status_check_interval > 180)) {
            throw new \InvalidArgumentException('invalid value for $status_check_interval when calling InlineObject59., must be smaller than or equal to 180.');
        }
        if (!is_null($status_check_interval) && ($status_check_interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $status_check_interval when calling InlineObject59., must be bigger than or equal to 1.');
        }
    ...
    public function setCertificate($certificate)
    {
        if (!is_null($certificate) && (mb_strlen($certificate) > 35)) {
            throw new \InvalidArgumentException('invalid length for $certificate when calling InlineObject59., must be smaller than or equal to 35.');
        }
