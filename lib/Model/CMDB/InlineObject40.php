 ...
 */
class InlineObject40 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'comment' => 'string',
        'entries' => '\Fortigate\FortiOS\Model\CMDB\DnsfilterDomainFilterIdEntries[]'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject40., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject40., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject40., must be smaller than or equal to 63.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject40., must be smaller than or equal to 255.');
        }
     ...
     * Gets entries
     *
     * @return \Fortigate\FortiOS\Model\CMDB\DnsfilterDomainFilterIdEntries[]|null
     */
     ...
     * Sets entries
     *
     * @param \Fortigate\FortiOS\Model\CMDB\DnsfilterDomainFilterIdEntries[]|null $entries DNS domain filter entries.
     *
     * @return self
     */
    public function setEntries($entries)
    {
        ...
        if (!is_null($entries) && (count($entries) > 0)) {
            throw new \InvalidArgumentException('invalid value for $entries when calling InlineObject40., number of items must be less than or equal to 0.');
        }
