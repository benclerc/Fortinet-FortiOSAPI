...
/**
 * InlineObject431 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject431 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_431';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject431., must be smaller than or equal to 35.');
        }
    ...
    public function setPrincipal($principal)
    {
        if (!is_null($principal) && (mb_strlen($principal) > 511)) {
            throw new \InvalidArgumentException('invalid length for $principal when calling InlineObject431., must be smaller than or equal to 511.');
        }
    ...
    public function setLdapServer($ldap_server)
    {
        ...
        if (!is_null($ldap_server) && (count($ldap_server) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ldap_server when calling InlineObject431., number of items must be less than or equal to 0.');
        }
    ...
    public function setKeytab($keytab)
    {
        if (!is_null($keytab) && (mb_strlen($keytab) > 8191)) {
            throw new \InvalidArgumentException('invalid length for $keytab when calling InlineObject431., must be smaller than or equal to 8191.');
        }
