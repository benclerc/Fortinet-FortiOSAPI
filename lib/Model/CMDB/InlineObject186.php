...
/**
 * InlineObject186 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject186 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_186';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject186., must be smaller than or equal to 35.');
        }
    ...
    public function setShellCommands($shell_commands)
    {
        ...
        if (!is_null($shell_commands) && (count($shell_commands) > 256)) {
            throw new \InvalidArgumentException('invalid value for $shell_commands when calling InlineObject186., number of items must be less than or equal to 256.');
        }
