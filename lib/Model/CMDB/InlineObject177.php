...
/**
 * InlineObject177 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject177 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_177';
    ...
    protected static $openAPITypes = [
        ...
        'distance' => '\Fortigate\FortiOS\Model\CMDB\RouterRipDistance[]',
        'distribute_list' => '\Fortigate\FortiOS\Model\CMDB\RouterRipDistributeList[]',
        'neighbor' => '\Fortigate\FortiOS\Model\CMDB\RouterRipNeighbor[]',
        'network' => '\Fortigate\FortiOS\Model\CMDB\RouterRipNetwork[]',
        'offset_list' => '\Fortigate\FortiOS\Model\CMDB\RouterRipOffsetList[]',
        ...
        'garbage_timer' => 'int',
        'version' => 'string',
        'interface' => '\Fortigate\FortiOS\Model\CMDB\RouterRipInterface[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'recv_buffer_size' => 'recv-buffer-size',
        'distance' => 'distance',
    ...
    protected static $setters = [
        ...
        'recv_buffer_size' => 'setRecvBufferSize',
    ...
    protected static $getters = [
        ...
        'recv_buffer_size' => 'getRecvBufferSize',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['recv_buffer_size'] = $data['recv_buffer_size'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['recv_buffer_size']) && ($this->container['recv_buffer_size'] > 2147483647)) {
            $invalidProperties[] = "invalid value for 'recv_buffer_size', must be smaller than or equal to 2147483647.";
        }

        if (!is_null($this->container['recv_buffer_size']) && ($this->container['recv_buffer_size'] < 8129)) {
            $invalidProperties[] = "invalid value for 'recv_buffer_size', must be bigger than or equal to 8129.";
        }
        ...
        if (!is_null($this->container['update_timer']) && ($this->container['update_timer'] < 1)) {
            $invalidProperties[] = "invalid value for 'update_timer', must be bigger than or equal to 1.";
        }
    ...
    public function setDefaultMetric($default_metric)
    {
        ...
        if (!is_null($default_metric) && ($default_metric > 16)) {
            throw new \InvalidArgumentException('invalid value for $default_metric when calling InlineObject177., must be smaller than or equal to 16.');
        }
        if (!is_null($default_metric) && ($default_metric < 1)) {
            throw new \InvalidArgumentException('invalid value for $default_metric when calling InlineObject177., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxOutMetric($max_out_metric)
    {
        ...
        if (!is_null($max_out_metric) && ($max_out_metric > 15)) {
            throw new \InvalidArgumentException('invalid value for $max_out_metric when calling InlineObject177., must be smaller than or equal to 15.');
        }
        if (!is_null($max_out_metric) && ($max_out_metric < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_out_metric when calling InlineObject177., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets recv_buffer_size
     *
     * @return int|null
     */
    public function getRecvBufferSize()
    {
        return $this->container['recv_buffer_size'];
    }

    /**
     * Sets recv_buffer_size
     *
     * @param int|null $recv_buffer_size Receiving buffer size.
     *
     * @return self
     */
    public function setRecvBufferSize($recv_buffer_size)
    {

        if (!is_null($recv_buffer_size) && ($recv_buffer_size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $recv_buffer_size when calling InlineObject177., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($recv_buffer_size) && ($recv_buffer_size < 8129)) {
            throw new \InvalidArgumentException('invalid value for $recv_buffer_size when calling InlineObject177., must be bigger than or equal to 8129.');
        }

        $this->container['recv_buffer_size'] = $recv_buffer_size;
     ...
     * Gets distance
     *
     * @return \Fortigate\FortiOS\Model\CMDB\RouterRipDistance[]|null
     */
     ...
     * Sets distance
     *
     * @param \Fortigate\FortiOS\Model\CMDB\RouterRipDistance[]|null $distance distance
     *
     * @return self
     */
    public function setDistance($distance)
    {
        ...
        if (!is_null($distance) && (count($distance) > 0)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject177., number of items must be less than or equal to 0.');
        }
    ...
    public function setDistributeList($distribute_list)
    {
        ...
        if (!is_null($distribute_list) && (count($distribute_list) > 0)) {
            throw new \InvalidArgumentException('invalid value for $distribute_list when calling InlineObject177., number of items must be less than or equal to 0.');
        }
     ...
     * Gets neighbor
     *
     * @return \Fortigate\FortiOS\Model\CMDB\RouterRipNeighbor[]|null
     */
     ...
     * Sets neighbor
     *
     * @param \Fortigate\FortiOS\Model\CMDB\RouterRipNeighbor[]|null $neighbor neighbor
     *
     * @return self
     */
    public function setNeighbor($neighbor)
    {
        ...
        if (!is_null($neighbor) && (count($neighbor) > 0)) {
            throw new \InvalidArgumentException('invalid value for $neighbor when calling InlineObject177., number of items must be less than or equal to 0.');
        }
     ...
     * Gets network
     *
     * @return \Fortigate\FortiOS\Model\CMDB\RouterRipNetwork[]|null
     */
     ...
     * Sets network
     *
     * @param \Fortigate\FortiOS\Model\CMDB\RouterRipNetwork[]|null $network network
     *
     * @return self
     */
    public function setNetwork($network)
    {
        ...
        if (!is_null($network) && (count($network) > 0)) {
            throw new \InvalidArgumentException('invalid value for $network when calling InlineObject177., number of items must be less than or equal to 0.');
        }
     ...
     * Gets offset_list
     *
     * @return \Fortigate\FortiOS\Model\CMDB\RouterRipOffsetList[]|null
     */
     ...
     * Sets offset_list
     *
     * @param \Fortigate\FortiOS\Model\CMDB\RouterRipOffsetList[]|null $offset_list Offset list.
     *
     * @return self
     */
    public function setOffsetList($offset_list)
    {
        ...
        if (!is_null($offset_list) && (count($offset_list) > 0)) {
            throw new \InvalidArgumentException('invalid value for $offset_list when calling InlineObject177., number of items must be less than or equal to 0.');
        }
    ...
    public function setPassiveInterface($passive_interface)
    {
        ...
        if (!is_null($passive_interface) && (count($passive_interface) > 0)) {
            throw new \InvalidArgumentException('invalid value for $passive_interface when calling InlineObject177., number of items must be less than or equal to 0.');
        }
    ...
    public function setRedistribute($redistribute)
    {
        ...
        if (!is_null($redistribute) && (count($redistribute) > 0)) {
            throw new \InvalidArgumentException('invalid value for $redistribute when calling InlineObject177., number of items must be less than or equal to 0.');
        }
     ...
     * Sets update_timer
     *
     * @param int|null $update_timer Update timer in seconds.
     *
     * @return self
     */
    public function setUpdateTimer($update_timer)
    {
        ...
        if (!is_null($update_timer) && ($update_timer > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $update_timer when calling InlineObject177., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($update_timer) && ($update_timer < 1)) {
            throw new \InvalidArgumentException('invalid value for $update_timer when calling InlineObject177., must be bigger than or equal to 1.');
        }
     ...
     * Sets timeout_timer
     *
     * @param int|null $timeout_timer Timeout timer in seconds.
     *
     * @return self
     */
    public function setTimeoutTimer($timeout_timer)
    {
        ...
        if (!is_null($timeout_timer) && ($timeout_timer > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $timeout_timer when calling InlineObject177., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($timeout_timer) && ($timeout_timer < 5)) {
            throw new \InvalidArgumentException('invalid value for $timeout_timer when calling InlineObject177., must be bigger than or equal to 5.');
        }
     ...
     * Sets garbage_timer
     *
     * @param int|null $garbage_timer Garbage timer in seconds.
     *
     * @return self
     */
    public function setGarbageTimer($garbage_timer)
    {
        ...
        if (!is_null($garbage_timer) && ($garbage_timer > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $garbage_timer when calling InlineObject177., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($garbage_timer) && ($garbage_timer < 5)) {
            throw new \InvalidArgumentException('invalid value for $garbage_timer when calling InlineObject177., must be bigger than or equal to 5.');
        }
     ...
     * Sets version
     *
     * @param string|null $version RIP version.    1:Version 1.    2:Version 2.
     *
     * @return self
     */
     ...
     * Gets interface
     *
     * @return \Fortigate\FortiOS\Model\CMDB\RouterRipInterface[]|null
     */
     ...
     * Sets interface
     *
     * @param \Fortigate\FortiOS\Model\CMDB\RouterRipInterface[]|null $interface RIP interface configuration.
     *
     * @return self
     */
    public function setInterface($interface)
    {
        ...
        if (!is_null($interface) && (count($interface) > 0)) {
            throw new \InvalidArgumentException('invalid value for $interface when calling InlineObject177., number of items must be less than or equal to 0.');
        }
