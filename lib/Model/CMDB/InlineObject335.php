...
/**
 * InlineObject335 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject335 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_335';
     ...
     * Sets name
     *
     * @param string|null $name IPv6 tunnel name.
     *
     * @return self
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject335., must be smaller than or equal to 15.');
        }
     ...
     * Sets source
     *
     * @param string|null $source Local IPv6 address of the tunnel.
     *
     * @return self
     */
     ...
     * Sets destination
     *
     * @param string|null $destination Remote IPv6 address of the tunnel.
     *
     * @return self
     */
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject335., must be smaller than or equal to 15.');
        }
