...
/**
 * InlineObject317 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject317 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_317';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject317., must be smaller than or equal to 15.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject317., must be smaller than or equal to 15.');
        }
    ...
    public function setKeyOutbound($key_outbound)
    {
        ...
        if (!is_null($key_outbound) && ($key_outbound > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $key_outbound when calling InlineObject317., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($key_outbound) && ($key_outbound < 0)) {
            throw new \InvalidArgumentException('invalid value for $key_outbound when calling InlineObject317., must be bigger than or equal to 0.');
        }
    ...
    public function setKeyInbound($key_inbound)
    {
        ...
        if (!is_null($key_inbound) && ($key_inbound > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $key_inbound when calling InlineObject317., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($key_inbound) && ($key_inbound < 0)) {
            throw new \InvalidArgumentException('invalid value for $key_inbound when calling InlineObject317., must be bigger than or equal to 0.');
        }
    ...
    public function setKeepaliveInterval($keepalive_interval)
    {
        ...
        if (!is_null($keepalive_interval) && ($keepalive_interval > 32767)) {
            throw new \InvalidArgumentException('invalid value for $keepalive_interval when calling InlineObject317., must be smaller than or equal to 32767.');
        }
        if (!is_null($keepalive_interval) && ($keepalive_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $keepalive_interval when calling InlineObject317., must be bigger than or equal to 0.');
        }
    ...
    public function setKeepaliveFailtimes($keepalive_failtimes)
    {
        ...
        if (!is_null($keepalive_failtimes) && ($keepalive_failtimes > 255)) {
            throw new \InvalidArgumentException('invalid value for $keepalive_failtimes when calling InlineObject317., must be smaller than or equal to 255.');
        }
        if (!is_null($keepalive_failtimes) && ($keepalive_failtimes < 1)) {
            throw new \InvalidArgumentException('invalid value for $keepalive_failtimes when calling InlineObject317., must be bigger than or equal to 1.');
        }
