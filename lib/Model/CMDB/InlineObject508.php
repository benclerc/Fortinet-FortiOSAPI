...
/**
 * InlineObject508 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject508 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_508';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject508., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject508., must be smaller than or equal to 255.');
        }
    ...
    public function setHostDomainNameSuffix($host_domain_name_suffix)
    {
        ...
        if (!is_null($host_domain_name_suffix) && (count($host_domain_name_suffix) > 0)) {
            throw new \InvalidArgumentException('invalid value for $host_domain_name_suffix when calling InlineObject508., number of items must be less than or equal to 0.');
        }
    ...
    public function setRules($rules)
    {
        ...
        if (!is_null($rules) && (count($rules) > 0)) {
            throw new \InvalidArgumentException('invalid value for $rules when calling InlineObject508., number of items must be less than or equal to 0.');
        }
