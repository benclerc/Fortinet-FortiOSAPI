 ...
 */
class InlineObject225 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject225., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject225., must be bigger than or equal to 0.');
        }
    ...
    public function setLeaseTime($lease_time)
    {
        ...
        if (!is_null($lease_time) && ($lease_time > 8640000)) {
            throw new \InvalidArgumentException('invalid value for $lease_time when calling InlineObject225., must be smaller than or equal to 8640000.');
        }
        if (!is_null($lease_time) && ($lease_time < 300)) {
            throw new \InvalidArgumentException('invalid value for $lease_time when calling InlineObject225., must be bigger than or equal to 300.');
        }
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 35)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling InlineObject225., must be smaller than or equal to 35.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject225., must be smaller than or equal to 15.');
        }
    ...
    public function setIpRange($ip_range)
    {
        ...
        if (!is_null($ip_range) && (count($ip_range) > 3)) {
            throw new \InvalidArgumentException('invalid value for $ip_range when calling InlineObject225., number of items must be less than or equal to 3.');
        }
    ...
    public function setTftpServer($tftp_server)
    {
        ...
        if (!is_null($tftp_server) && (count($tftp_server) > 0)) {
            throw new \InvalidArgumentException('invalid value for $tftp_server when calling InlineObject225., number of items must be less than or equal to 0.');
        }
    ...
    public function setFilename($filename)
    {
        if (!is_null($filename) && (mb_strlen($filename) > 127)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling InlineObject225., must be smaller than or equal to 127.');
        }
    ...
    public function setOptions($options)
    {
        ...
        if (!is_null($options) && (count($options) > 30)) {
            throw new \InvalidArgumentException('invalid value for $options when calling InlineObject225., number of items must be less than or equal to 30.');
        }
    ...
    public function setConflictedIpTimeout($conflicted_ip_timeout)
    {
        ...
        if (!is_null($conflicted_ip_timeout) && ($conflicted_ip_timeout > 8640000)) {
            throw new \InvalidArgumentException('invalid value for $conflicted_ip_timeout when calling InlineObject225., must be smaller than or equal to 8640000.');
        }
        if (!is_null($conflicted_ip_timeout) && ($conflicted_ip_timeout < 60)) {
            throw new \InvalidArgumentException('invalid value for $conflicted_ip_timeout when calling InlineObject225., must be bigger than or equal to 60.');
        }
    ...
    public function setIpsecLeaseHold($ipsec_lease_hold)
    {
        ...
        if (!is_null($ipsec_lease_hold) && ($ipsec_lease_hold > 8640000)) {
            throw new \InvalidArgumentException('invalid value for $ipsec_lease_hold when calling InlineObject225., must be smaller than or equal to 8640000.');
        }
        if (!is_null($ipsec_lease_hold) && ($ipsec_lease_hold < 0)) {
            throw new \InvalidArgumentException('invalid value for $ipsec_lease_hold when calling InlineObject225., must be bigger than or equal to 0.');
        }
    ...
    public function setDdnsZone($ddns_zone)
    {
        if (!is_null($ddns_zone) && (mb_strlen($ddns_zone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ddns_zone when calling InlineObject225., must be smaller than or equal to 64.');
        }
    ...
    public function setDdnsKeyname($ddns_keyname)
    {
        if (!is_null($ddns_keyname) && (mb_strlen($ddns_keyname) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ddns_keyname when calling InlineObject225., must be smaller than or equal to 64.');
        }
    ...
    public function setDdnsTtl($ddns_ttl)
    {
        ...
        if (!is_null($ddns_ttl) && ($ddns_ttl > 86400)) {
            throw new \InvalidArgumentException('invalid value for $ddns_ttl when calling InlineObject225., must be smaller than or equal to 86400.');
        }
        if (!is_null($ddns_ttl) && ($ddns_ttl < 60)) {
            throw new \InvalidArgumentException('invalid value for $ddns_ttl when calling InlineObject225., must be bigger than or equal to 60.');
        }
    ...
    public function setVciString($vci_string)
    {
        ...
        if (!is_null($vci_string) && (count($vci_string) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vci_string when calling InlineObject225., number of items must be less than or equal to 0.');
        }
    ...
    public function setExcludeRange($exclude_range)
    {
        ...
        if (!is_null($exclude_range) && (count($exclude_range) > 16)) {
            throw new \InvalidArgumentException('invalid value for $exclude_range when calling InlineObject225., number of items must be less than or equal to 16.');
        }
    ...
    public function setReservedAddress($reserved_address)
    {
        ...
        if (!is_null($reserved_address) && (count($reserved_address) > 0)) {
            throw new \InvalidArgumentException('invalid value for $reserved_address when calling InlineObject225., number of items must be less than or equal to 0.');
        }
