...
/**
 * InlineObject396 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject396 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_396';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4096)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject396., must be smaller than or equal to 4096.');
        }
        if (!is_null($id) && ($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject396., must be bigger than or equal to 1.');
        }
    ...
    public function setVdom($vdom)
    {
        ...
        if (!is_null($vdom) && (count($vdom) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vdom when calling InlineObject396., number of items must be less than or equal to 0.');
        }
