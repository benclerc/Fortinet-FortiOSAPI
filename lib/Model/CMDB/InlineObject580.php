...
/**
 * InlineObject580 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject580 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_580';
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineObject580., must be smaller than or equal to 35.');
        }
