...
/**
 * InlineObject295 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject295 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_295';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject295., must be smaller than or equal to 35.');
        }
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 255)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling InlineObject295., must be smaller than or equal to 255.');
        }
    ...
    public function setPrimaryName($primary_name)
    {
        if (!is_null($primary_name) && (mb_strlen($primary_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $primary_name when calling InlineObject295., must be smaller than or equal to 255.');
        }
    ...
    public function setContact($contact)
    {
        if (!is_null($contact) && (mb_strlen($contact) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling InlineObject295., must be smaller than or equal to 255.');
        }
    ...
    public function setTtl($ttl)
    {
        ...
        if (!is_null($ttl) && ($ttl > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling InlineObject295., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($ttl) && ($ttl < 0)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling InlineObject295., must be bigger than or equal to 0.');
        }
    ...
    public function setRrMax($rr_max)
    {
        ...
        if (!is_null($rr_max) && ($rr_max > 65536)) {
            throw new \InvalidArgumentException('invalid value for $rr_max when calling InlineObject295., must be smaller than or equal to 65536.');
        }
        if (!is_null($rr_max) && ($rr_max < 10)) {
            throw new \InvalidArgumentException('invalid value for $rr_max when calling InlineObject295., must be bigger than or equal to 10.');
        }
    ...
    public function setDnsEntry($dns_entry)
    {
        ...
        if (!is_null($dns_entry) && (count($dns_entry) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dns_entry when calling InlineObject295., number of items must be less than or equal to 0.');
        }
