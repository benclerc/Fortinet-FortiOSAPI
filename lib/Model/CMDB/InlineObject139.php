...
/**
 * InlineObject139 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject139 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_139';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 71)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject139., must be smaller than or equal to 71.');
        }
    ...
    public function setPolicy($policy)
    {
        ...
        if (!is_null($policy) && ($policy > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $policy when calling InlineObject139., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($policy) && ($policy < 0)) {
            throw new \InvalidArgumentException('invalid value for $policy when calling InlineObject139., must be bigger than or equal to 0.');
        }
    ...
    public function setQuery($query)
    {
        if (!is_null($query) && (mb_strlen($query) > 2303)) {
            throw new \InvalidArgumentException('invalid length for $query when calling InlineObject139., must be smaller than or equal to 2303.');
        }
    ...
    public function setField($field)
    {
        ...
        if (!is_null($field) && (count($field) > 32)) {
            throw new \InvalidArgumentException('invalid value for $field when calling InlineObject139., number of items must be less than or equal to 32.');
        }
    ...
    public function setParameters($parameters)
    {
        ...
        if (!is_null($parameters) && (count($parameters) > 0)) {
            throw new \InvalidArgumentException('invalid value for $parameters when calling InlineObject139., number of items must be less than or equal to 0.');
        }
