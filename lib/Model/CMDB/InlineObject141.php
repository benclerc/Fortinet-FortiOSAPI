 ...
 */
class InlineObject141 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject141., must be smaller than or equal to 35.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 127)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineObject141., must be smaller than or equal to 127.');
        }
    ...
    public function setSubtitle($subtitle)
    {
        if (!is_null($subtitle) && (mb_strlen($subtitle) > 127)) {
            throw new \InvalidArgumentException('invalid length for $subtitle when calling InlineObject141., must be smaller than or equal to 127.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 127)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject141., must be smaller than or equal to 127.');
        }
    ...
    public function setStyleTheme($style_theme)
    {
        if (!is_null($style_theme) && (mb_strlen($style_theme) > 35)) {
            throw new \InvalidArgumentException('invalid length for $style_theme when calling InlineObject141., must be smaller than or equal to 35.');
        }
    ...
    public function setEmailRecipients($email_recipients)
    {
        if (!is_null($email_recipients) && (mb_strlen($email_recipients) > 511)) {
            throw new \InvalidArgumentException('invalid length for $email_recipients when calling InlineObject141., must be smaller than or equal to 511.');
        }
    ...
    public function setMaxPdfReport($max_pdf_report)
    {
        ...
        if (!is_null($max_pdf_report) && ($max_pdf_report > 365)) {
            throw new \InvalidArgumentException('invalid value for $max_pdf_report when calling InlineObject141., must be smaller than or equal to 365.');
        }
        if (!is_null($max_pdf_report) && ($max_pdf_report < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_pdf_report when calling InlineObject141., must be bigger than or equal to 1.');
        }
    ...
    public function setPage($page)
    {
        ...
        if (!is_null($page) && (count($page) > 0)) {
            throw new \InvalidArgumentException('invalid value for $page when calling InlineObject141., number of items must be less than or equal to 0.');
        }
    ...
    public function setBodyItem($body_item)
    {
        ...
        if (!is_null($body_item) && (count($body_item) > 256)) {
            throw new \InvalidArgumentException('invalid value for $body_item when calling InlineObject141., number of items must be less than or equal to 256.');
        }
