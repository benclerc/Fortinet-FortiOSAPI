...
/**
 * AntivirusProfileNamePop3 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class AntivirusProfileNamePop3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_antivirus_profile__name__pop3';
     ...
     * Sets options
     *
     * @param string|null $options Enable/disable POP3 AntiVirus scanning, monitoring, and quarantine.    scan:Enable POP3 antivirus scanning.    avmonitor:Enable POP3 antivirus logging.    quarantine:Enable POP3 antivirus quarantine. Files are quarantined depending on quarantine settings.
     *
     * @return self
     */
