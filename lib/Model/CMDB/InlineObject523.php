...
/**
 * InlineObject523 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject523 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_523';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject523., must be smaller than or equal to 63.');
        }
    ...
    public function setServerList($server_list)
    {
        ...
        if (!is_null($server_list) && (count($server_list) > 0)) {
            throw new \InvalidArgumentException('invalid value for $server_list when calling InlineObject523., number of items must be less than or equal to 0.');
        }
