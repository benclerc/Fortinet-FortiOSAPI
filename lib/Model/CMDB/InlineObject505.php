...
/**
 * InlineObject505 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject505 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_505';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject505., must be smaller than or equal to 35.');
        }
    ...
    public function setCert($cert)
    {
        if (!is_null($cert) && (mb_strlen($cert) > 35)) {
            throw new \InvalidArgumentException('invalid length for $cert when calling InlineObject505., must be smaller than or equal to 35.');
        }
    ...
    public function setPeer($peer)
    {
        if (!is_null($peer) && (mb_strlen($peer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $peer when calling InlineObject505., must be smaller than or equal to 35.');
        }
