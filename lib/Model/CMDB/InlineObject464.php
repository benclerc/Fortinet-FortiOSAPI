...
/**
 * InlineObject464 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject464 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_464';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject464., must be smaller than or equal to 35.');
        }
    ...
    public function setUrl($url)
    {
        if (!is_null($url) && (mb_strlen($url) > 127)) {
            throw new \InvalidArgumentException('invalid length for $url when calling InlineObject464., must be smaller than or equal to 127.');
        }
    ...
    public function setCert($cert)
    {
        if (!is_null($cert) && (mb_strlen($cert) > 127)) {
            throw new \InvalidArgumentException('invalid length for $cert when calling InlineObject464., must be smaller than or equal to 127.');
        }
    ...
    public function setSecondaryUrl($secondary_url)
    {
        if (!is_null($secondary_url) && (mb_strlen($secondary_url) > 127)) {
            throw new \InvalidArgumentException('invalid length for $secondary_url when calling InlineObject464., must be smaller than or equal to 127.');
        }
    ...
    public function setSecondaryCert($secondary_cert)
    {
        if (!is_null($secondary_cert) && (mb_strlen($secondary_cert) > 127)) {
            throw new \InvalidArgumentException('invalid length for $secondary_cert when calling InlineObject464., must be smaller than or equal to 127.');
        }
