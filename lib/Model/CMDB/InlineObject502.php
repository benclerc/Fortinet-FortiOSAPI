...
/**
 * InlineObject502 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject502 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_502';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject502., must be smaller than or equal to 35.');
        }
    ...
    public function setSignature($signature)
    {
        ...
        if (!is_null($signature) && (count($signature) > 0)) {
            throw new \InvalidArgumentException('invalid value for $signature when calling InlineObject502., number of items must be less than or equal to 0.');
        }
    ...
    public function setConstraint($constraint)
    {
        ...
        if (!is_null($constraint) && (count($constraint) > 0)) {
            throw new \InvalidArgumentException('invalid value for $constraint when calling InlineObject502., number of items must be less than or equal to 0.');
        }
    ...
    public function setMethod($method)
    {
        ...
        if (!is_null($method) && (count($method) > 0)) {
            throw new \InvalidArgumentException('invalid value for $method when calling InlineObject502., number of items must be less than or equal to 0.');
        }
    ...
    public function setAddressList($address_list)
    {
        ...
        if (!is_null($address_list) && (count($address_list) > 0)) {
            throw new \InvalidArgumentException('invalid value for $address_list when calling InlineObject502., number of items must be less than or equal to 0.');
        }
    ...
    public function setUrlAccess($url_access)
    {
        ...
        if (!is_null($url_access) && (count($url_access) > 0)) {
            throw new \InvalidArgumentException('invalid value for $url_access when calling InlineObject502., number of items must be less than or equal to 0.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject502., must be smaller than or equal to 1023.');
        }
