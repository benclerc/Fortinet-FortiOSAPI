...
/**
 * InlineObject60 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject60 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_60';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 31)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject60., must be smaller than or equal to 31.');
        }
    ...
    public function setIccid($iccid)
    {
        if (!is_null($iccid) && (mb_strlen($iccid) > 31)) {
            throw new \InvalidArgumentException('invalid length for $iccid when calling InlineObject60., must be smaller than or equal to 31.');
        }
    ...
    public function setCarrier($carrier)
    {
        if (!is_null($carrier) && (mb_strlen($carrier) > 31)) {
            throw new \InvalidArgumentException('invalid length for $carrier when calling InlineObject60., must be smaller than or equal to 31.');
        }
    ...
    public function setApn($apn)
    {
        if (!is_null($apn) && (mb_strlen($apn) > 63)) {
            throw new \InvalidArgumentException('invalid length for $apn when calling InlineObject60., must be smaller than or equal to 63.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 31)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject60., must be smaller than or equal to 31.');
        }
    ...
    public function setSignalThreshold($signal_threshold)
    {
        ...
        if (!is_null($signal_threshold) && ($signal_threshold > 100)) {
            throw new \InvalidArgumentException('invalid value for $signal_threshold when calling InlineObject60., must be smaller than or equal to 100.');
        }
        if (!is_null($signal_threshold) && ($signal_threshold < 50)) {
            throw new \InvalidArgumentException('invalid value for $signal_threshold when calling InlineObject60., must be bigger than or equal to 50.');
        }
    ...
    public function setSignalPeriod($signal_period)
    {
        ...
        if (!is_null($signal_period) && ($signal_period > 18000)) {
            throw new \InvalidArgumentException('invalid value for $signal_period when calling InlineObject60., must be smaller than or equal to 18000.');
        }
        if (!is_null($signal_period) && ($signal_period < 600)) {
            throw new \InvalidArgumentException('invalid value for $signal_period when calling InlineObject60., must be bigger than or equal to 600.');
        }
    ...
    public function setCapacity($capacity)
    {
        ...
        if (!is_null($capacity) && ($capacity > 102400000)) {
            throw new \InvalidArgumentException('invalid value for $capacity when calling InlineObject60., must be smaller than or equal to 102400000.');
        }
        if (!is_null($capacity) && ($capacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $capacity when calling InlineObject60., must be bigger than or equal to 0.');
        }
    ...
    public function setMonthlyFee($monthly_fee)
    {
        ...
        if (!is_null($monthly_fee) && ($monthly_fee > 1000000)) {
            throw new \InvalidArgumentException('invalid value for $monthly_fee when calling InlineObject60., must be smaller than or equal to 1000000.');
        }
        if (!is_null($monthly_fee) && ($monthly_fee < 0)) {
            throw new \InvalidArgumentException('invalid value for $monthly_fee when calling InlineObject60., must be bigger than or equal to 0.');
        }
    ...
    public function setBillingDate($billing_date)
    {
        ...
        if (!is_null($billing_date) && ($billing_date > 31)) {
            throw new \InvalidArgumentException('invalid value for $billing_date when calling InlineObject60., must be smaller than or equal to 31.');
        }
        if (!is_null($billing_date) && ($billing_date < 1)) {
            throw new \InvalidArgumentException('invalid value for $billing_date when calling InlineObject60., must be bigger than or equal to 1.');
        }
    ...
    public function setPreferredSubnet($preferred_subnet)
    {
        ...
        if (!is_null($preferred_subnet) && ($preferred_subnet > 32)) {
            throw new \InvalidArgumentException('invalid value for $preferred_subnet when calling InlineObject60., must be smaller than or equal to 32.');
        }
        if (!is_null($preferred_subnet) && ($preferred_subnet < 8)) {
            throw new \InvalidArgumentException('invalid value for $preferred_subnet when calling InlineObject60., must be bigger than or equal to 8.');
        }
