...
class InlineObject29 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setServerName($server_name)
    {
        if (!is_null($server_name) && (mb_strlen($server_name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server_name when calling InlineObject29., must be smaller than or equal to 63.');
        }
    ...
    public function setHostname($hostname)
    {
        if (!is_null($hostname) && (mb_strlen($hostname) > 255)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling InlineObject29., must be smaller than or equal to 255.');
        }
    ...
    public function setDomainName($domain_name)
    {
        if (!is_null($domain_name) && (mb_strlen($domain_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $domain_name when calling InlineObject29., must be smaller than or equal to 255.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject29., must be smaller than or equal to 64.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject29., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject29., must be bigger than or equal to 0.');
        }
