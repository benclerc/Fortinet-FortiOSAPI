...
/**
 * InlineObject351 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject351 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_351';
    ...
    public function setCategory($category)
    {
        if (!is_null($category) && (mb_strlen($category) > 63)) {
            throw new \InvalidArgumentException('invalid length for $category when calling InlineObject351., must be smaller than or equal to 63.');
        }
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && ($color > 32)) {
            throw new \InvalidArgumentException('invalid value for $color when calling InlineObject351., must be smaller than or equal to 32.');
        }
        if (!is_null($color) && ($color < 0)) {
            throw new \InvalidArgumentException('invalid value for $color when calling InlineObject351., must be bigger than or equal to 0.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 0)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling InlineObject351., number of items must be less than or equal to 0.');
        }
