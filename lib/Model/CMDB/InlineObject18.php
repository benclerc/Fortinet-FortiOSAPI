...
class InlineObject18 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject18., must be smaller than or equal to 35.');
        }
    ...
    public function setKerberosKeytab($kerberos_keytab)
    {
        if (!is_null($kerberos_keytab) && (mb_strlen($kerberos_keytab) > 35)) {
            throw new \InvalidArgumentException('invalid length for $kerberos_keytab when calling InlineObject18., must be smaller than or equal to 35.');
        }
    ...
    public function setDomainController($domain_controller)
    {
        if (!is_null($domain_controller) && (mb_strlen($domain_controller) > 35)) {
            throw new \InvalidArgumentException('invalid length for $domain_controller when calling InlineObject18., must be smaller than or equal to 35.');
        }
    ...
    public function setFssoAgentForNtlm($fsso_agent_for_ntlm)
    {
        if (!is_null($fsso_agent_for_ntlm) && (mb_strlen($fsso_agent_for_ntlm) > 35)) {
            throw new \InvalidArgumentException('invalid length for $fsso_agent_for_ntlm when calling InlineObject18., must be smaller than or equal to 35.');
        }
    ...
    public function setUserDatabase($user_database)
    {
        ...
        if (!is_null($user_database) && (count($user_database) > 0)) {
            throw new \InvalidArgumentException('invalid value for $user_database when calling InlineObject18., number of items must be less than or equal to 0.');
        }
    ...
    public function setSshCa($ssh_ca)
    {
        if (!is_null($ssh_ca) && (mb_strlen($ssh_ca) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ssh_ca when calling InlineObject18., must be smaller than or equal to 35.');
        }
