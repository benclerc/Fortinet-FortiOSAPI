...
/**
 * InlineObject601 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject601 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_601';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject601., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 1027)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject601., must be smaller than or equal to 1027.');
        }
    ...
    public function setOpacity($opacity)
    {
        ...
        if (!is_null($opacity) && ($opacity > 100)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling InlineObject601., must be smaller than or equal to 100.');
        }
        if (!is_null($opacity) && ($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling InlineObject601., must be bigger than or equal to 0.');
        }
