...
/**
 * InlineObject321 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject321 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_321';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject321., must be smaller than or equal to 15.');
        }
    ...
    public function setVdom($vdom)
    {
        if (!is_null($vdom) && (mb_strlen($vdom) > 31)) {
            throw new \InvalidArgumentException('invalid length for $vdom when calling InlineObject321., must be smaller than or equal to 31.');
        }
    ...
    public function setVrf($vrf)
    {
        ...
        if (!is_null($vrf) && ($vrf > 31)) {
            throw new \InvalidArgumentException('invalid value for $vrf when calling InlineObject321., must be smaller than or equal to 31.');
        }
        if (!is_null($vrf) && ($vrf < 0)) {
            throw new \InvalidArgumentException('invalid value for $vrf when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setCliConnStatus($cli_conn_status)
    {
        ...
        if (!is_null($cli_conn_status) && ($cli_conn_status > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $cli_conn_status when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($cli_conn_status) && ($cli_conn_status < 0)) {
            throw new \InvalidArgumentException('invalid value for $cli_conn_status when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setClientOptions($client_options)
    {
        ...
        if (!is_null($client_options) && (count($client_options) > 0)) {
            throw new \InvalidArgumentException('invalid value for $client_options when calling InlineObject321., number of items must be less than or equal to 0.');
        }
    ...
    public function setDistance($distance)
    {
        ...
        if (!is_null($distance) && ($distance > 255)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject321., must be smaller than or equal to 255.');
        }
        if (!is_null($distance) && ($distance < 1)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setPriority($priority)
    {
        ...
        if (!is_null($priority) && ($priority > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($priority) && ($priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setDhcpRelayInterface($dhcp_relay_interface)
    {
        if (!is_null($dhcp_relay_interface) && (mb_strlen($dhcp_relay_interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $dhcp_relay_interface when calling InlineObject321., must be smaller than or equal to 15.');
        }
    ...
    public function setPingServStatus($ping_serv_status)
    {
        ...
        if (!is_null($ping_serv_status) && ($ping_serv_status > 255)) {
            throw new \InvalidArgumentException('invalid value for $ping_serv_status when calling InlineObject321., must be smaller than or equal to 255.');
        }
        if (!is_null($ping_serv_status) && ($ping_serv_status < 0)) {
            throw new \InvalidArgumentException('invalid value for $ping_serv_status when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setHaPriority($ha_priority)
    {
        ...
        if (!is_null($ha_priority) && ($ha_priority > 50)) {
            throw new \InvalidArgumentException('invalid value for $ha_priority when calling InlineObject321., must be smaller than or equal to 50.');
        }
        if (!is_null($ha_priority) && ($ha_priority < 1)) {
            throw new \InvalidArgumentException('invalid value for $ha_priority when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setFailAlertInterfaces($fail_alert_interfaces)
    {
        ...
        if (!is_null($fail_alert_interfaces) && (count($fail_alert_interfaces) > 0)) {
            throw new \InvalidArgumentException('invalid value for $fail_alert_interfaces when calling InlineObject321., number of items must be less than or equal to 0.');
        }
    ...
    public function setDhcpClientIdentifier($dhcp_client_identifier)
    {
        if (!is_null($dhcp_client_identifier) && (mb_strlen($dhcp_client_identifier) > 48)) {
            throw new \InvalidArgumentException('invalid length for $dhcp_client_identifier when calling InlineObject321., must be smaller than or equal to 48.');
        }
    ...
    public function setDhcpRenewTime($dhcp_renew_time)
    {
        ...
        if (!is_null($dhcp_renew_time) && ($dhcp_renew_time > 604800)) {
            throw new \InvalidArgumentException('invalid value for $dhcp_renew_time when calling InlineObject321., must be smaller than or equal to 604800.');
        }
        if (!is_null($dhcp_renew_time) && ($dhcp_renew_time < 300)) {
            throw new \InvalidArgumentException('invalid value for $dhcp_renew_time when calling InlineObject321., must be bigger than or equal to 300.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject321., must be smaller than or equal to 64.');
        }
    ...
    public function setIdleTimeout($idle_timeout)
    {
        ...
        if (!is_null($idle_timeout) && ($idle_timeout > 32767)) {
            throw new \InvalidArgumentException('invalid value for $idle_timeout when calling InlineObject321., must be smaller than or equal to 32767.');
        }
        if (!is_null($idle_timeout) && ($idle_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $idle_timeout when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setDetectedPeerMtu($detected_peer_mtu)
    {
        ...
        if (!is_null($detected_peer_mtu) && ($detected_peer_mtu > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $detected_peer_mtu when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($detected_peer_mtu) && ($detected_peer_mtu < 0)) {
            throw new \InvalidArgumentException('invalid value for $detected_peer_mtu when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setDiscRetryTimeout($disc_retry_timeout)
    {
        ...
        if (!is_null($disc_retry_timeout) && ($disc_retry_timeout > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $disc_retry_timeout when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($disc_retry_timeout) && ($disc_retry_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $disc_retry_timeout when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setPadtRetryTimeout($padt_retry_timeout)
    {
        ...
        if (!is_null($padt_retry_timeout) && ($padt_retry_timeout > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $padt_retry_timeout when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($padt_retry_timeout) && ($padt_retry_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $padt_retry_timeout when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setServiceName($service_name)
    {
        if (!is_null($service_name) && (mb_strlen($service_name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $service_name when calling InlineObject321., must be smaller than or equal to 63.');
        }
    ...
    public function setAcName($ac_name)
    {
        if (!is_null($ac_name) && (mb_strlen($ac_name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $ac_name when calling InlineObject321., must be smaller than or equal to 63.');
        }
    ...
    public function setLcpEchoInterval($lcp_echo_interval)
    {
        ...
        if (!is_null($lcp_echo_interval) && ($lcp_echo_interval > 32767)) {
            throw new \InvalidArgumentException('invalid value for $lcp_echo_interval when calling InlineObject321., must be smaller than or equal to 32767.');
        }
        if (!is_null($lcp_echo_interval) && ($lcp_echo_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $lcp_echo_interval when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setLcpMaxEchoFails($lcp_max_echo_fails)
    {
        ...
        if (!is_null($lcp_max_echo_fails) && ($lcp_max_echo_fails > 32767)) {
            throw new \InvalidArgumentException('invalid value for $lcp_max_echo_fails when calling InlineObject321., must be smaller than or equal to 32767.');
        }
        if (!is_null($lcp_max_echo_fails) && ($lcp_max_echo_fails < 0)) {
            throw new \InvalidArgumentException('invalid value for $lcp_max_echo_fails when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setPptpUser($pptp_user)
    {
        if (!is_null($pptp_user) && (mb_strlen($pptp_user) > 64)) {
            throw new \InvalidArgumentException('invalid length for $pptp_user when calling InlineObject321., must be smaller than or equal to 64.');
        }
    ...
    public function setPptpTimeout($pptp_timeout)
    {
        ...
        if (!is_null($pptp_timeout) && ($pptp_timeout > 65535)) {
            throw new \InvalidArgumentException('invalid value for $pptp_timeout when calling InlineObject321., must be smaller than or equal to 65535.');
        }
        if (!is_null($pptp_timeout) && ($pptp_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $pptp_timeout when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setBfdDesiredMinTx($bfd_desired_min_tx)
    {
        ...
        if (!is_null($bfd_desired_min_tx) && ($bfd_desired_min_tx > 100000)) {
            throw new \InvalidArgumentException('invalid value for $bfd_desired_min_tx when calling InlineObject321., must be smaller than or equal to 100000.');
        }
        if (!is_null($bfd_desired_min_tx) && ($bfd_desired_min_tx < 1)) {
            throw new \InvalidArgumentException('invalid value for $bfd_desired_min_tx when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setBfdDetectMult($bfd_detect_mult)
    {
        ...
        if (!is_null($bfd_detect_mult) && ($bfd_detect_mult > 50)) {
            throw new \InvalidArgumentException('invalid value for $bfd_detect_mult when calling InlineObject321., must be smaller than or equal to 50.');
        }
        if (!is_null($bfd_detect_mult) && ($bfd_detect_mult < 1)) {
            throw new \InvalidArgumentException('invalid value for $bfd_detect_mult when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setBfdRequiredMinRx($bfd_required_min_rx)
    {
        ...
        if (!is_null($bfd_required_min_rx) && ($bfd_required_min_rx > 100000)) {
            throw new \InvalidArgumentException('invalid value for $bfd_required_min_rx when calling InlineObject321., must be smaller than or equal to 100000.');
        }
        if (!is_null($bfd_required_min_rx) && ($bfd_required_min_rx < 1)) {
            throw new \InvalidArgumentException('invalid value for $bfd_required_min_rx when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setMtu($mtu)
    {
        ...
        if (!is_null($mtu) && ($mtu > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $mtu when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($mtu) && ($mtu < 0)) {
            throw new \InvalidArgumentException('invalid value for $mtu when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setSampleRate($sample_rate)
    {
        ...
        if (!is_null($sample_rate) && ($sample_rate > 99999)) {
            throw new \InvalidArgumentException('invalid value for $sample_rate when calling InlineObject321., must be smaller than or equal to 99999.');
        }
        if (!is_null($sample_rate) && ($sample_rate < 10)) {
            throw new \InvalidArgumentException('invalid value for $sample_rate when calling InlineObject321., must be bigger than or equal to 10.');
        }
    ...
    public function setPollingInterval($polling_interval)
    {
        ...
        if (!is_null($polling_interval) && ($polling_interval > 255)) {
            throw new \InvalidArgumentException('invalid value for $polling_interval when calling InlineObject321., must be smaller than or equal to 255.');
        }
        if (!is_null($polling_interval) && ($polling_interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $polling_interval when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setTcpMss($tcp_mss)
    {
        ...
        if (!is_null($tcp_mss) && ($tcp_mss > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $tcp_mss when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($tcp_mss) && ($tcp_mss < 0)) {
            throw new \InvalidArgumentException('invalid value for $tcp_mss when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setInbandwidth($inbandwidth)
    {
        ...
        if (!is_null($inbandwidth) && ($inbandwidth > 16776000)) {
            throw new \InvalidArgumentException('invalid value for $inbandwidth when calling InlineObject321., must be smaller than or equal to 16776000.');
        }
        if (!is_null($inbandwidth) && ($inbandwidth < 0)) {
            throw new \InvalidArgumentException('invalid value for $inbandwidth when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setOutbandwidth($outbandwidth)
    {
        ...
        if (!is_null($outbandwidth) && ($outbandwidth > 16776000)) {
            throw new \InvalidArgumentException('invalid value for $outbandwidth when calling InlineObject321., must be smaller than or equal to 16776000.');
        }
        if (!is_null($outbandwidth) && ($outbandwidth < 0)) {
            throw new \InvalidArgumentException('invalid value for $outbandwidth when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setEgressShapingProfile($egress_shaping_profile)
    {
        if (!is_null($egress_shaping_profile) && (mb_strlen($egress_shaping_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $egress_shaping_profile when calling InlineObject321., must be smaller than or equal to 35.');
        }
    ...
    public function setIngressShapingProfile($ingress_shaping_profile)
    {
        if (!is_null($ingress_shaping_profile) && (mb_strlen($ingress_shaping_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ingress_shaping_profile when calling InlineObject321., must be smaller than or equal to 35.');
        }
    ...
    public function setDisconnectThreshold($disconnect_threshold)
    {
        ...
        if (!is_null($disconnect_threshold) && ($disconnect_threshold > 10000)) {
            throw new \InvalidArgumentException('invalid value for $disconnect_threshold when calling InlineObject321., must be smaller than or equal to 10000.');
        }
        if (!is_null($disconnect_threshold) && ($disconnect_threshold < 0)) {
            throw new \InvalidArgumentException('invalid value for $disconnect_threshold when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setSpilloverThreshold($spillover_threshold)
    {
        ...
        if (!is_null($spillover_threshold) && ($spillover_threshold > 16776000)) {
            throw new \InvalidArgumentException('invalid value for $spillover_threshold when calling InlineObject321., must be smaller than or equal to 16776000.');
        }
        if (!is_null($spillover_threshold) && ($spillover_threshold < 0)) {
            throw new \InvalidArgumentException('invalid value for $spillover_threshold when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setIngressSpilloverThreshold($ingress_spillover_threshold)
    {
        ...
        if (!is_null($ingress_spillover_threshold) && ($ingress_spillover_threshold > 16776000)) {
            throw new \InvalidArgumentException('invalid value for $ingress_spillover_threshold when calling InlineObject321., must be smaller than or equal to 16776000.');
        }
        if (!is_null($ingress_spillover_threshold) && ($ingress_spillover_threshold < 0)) {
            throw new \InvalidArgumentException('invalid value for $ingress_spillover_threshold when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight > 255)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling InlineObject321., must be smaller than or equal to 255.');
        }
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject321., must be smaller than or equal to 15.');
        }
    ...
    public function setVlanid($vlanid)
    {
        ...
        if (!is_null($vlanid) && ($vlanid > 4094)) {
            throw new \InvalidArgumentException('invalid value for $vlanid when calling InlineObject321., must be smaller than or equal to 4094.');
        }
        if (!is_null($vlanid) && ($vlanid < 1)) {
            throw new \InvalidArgumentException('invalid value for $vlanid when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setForwardDomain($forward_domain)
    {
        ...
        if (!is_null($forward_domain) && ($forward_domain > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $forward_domain when calling InlineObject321., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($forward_domain) && ($forward_domain < 0)) {
            throw new \InvalidArgumentException('invalid value for $forward_domain when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setMember($member)
    {
        ...
        if (!is_null($member) && (count($member) > 0)) {
            throw new \InvalidArgumentException('invalid value for $member when calling InlineObject321., number of items must be less than or equal to 0.');
        }
    ...
    public function setMinLinks($min_links)
    {
        ...
        if (!is_null($min_links) && ($min_links > 32)) {
            throw new \InvalidArgumentException('invalid value for $min_links when calling InlineObject321., must be smaller than or equal to 32.');
        }
        if (!is_null($min_links) && ($min_links < 1)) {
            throw new \InvalidArgumentException('invalid value for $min_links when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setLinkUpDelay($link_up_delay)
    {
        ...
        if (!is_null($link_up_delay) && ($link_up_delay > 3600000)) {
            throw new \InvalidArgumentException('invalid value for $link_up_delay when calling InlineObject321., must be smaller than or equal to 3600000.');
        }
        if (!is_null($link_up_delay) && ($link_up_delay < 50)) {
            throw new \InvalidArgumentException('invalid value for $link_up_delay when calling InlineObject321., must be bigger than or equal to 50.');
        }
    ...
    public function setAggregate($aggregate)
    {
        if (!is_null($aggregate) && (mb_strlen($aggregate) > 15)) {
            throw new \InvalidArgumentException('invalid length for $aggregate when calling InlineObject321., must be smaller than or equal to 15.');
        }
    ...
    public function setRedundantInterface($redundant_interface)
    {
        if (!is_null($redundant_interface) && (mb_strlen($redundant_interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $redundant_interface when calling InlineObject321., must be smaller than or equal to 15.');
        }
    ...
    public function setDevindex($devindex)
    {
        ...
        if (!is_null($devindex) && ($devindex > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $devindex when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($devindex) && ($devindex < 0)) {
            throw new \InvalidArgumentException('invalid value for $devindex when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setVindex($vindex)
    {
        ...
        if (!is_null($vindex) && ($vindex > 65535)) {
            throw new \InvalidArgumentException('invalid value for $vindex when calling InlineObject321., must be smaller than or equal to 65535.');
        }
        if (!is_null($vindex) && ($vindex < 0)) {
            throw new \InvalidArgumentException('invalid value for $vindex when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setSwitch($switch)
    {
        if (!is_null($switch) && (mb_strlen($switch) > 15)) {
            throw new \InvalidArgumentException('invalid length for $switch when calling InlineObject321., must be smaller than or equal to 15.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject321., must be smaller than or equal to 255.');
        }
    ...
    public function setAlias($alias)
    {
        if (!is_null($alias) && (mb_strlen($alias) > 25)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling InlineObject321., must be smaller than or equal to 25.');
        }
    ...
    public function setL2tpClientSettings($l2tp_client_settings)
    {
        ...
        if (!is_null($l2tp_client_settings) && (count($l2tp_client_settings) > 0)) {
            throw new \InvalidArgumentException('invalid value for $l2tp_client_settings when calling InlineObject321., number of items must be less than or equal to 0.');
        }
    ...
    public function setSecurity8021xMaster($security_8021x_master)
    {
        if (!is_null($security_8021x_master) && (mb_strlen($security_8021x_master) > 15)) {
            throw new \InvalidArgumentException('invalid length for $security_8021x_master when calling InlineObject321., must be smaller than or equal to 15.');
        }
    ...
    public function setSecurity8021xDynamicVlanId($security_8021x_dynamic_vlan_id)
    {
        ...
        if (!is_null($security_8021x_dynamic_vlan_id) && ($security_8021x_dynamic_vlan_id > 4094)) {
            throw new \InvalidArgumentException('invalid value for $security_8021x_dynamic_vlan_id when calling InlineObject321., must be smaller than or equal to 4094.');
        }
        if (!is_null($security_8021x_dynamic_vlan_id) && ($security_8021x_dynamic_vlan_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $security_8021x_dynamic_vlan_id when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setSecurityExternalWeb($security_external_web)
    {
        if (!is_null($security_external_web) && (mb_strlen($security_external_web) > 127)) {
            throw new \InvalidArgumentException('invalid length for $security_external_web when calling InlineObject321., must be smaller than or equal to 127.');
        }
    ...
    public function setSecurityExternalLogout($security_external_logout)
    {
        if (!is_null($security_external_logout) && (mb_strlen($security_external_logout) > 127)) {
            throw new \InvalidArgumentException('invalid length for $security_external_logout when calling InlineObject321., must be smaller than or equal to 127.');
        }
    ...
    public function setReplacemsgOverrideGroup($replacemsg_override_group)
    {
        if (!is_null($replacemsg_override_group) && (mb_strlen($replacemsg_override_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $replacemsg_override_group when calling InlineObject321., must be smaller than or equal to 35.');
        }
    ...
    public function setSecurityRedirectUrl($security_redirect_url)
    {
        if (!is_null($security_redirect_url) && (mb_strlen($security_redirect_url) > 127)) {
            throw new \InvalidArgumentException('invalid length for $security_redirect_url when calling InlineObject321., must be smaller than or equal to 127.');
        }
    ...
    public function setSecurityExemptList($security_exempt_list)
    {
        if (!is_null($security_exempt_list) && (mb_strlen($security_exempt_list) > 35)) {
            throw new \InvalidArgumentException('invalid length for $security_exempt_list when calling InlineObject321., must be smaller than or equal to 35.');
        }
    ...
    public function setSecurityGroups($security_groups)
    {
        ...
        if (!is_null($security_groups) && (count($security_groups) > 0)) {
            throw new \InvalidArgumentException('invalid value for $security_groups when calling InlineObject321., number of items must be less than or equal to 0.');
        }
    ...
    public function setLldpNetworkPolicy($lldp_network_policy)
    {
        if (!is_null($lldp_network_policy) && (mb_strlen($lldp_network_policy) > 35)) {
            throw new \InvalidArgumentException('invalid length for $lldp_network_policy when calling InlineObject321., must be smaller than or equal to 35.');
        }
    ...
    public function setEstimatedUpstreamBandwidth($estimated_upstream_bandwidth)
    {
        ...
        if (!is_null($estimated_upstream_bandwidth) && ($estimated_upstream_bandwidth > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $estimated_upstream_bandwidth when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($estimated_upstream_bandwidth) && ($estimated_upstream_bandwidth < 0)) {
            throw new \InvalidArgumentException('invalid value for $estimated_upstream_bandwidth when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setEstimatedDownstreamBandwidth($estimated_downstream_bandwidth)
    {
        ...
        if (!is_null($estimated_downstream_bandwidth) && ($estimated_downstream_bandwidth > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $estimated_downstream_bandwidth when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($estimated_downstream_bandwidth) && ($estimated_downstream_bandwidth < 0)) {
            throw new \InvalidArgumentException('invalid value for $estimated_downstream_bandwidth when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setMeasuredUpstreamBandwidth($measured_upstream_bandwidth)
    {
        ...
        if (!is_null($measured_upstream_bandwidth) && ($measured_upstream_bandwidth > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $measured_upstream_bandwidth when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($measured_upstream_bandwidth) && ($measured_upstream_bandwidth < 0)) {
            throw new \InvalidArgumentException('invalid value for $measured_upstream_bandwidth when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setMeasuredDownstreamBandwidth($measured_downstream_bandwidth)
    {
        ...
        if (!is_null($measured_downstream_bandwidth) && ($measured_downstream_bandwidth > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $measured_downstream_bandwidth when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($measured_downstream_bandwidth) && ($measured_downstream_bandwidth < 0)) {
            throw new \InvalidArgumentException('invalid value for $measured_downstream_bandwidth when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setBandwidthMeasureTime($bandwidth_measure_time)
    {
        ...
        if (!is_null($bandwidth_measure_time) && ($bandwidth_measure_time > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth_measure_time when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($bandwidth_measure_time) && ($bandwidth_measure_time < 0)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth_measure_time when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setVrrp($vrrp)
    {
        ...
        if (!is_null($vrrp) && (count($vrrp) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vrrp when calling InlineObject321., number of items must be less than or equal to 0.');
        }
    ...
    public function setSnmpIndex($snmp_index)
    {
        ...
        if (!is_null($snmp_index) && ($snmp_index > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $snmp_index when calling InlineObject321., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($snmp_index) && ($snmp_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $snmp_index when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setSecondaryip($secondaryip)
    {
        ...
        if (!is_null($secondaryip) && (count($secondaryip) > 32)) {
            throw new \InvalidArgumentException('invalid value for $secondaryip when calling InlineObject321., number of items must be less than or equal to 32.');
        }
    ...
    public function setInternal($internal)
    {
        ...
        if (!is_null($internal) && ($internal > 255)) {
            throw new \InvalidArgumentException('invalid value for $internal when calling InlineObject321., must be smaller than or equal to 255.');
        }
        if (!is_null($internal) && ($internal < 0)) {
            throw new \InvalidArgumentException('invalid value for $internal when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setFortilinkBackupLink($fortilink_backup_link)
    {
        ...
        if (!is_null($fortilink_backup_link) && ($fortilink_backup_link > 255)) {
            throw new \InvalidArgumentException('invalid value for $fortilink_backup_link when calling InlineObject321., must be smaller than or equal to 255.');
        }
        if (!is_null($fortilink_backup_link) && ($fortilink_backup_link < 0)) {
            throw new \InvalidArgumentException('invalid value for $fortilink_backup_link when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setSwitchControllerTrafficPolicy($switch_controller_traffic_policy)
    {
        if (!is_null($switch_controller_traffic_policy) && (mb_strlen($switch_controller_traffic_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $switch_controller_traffic_policy when calling InlineObject321., must be smaller than or equal to 63.');
        }
    ...
    public function setSwitchControllerMgmtVlan($switch_controller_mgmt_vlan)
    {
        ...
        if (!is_null($switch_controller_mgmt_vlan) && ($switch_controller_mgmt_vlan > 4094)) {
            throw new \InvalidArgumentException('invalid value for $switch_controller_mgmt_vlan when calling InlineObject321., must be smaller than or equal to 4094.');
        }
        if (!is_null($switch_controller_mgmt_vlan) && ($switch_controller_mgmt_vlan < 1)) {
            throw new \InvalidArgumentException('invalid value for $switch_controller_mgmt_vlan when calling InlineObject321., must be bigger than or equal to 1.');
        }
    ...
    public function setSwitchControllerLearningLimit($switch_controller_learning_limit)
    {
        ...
        if (!is_null($switch_controller_learning_limit) && ($switch_controller_learning_limit > 128)) {
            throw new \InvalidArgumentException('invalid value for $switch_controller_learning_limit when calling InlineObject321., must be smaller than or equal to 128.');
        }
        if (!is_null($switch_controller_learning_limit) && ($switch_controller_learning_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $switch_controller_learning_limit when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setSwitchControllerNac($switch_controller_nac)
    {
        if (!is_null($switch_controller_nac) && (mb_strlen($switch_controller_nac) > 35)) {
            throw new \InvalidArgumentException('invalid length for $switch_controller_nac when calling InlineObject321., must be smaller than or equal to 35.');
        }
    ...
    public function setSwcVlan($swc_vlan)
    {
        ...
        if (!is_null($swc_vlan) && ($swc_vlan > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $swc_vlan when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($swc_vlan) && ($swc_vlan < 0)) {
            throw new \InvalidArgumentException('invalid value for $swc_vlan when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setSwcFirstCreate($swc_first_create)
    {
        ...
        if (!is_null($swc_first_create) && ($swc_first_create > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $swc_first_create when calling InlineObject321., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($swc_first_create) && ($swc_first_create < 0)) {
            throw new \InvalidArgumentException('invalid value for $swc_first_create when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && ($color > 32)) {
            throw new \InvalidArgumentException('invalid value for $color when calling InlineObject321., must be smaller than or equal to 32.');
        }
        if (!is_null($color) && ($color < 0)) {
            throw new \InvalidArgumentException('invalid value for $color when calling InlineObject321., must be bigger than or equal to 0.');
        }
    ...
    public function setTagging($tagging)
    {
        ...
        if (!is_null($tagging) && (count($tagging) > 0)) {
            throw new \InvalidArgumentException('invalid value for $tagging when calling InlineObject321., number of items must be less than or equal to 0.');
        }
    ...
    public function setIpv6($ipv6)
    {
        ...
        if (!is_null($ipv6) && (count($ipv6) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ipv6 when calling InlineObject321., number of items must be less than or equal to 0.');
        }
