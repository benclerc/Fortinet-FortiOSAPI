...
/**
 * InlineObject482 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject482 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_482';
    ...
    protected static $setters = [
        ...
        'use_natip' => 'setUseNatip',
        'selector_match' => 'setSelectorMatch',
    ...
    protected static $getters = [
        ...
        'use_natip' => 'getUseNatip',
        'selector_match' => 'getSelectorMatch',
    ...
    const USE_NATIP_ENABLE = 'enable';
    const USE_NATIP_DISABLE = 'disable';
    const SELECTOR_MATCH_EXACT = 'exact';
    const SELECTOR_MATCH_SUBSET = 'subset';
    const SELECTOR_MATCH_AUTO = 'auto';
     ...
     * @return string[]
     */
    public function getUseNatipAllowableValues()
    {
        return [
            self::USE_NATIP_ENABLE,
            self::USE_NATIP_DISABLE,
        ];
    }
     ...
     * @return string[]
     */
    public function getSelectorMatchAllowableValues()
    {
        return [
            self::SELECTOR_MATCH_EXACT,
            self::SELECTOR_MATCH_SUBSET,
            self::SELECTOR_MATCH_AUTO,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['use_natip'] = $data['use_natip'] ?? null;
        $this->container['selector_match'] = $data['selector_match'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['phase1name']) && (mb_strlen($this->container['phase1name']) > 35)) {
            $invalidProperties[] = "invalid value for 'phase1name', the character length must be smaller than or equal to 35.";
        }
        ...
        $allowedValues = $this->getUseNatipAllowableValues();
        if (!is_null($this->container['use_natip']) && !in_array($this->container['use_natip'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'use_natip', must be one of '%s'",
                $this->container['use_natip'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getSelectorMatchAllowableValues();
        if (!is_null($this->container['selector_match']) && !in_array($this->container['selector_match'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'selector_match', must be one of '%s'",
                $this->container['selector_match'],
                implode("', '", $allowedValues)
            );
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject482., must be smaller than or equal to 35.');
        }
    ...
    {
        if (!is_null($phase1name) && (mb_strlen($phase1name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $phase1name when calling InlineObject482., must be smaller than or equal to 35.');
        }
     ...
     * @return string|null
     */
    public function getUseNatip()
    {
        return $this->container['use_natip'];
    }

    /**
     * Sets use_natip
     *
     * @param string|null $use_natip Enable to use the FortiGate public IP as the source selector when outbound NAT is used.    enable:Replace source selector with interface IP when using outbound NAT.    disable:Do not modify source selector when using outbound NAT.
     *
     * @return self
     */
    public function setUseNatip($use_natip)
    {
        $allowedValues = $this->getUseNatipAllowableValues();
        if (!is_null($use_natip) && !in_array($use_natip, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'use_natip', must be one of '%s'",
                    $use_natip,
        ...
        $this->container['use_natip'] = $use_natip;
     ...
     * @return string|null
     */
    public function getSelectorMatch()
    {
        return $this->container['selector_match'];
    }

    /**
     * Sets selector_match
     *
     * @param string|null $selector_match Match type to use when comparing selectors.    exact:Match selectors exactly.    subset:Match selectors by subset.    auto:Use subset or exact match depending on selector address type.
     *
     * @return self
     */
    public function setSelectorMatch($selector_match)
    {
        $allowedValues = $this->getSelectorMatchAllowableValues();
        if (!is_null($selector_match) && !in_array($selector_match, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'selector_match', must be one of '%s'",
                    $selector_match,
        ...
        $this->container['selector_match'] = $selector_match;
    ...
    public function setKeylifeseconds($keylifeseconds)
    {
        ...
        if (!is_null($keylifeseconds) && ($keylifeseconds > 172800)) {
            throw new \InvalidArgumentException('invalid value for $keylifeseconds when calling InlineObject482., must be smaller than or equal to 172800.');
        }
        if (!is_null($keylifeseconds) && ($keylifeseconds < 120)) {
            throw new \InvalidArgumentException('invalid value for $keylifeseconds when calling InlineObject482., must be bigger than or equal to 120.');
        }
    ...
    public function setKeylifekbs($keylifekbs)
    {
        ...
        if (!is_null($keylifekbs) && ($keylifekbs > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $keylifekbs when calling InlineObject482., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($keylifekbs) && ($keylifekbs < 5120)) {
            throw new \InvalidArgumentException('invalid value for $keylifekbs when calling InlineObject482., must be bigger than or equal to 5120.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject482., must be smaller than or equal to 255.');
        }
    ...
    public function setProtocol($protocol)
    {
        ...
        if (!is_null($protocol) && ($protocol > 255)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject482., must be smaller than or equal to 255.');
        }
        if (!is_null($protocol) && ($protocol < 0)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject482., must be bigger than or equal to 0.');
        }
    ...
    public function setSrcName($src_name)
    {
        if (!is_null($src_name) && (mb_strlen($src_name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $src_name when calling InlineObject482., must be smaller than or equal to 79.');
        }
    ...
    public function setSrcName6($src_name6)
    {
        if (!is_null($src_name6) && (mb_strlen($src_name6) > 79)) {
            throw new \InvalidArgumentException('invalid length for $src_name6 when calling InlineObject482., must be smaller than or equal to 79.');
        }
     ...
     * Sets src_addr_type
     *
     * @param string|null $src_addr_type Local proxy ID type.    subnet:IPv4 subnet.    range:IPv4 range.    ip:IPv4 IP.    name:IPv4 firewall address or group name.
     *
     * @return self
     */
    ...
    public function setSrcPort($src_port)
    {
        ...
        if (!is_null($src_port) && ($src_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $src_port when calling InlineObject482., must be smaller than or equal to 65535.');
        }
        if (!is_null($src_port) && ($src_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $src_port when calling InlineObject482., must be bigger than or equal to 0.');
        }
    ...
    public function setDstName($dst_name)
    {
        if (!is_null($dst_name) && (mb_strlen($dst_name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $dst_name when calling InlineObject482., must be smaller than or equal to 79.');
        }
    ...
    public function setDstName6($dst_name6)
    {
        if (!is_null($dst_name6) && (mb_strlen($dst_name6) > 79)) {
            throw new \InvalidArgumentException('invalid length for $dst_name6 when calling InlineObject482., must be smaller than or equal to 79.');
        }
     ...
     * Sets dst_addr_type
     *
     * @param string|null $dst_addr_type Remote proxy ID type.    subnet:IPv4 subnet.    range:IPv4 range.    ip:IPv4 IP.    name:IPv4 firewall address or group name.
     *
     * @return self
     */
    ...
    public function setDstPort($dst_port)
    {
        ...
        if (!is_null($dst_port) && ($dst_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $dst_port when calling InlineObject482., must be smaller than or equal to 65535.');
        }
        if (!is_null($dst_port) && ($dst_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $dst_port when calling InlineObject482., must be bigger than or equal to 0.');
        }
