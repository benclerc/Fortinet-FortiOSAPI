...
/**
 * VpnSslWebPortalNameBookmarks Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class VpnSslWebPortalNameBookmarks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_vpn_ssl_web_portal__name__bookmarks';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['form_data']) && (count($this->container['form_data']) > 0)) {
            $invalidProperties[] = "invalid value for 'form_data', number of items must be less than or equal to 0.";
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 35.');
        }
    ...
    public function setUrl($url)
    {
        if (!is_null($url) && (mb_strlen($url) > 128)) {
            throw new \InvalidArgumentException('invalid length for $url when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 128.');
        }
    ...
    public function setHost($host)
    {
        if (!is_null($host) && (mb_strlen($host) > 128)) {
            throw new \InvalidArgumentException('invalid length for $host when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 128.');
        }
    ...
    public function setFolder($folder)
    {
        if (!is_null($folder) && (mb_strlen($folder) > 128)) {
            throw new \InvalidArgumentException('invalid length for $folder when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 128.');
        }
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 128)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 128.');
        }
    ...
    public function setAdditionalParams($additional_params)
    {
        if (!is_null($additional_params) && (mb_strlen($additional_params) > 128)) {
            throw new \InvalidArgumentException('invalid length for $additional_params when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 128.');
        }
    ...
    public function setListeningPort($listening_port)
    {
        ...
        if (!is_null($listening_port) && ($listening_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $listening_port when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 65535.');
        }
        if (!is_null($listening_port) && ($listening_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $listening_port when calling VpnSslWebPortalNameBookmarks., must be bigger than or equal to 0.');
        }
    ...
    public function setRemotePort($remote_port)
    {
        ...
        if (!is_null($remote_port) && ($remote_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $remote_port when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 65535.');
        }
        if (!is_null($remote_port) && ($remote_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $remote_port when calling VpnSslWebPortalNameBookmarks., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 128)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 128.');
        }
    ...
    public function setPreconnectionId($preconnection_id)
    {
        ...
        if (!is_null($preconnection_id) && ($preconnection_id > 2147483648)) {
            throw new \InvalidArgumentException('invalid value for $preconnection_id when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 2147483648.');
        }
        if (!is_null($preconnection_id) && ($preconnection_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $preconnection_id when calling VpnSslWebPortalNameBookmarks., must be bigger than or equal to 0.');
        }
    ...
    public function setPreconnectionBlob($preconnection_blob)
    {
        if (!is_null($preconnection_blob) && (mb_strlen($preconnection_blob) > 511)) {
            throw new \InvalidArgumentException('invalid length for $preconnection_blob when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 511.');
        }
    ...
    public function setLoadBalancingInfo($load_balancing_info)
    {
        if (!is_null($load_balancing_info) && (mb_strlen($load_balancing_info) > 511)) {
            throw new \InvalidArgumentException('invalid length for $load_balancing_info when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 511.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling VpnSslWebPortalNameBookmarks., must be bigger than or equal to 0.');
        }
    ...
    public function setLogonUser($logon_user)
    {
        if (!is_null($logon_user) && (mb_strlen($logon_user) > 35)) {
            throw new \InvalidArgumentException('invalid length for $logon_user when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 35.');
        }
    ...
    public function setFormData($form_data)
    {
        ...
        if (!is_null($form_data) && (count($form_data) > 0)) {
            throw new \InvalidArgumentException('invalid value for $form_data when calling VpnSslWebPortalNameBookmarks., number of items must be less than or equal to 0.');
        }
    ...
    public function setSsoUsername($sso_username)
    {
        if (!is_null($sso_username) && (mb_strlen($sso_username) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sso_username when calling VpnSslWebPortalNameBookmarks., must be smaller than or equal to 35.');
        }
