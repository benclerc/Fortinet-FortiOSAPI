 ...
 */
class InlineObject182 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSeqNum($seq_num)
    {
        ...
        if (!is_null($seq_num) && ($seq_num > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject182., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($seq_num) && ($seq_num < 0)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject182., must be bigger than or equal to 0.');
        }
    ...
    public function setDistance($distance)
    {
        ...
        if (!is_null($distance) && ($distance > 255)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject182., must be smaller than or equal to 255.');
        }
        if (!is_null($distance) && ($distance < 1)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject182., must be bigger than or equal to 1.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight > 255)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling InlineObject182., must be smaller than or equal to 255.');
        }
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling InlineObject182., must be bigger than or equal to 0.');
        }
    ...
    public function setPriority($priority)
    {
        ...
        if (!is_null($priority) && ($priority > 65535)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject182., must be smaller than or equal to 65535.');
        }
        if (!is_null($priority) && ($priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject182., must be bigger than or equal to 0.');
        }
    ...
    public function setDevice($device)
    {
        if (!is_null($device) && (mb_strlen($device) > 35)) {
            throw new \InvalidArgumentException('invalid length for $device when calling InlineObject182., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject182., must be smaller than or equal to 255.');
        }
    ...
    public function setDstaddr($dstaddr)
    {
        if (!is_null($dstaddr) && (mb_strlen($dstaddr) > 79)) {
            throw new \InvalidArgumentException('invalid length for $dstaddr when calling InlineObject182., must be smaller than or equal to 79.');
        }
    ...
    public function setInternetService($internet_service)
    {
        ...
        if (!is_null($internet_service) && ($internet_service > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $internet_service when calling InlineObject182., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($internet_service) && ($internet_service < 0)) {
            throw new \InvalidArgumentException('invalid value for $internet_service when calling InlineObject182., must be bigger than or equal to 0.');
        }
    ...
    public function setInternetServiceCustom($internet_service_custom)
    {
        if (!is_null($internet_service_custom) && (mb_strlen($internet_service_custom) > 64)) {
            throw new \InvalidArgumentException('invalid length for $internet_service_custom when calling InlineObject182., must be smaller than or equal to 64.');
        }
    ...
    public function setVrf($vrf)
    {
        ...
        if (!is_null($vrf) && ($vrf > 31)) {
            throw new \InvalidArgumentException('invalid value for $vrf when calling InlineObject182., must be smaller than or equal to 31.');
        }
        if (!is_null($vrf) && ($vrf < 0)) {
            throw new \InvalidArgumentException('invalid value for $vrf when calling InlineObject182., must be bigger than or equal to 0.');
        }
