...
/**
 * InlineObject311 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject311 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_311';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject311., must be smaller than or equal to 15.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject311., must be smaller than or equal to 15.');
        }
    ...
    public function setVni($vni)
    {
        ...
        if (!is_null($vni) && ($vni > 16777215)) {
            throw new \InvalidArgumentException('invalid value for $vni when calling InlineObject311., must be smaller than or equal to 16777215.');
        }
        if (!is_null($vni) && ($vni < 0)) {
            throw new \InvalidArgumentException('invalid value for $vni when calling InlineObject311., must be bigger than or equal to 0.');
        }
    ...
    public function setDstport($dstport)
    {
        ...
        if (!is_null($dstport) && ($dstport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $dstport when calling InlineObject311., must be smaller than or equal to 65535.');
        }
        if (!is_null($dstport) && ($dstport < 1)) {
            throw new \InvalidArgumentException('invalid value for $dstport when calling InlineObject311., must be bigger than or equal to 1.');
        }
