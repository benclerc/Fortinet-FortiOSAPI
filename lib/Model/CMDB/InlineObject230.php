...
/**
 * InlineObject230 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject230 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_230';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject230., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject230., must be smaller than or equal to 1023.');
        }
    ...
    public function setVoice($voice)
    {
        ...
        if (!is_null($voice) && (count($voice) > 0)) {
            throw new \InvalidArgumentException('invalid value for $voice when calling InlineObject230., number of items must be less than or equal to 0.');
        }
    ...
    public function setVoiceSignaling($voice_signaling)
    {
        ...
        if (!is_null($voice_signaling) && (count($voice_signaling) > 0)) {
            throw new \InvalidArgumentException('invalid value for $voice_signaling when calling InlineObject230., number of items must be less than or equal to 0.');
        }
    ...
    public function setGuest($guest)
    {
        ...
        if (!is_null($guest) && (count($guest) > 0)) {
            throw new \InvalidArgumentException('invalid value for $guest when calling InlineObject230., number of items must be less than or equal to 0.');
        }
    ...
    public function setGuestVoiceSignaling($guest_voice_signaling)
    {
        ...
        if (!is_null($guest_voice_signaling) && (count($guest_voice_signaling) > 0)) {
            throw new \InvalidArgumentException('invalid value for $guest_voice_signaling when calling InlineObject230., number of items must be less than or equal to 0.');
        }
    ...
    public function setSoftphone($softphone)
    {
        ...
        if (!is_null($softphone) && (count($softphone) > 0)) {
            throw new \InvalidArgumentException('invalid value for $softphone when calling InlineObject230., number of items must be less than or equal to 0.');
        }
    ...
    public function setVideoConferencing($video_conferencing)
    {
        ...
        if (!is_null($video_conferencing) && (count($video_conferencing) > 0)) {
            throw new \InvalidArgumentException('invalid value for $video_conferencing when calling InlineObject230., number of items must be less than or equal to 0.');
        }
    ...
    public function setStreamingVideo($streaming_video)
    {
        ...
        if (!is_null($streaming_video) && (count($streaming_video) > 0)) {
            throw new \InvalidArgumentException('invalid value for $streaming_video when calling InlineObject230., number of items must be less than or equal to 0.');
        }
    ...
    public function setVideoSignaling($video_signaling)
    {
        ...
        if (!is_null($video_signaling) && (count($video_signaling) > 0)) {
            throw new \InvalidArgumentException('invalid value for $video_signaling when calling InlineObject230., number of items must be less than or equal to 0.');
        }
