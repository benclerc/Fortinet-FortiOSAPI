 ...
 */
class InlineObject100 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets filter
     *
     * @param string|null $filter FortiAnalyzer 3 log filter.
     *
     * @return self
     */
    public function setFilter($filter)
    {
        if (!is_null($filter) && (mb_strlen($filter) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $filter when calling InlineObject100., must be smaller than or equal to 1023.');
        }
