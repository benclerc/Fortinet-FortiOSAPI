...
/**
 * InlineObject291 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject291 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_291';
    ...
    public function setDdnsid($ddnsid)
    {
        ...
        if (!is_null($ddnsid) && ($ddnsid > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $ddnsid when calling InlineObject291., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($ddnsid) && ($ddnsid < 0)) {
            throw new \InvalidArgumentException('invalid value for $ddnsid when calling InlineObject291., must be bigger than or equal to 0.');
        }
    ...
    public function setDdnsServerAddr($ddns_server_addr)
    {
        ...
        if (!is_null($ddns_server_addr) && (count($ddns_server_addr) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ddns_server_addr when calling InlineObject291., number of items must be less than or equal to 0.');
        }
    ...
    public function setDdnsZone($ddns_zone)
    {
        if (!is_null($ddns_zone) && (mb_strlen($ddns_zone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ddns_zone when calling InlineObject291., must be smaller than or equal to 64.');
        }
    ...
    public function setDdnsTtl($ddns_ttl)
    {
        ...
        if (!is_null($ddns_ttl) && ($ddns_ttl > 86400)) {
            throw new \InvalidArgumentException('invalid value for $ddns_ttl when calling InlineObject291., must be smaller than or equal to 86400.');
        }
        if (!is_null($ddns_ttl) && ($ddns_ttl < 60)) {
            throw new \InvalidArgumentException('invalid value for $ddns_ttl when calling InlineObject291., must be bigger than or equal to 60.');
        }
    ...
    public function setDdnsKeyname($ddns_keyname)
    {
        if (!is_null($ddns_keyname) && (mb_strlen($ddns_keyname) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ddns_keyname when calling InlineObject291., must be smaller than or equal to 64.');
        }
    ...
    public function setDdnsDomain($ddns_domain)
    {
        if (!is_null($ddns_domain) && (mb_strlen($ddns_domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ddns_domain when calling InlineObject291., must be smaller than or equal to 64.');
        }
    ...
    public function setDdnsUsername($ddns_username)
    {
        if (!is_null($ddns_username) && (mb_strlen($ddns_username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ddns_username when calling InlineObject291., must be smaller than or equal to 64.');
        }
    ...
    public function setDdnsSn($ddns_sn)
    {
        if (!is_null($ddns_sn) && (mb_strlen($ddns_sn) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ddns_sn when calling InlineObject291., must be smaller than or equal to 64.');
        }
    ...
    public function setUpdateInterval($update_interval)
    {
        ...
        if (!is_null($update_interval) && ($update_interval > 2592000)) {
            throw new \InvalidArgumentException('invalid value for $update_interval when calling InlineObject291., must be smaller than or equal to 2592000.');
        }
        if (!is_null($update_interval) && ($update_interval < 60)) {
            throw new \InvalidArgumentException('invalid value for $update_interval when calling InlineObject291., must be bigger than or equal to 60.');
        }
    ...
    public function setSslCertificate($ssl_certificate)
    {
        if (!is_null($ssl_certificate) && (mb_strlen($ssl_certificate) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ssl_certificate when calling InlineObject291., must be smaller than or equal to 35.');
        }
    ...
    public function setMonitorInterface($monitor_interface)
    {
        ...
        if (!is_null($monitor_interface) && (count($monitor_interface) > 0)) {
            throw new \InvalidArgumentException('invalid value for $monitor_interface when calling InlineObject291., number of items must be less than or equal to 0.');
        }
