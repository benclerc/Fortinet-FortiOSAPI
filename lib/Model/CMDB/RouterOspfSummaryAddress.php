...
/**
 * RouterOspfSummaryAddress Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class RouterOspfSummaryAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_router_ospf_summary_address';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RouterOspfSummaryAddress., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RouterOspfSummaryAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setTag($tag)
    {
        ...
        if (!is_null($tag) && ($tag > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $tag when calling RouterOspfSummaryAddress., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($tag) && ($tag < 0)) {
            throw new \InvalidArgumentException('invalid value for $tag when calling RouterOspfSummaryAddress., must be bigger than or equal to 0.');
        }
