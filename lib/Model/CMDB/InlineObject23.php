 ...
 */
class InlineObject23 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject23., must be smaller than or equal to 35.');
        }
    ...
    public function setUpdateVdom($update_vdom)
    {
        if (!is_null($update_vdom) && (mb_strlen($update_vdom) > 31)) {
            throw new \InvalidArgumentException('invalid length for $update_vdom when calling InlineObject23., must be smaller than or equal to 31.');
        }
    ...
    public function setLdapServer($ldap_server)
    {
        if (!is_null($ldap_server) && (mb_strlen($ldap_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ldap_server when calling InlineObject23., must be smaller than or equal to 35.');
        }
    ...
    public function setLdapUsername($ldap_username)
    {
        if (!is_null($ldap_username) && (mb_strlen($ldap_username) > 63)) {
            throw new \InvalidArgumentException('invalid length for $ldap_username when calling InlineObject23., must be smaller than or equal to 63.');
        }
    ...
    public function setHttpUrl($http_url)
    {
        if (!is_null($http_url) && (mb_strlen($http_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $http_url when calling InlineObject23., must be smaller than or equal to 255.');
        }
    ...
    public function setScepUrl($scep_url)
    {
        if (!is_null($scep_url) && (mb_strlen($scep_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $scep_url when calling InlineObject23., must be smaller than or equal to 255.');
        }
    ...
    public function setScepCert($scep_cert)
    {
        if (!is_null($scep_cert) && (mb_strlen($scep_cert) > 35)) {
            throw new \InvalidArgumentException('invalid length for $scep_cert when calling InlineObject23., must be smaller than or equal to 35.');
        }
    ...
    public function setUpdateInterval($update_interval)
    {
        ...
        if (!is_null($update_interval) && ($update_interval > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $update_interval when calling InlineObject23., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($update_interval) && ($update_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $update_interval when calling InlineObject23., must be bigger than or equal to 0.');
        }
