...
/**
 * InlineObject185 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject185 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_185';
    ...
    public function setSeqNum($seq_num)
    {
        ...
        if (!is_null($seq_num) && ($seq_num > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject185., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($seq_num) && ($seq_num < 0)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject185., must be bigger than or equal to 0.');
        }
    ...
    public function setDevice($device)
    {
        if (!is_null($device) && (mb_strlen($device) > 35)) {
            throw new \InvalidArgumentException('invalid length for $device when calling InlineObject185., must be smaller than or equal to 35.');
        }
    ...
    public function setDevindex($devindex)
    {
        ...
        if (!is_null($devindex) && ($devindex > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $devindex when calling InlineObject185., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($devindex) && ($devindex < 0)) {
            throw new \InvalidArgumentException('invalid value for $devindex when calling InlineObject185., must be bigger than or equal to 0.');
        }
    ...
    public function setDistance($distance)
    {
        ...
        if (!is_null($distance) && ($distance > 255)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject185., must be smaller than or equal to 255.');
        }
        if (!is_null($distance) && ($distance < 1)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject185., must be bigger than or equal to 1.');
        }
    ...
    public function setPriority($priority)
    {
        ...
        if (!is_null($priority) && ($priority > 65535)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject185., must be smaller than or equal to 65535.');
        }
        if (!is_null($priority) && ($priority < 1)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject185., must be bigger than or equal to 1.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject185., must be smaller than or equal to 255.');
        }
