...
/**
 * InlineObject614 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject614 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_614';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject614., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 63)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject614., must be smaller than or equal to 63.');
        }
    ...
    public function setApBgscanPeriod($ap_bgscan_period)
    {
        ...
        if (!is_null($ap_bgscan_period) && ($ap_bgscan_period > 3600)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_period when calling InlineObject614., must be smaller than or equal to 3600.');
        }
        if (!is_null($ap_bgscan_period) && ($ap_bgscan_period < 10)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_period when calling InlineObject614., must be bigger than or equal to 10.');
        }
    ...
    public function setApBgscanIntv($ap_bgscan_intv)
    {
        ...
        if (!is_null($ap_bgscan_intv) && ($ap_bgscan_intv > 600)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_intv when calling InlineObject614., must be smaller than or equal to 600.');
        }
        if (!is_null($ap_bgscan_intv) && ($ap_bgscan_intv < 1)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_intv when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setApBgscanDuration($ap_bgscan_duration)
    {
        ...
        if (!is_null($ap_bgscan_duration) && ($ap_bgscan_duration > 1000)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_duration when calling InlineObject614., must be smaller than or equal to 1000.');
        }
        if (!is_null($ap_bgscan_duration) && ($ap_bgscan_duration < 10)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_duration when calling InlineObject614., must be bigger than or equal to 10.');
        }
    ...
    public function setApBgscanIdle($ap_bgscan_idle)
    {
        ...
        if (!is_null($ap_bgscan_idle) && ($ap_bgscan_idle > 1000)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_idle when calling InlineObject614., must be smaller than or equal to 1000.');
        }
        if (!is_null($ap_bgscan_idle) && ($ap_bgscan_idle < 0)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_idle when calling InlineObject614., must be bigger than or equal to 0.');
        }
    ...
    public function setApBgscanReportIntv($ap_bgscan_report_intv)
    {
        ...
        if (!is_null($ap_bgscan_report_intv) && ($ap_bgscan_report_intv > 600)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_report_intv when calling InlineObject614., must be smaller than or equal to 600.');
        }
        if (!is_null($ap_bgscan_report_intv) && ($ap_bgscan_report_intv < 15)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_report_intv when calling InlineObject614., must be bigger than or equal to 15.');
        }
    ...
    public function setApBgscanDisableSchedules($ap_bgscan_disable_schedules)
    {
        ...
        if (!is_null($ap_bgscan_disable_schedules) && (count($ap_bgscan_disable_schedules) > 16)) {
            throw new \InvalidArgumentException('invalid value for $ap_bgscan_disable_schedules when calling InlineObject614., number of items must be less than or equal to 16.');
        }
    ...
    public function setApFgscanReportIntv($ap_fgscan_report_intv)
    {
        ...
        if (!is_null($ap_fgscan_report_intv) && ($ap_fgscan_report_intv > 600)) {
            throw new \InvalidArgumentException('invalid value for $ap_fgscan_report_intv when calling InlineObject614., must be smaller than or equal to 600.');
        }
        if (!is_null($ap_fgscan_report_intv) && ($ap_fgscan_report_intv < 15)) {
            throw new \InvalidArgumentException('invalid value for $ap_fgscan_report_intv when calling InlineObject614., must be bigger than or equal to 15.');
        }
    ...
    public function setApScanThreshold($ap_scan_threshold)
    {
        if (!is_null($ap_scan_threshold) && (mb_strlen($ap_scan_threshold) > 7)) {
            throw new \InvalidArgumentException('invalid length for $ap_scan_threshold when calling InlineObject614., must be smaller than or equal to 7.');
        }
    ...
    public function setLongDurationThresh($long_duration_thresh)
    {
        ...
        if (!is_null($long_duration_thresh) && ($long_duration_thresh > 32767)) {
            throw new \InvalidArgumentException('invalid value for $long_duration_thresh when calling InlineObject614., must be smaller than or equal to 32767.');
        }
        if (!is_null($long_duration_thresh) && ($long_duration_thresh < 1000)) {
            throw new \InvalidArgumentException('invalid value for $long_duration_thresh when calling InlineObject614., must be bigger than or equal to 1000.');
        }
    ...
    public function setAuthFloodTime($auth_flood_time)
    {
        ...
        if (!is_null($auth_flood_time) && ($auth_flood_time > 120)) {
            throw new \InvalidArgumentException('invalid value for $auth_flood_time when calling InlineObject614., must be smaller than or equal to 120.');
        }
        if (!is_null($auth_flood_time) && ($auth_flood_time < 5)) {
            throw new \InvalidArgumentException('invalid value for $auth_flood_time when calling InlineObject614., must be bigger than or equal to 5.');
        }
    ...
    public function setAuthFloodThresh($auth_flood_thresh)
    {
        ...
        if (!is_null($auth_flood_thresh) && ($auth_flood_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $auth_flood_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($auth_flood_thresh) && ($auth_flood_thresh < 1)) {
            throw new \InvalidArgumentException('invalid value for $auth_flood_thresh when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setAssocFloodTime($assoc_flood_time)
    {
        ...
        if (!is_null($assoc_flood_time) && ($assoc_flood_time > 120)) {
            throw new \InvalidArgumentException('invalid value for $assoc_flood_time when calling InlineObject614., must be smaller than or equal to 120.');
        }
        if (!is_null($assoc_flood_time) && ($assoc_flood_time < 5)) {
            throw new \InvalidArgumentException('invalid value for $assoc_flood_time when calling InlineObject614., must be bigger than or equal to 5.');
        }
    ...
    public function setAssocFloodThresh($assoc_flood_thresh)
    {
        ...
        if (!is_null($assoc_flood_thresh) && ($assoc_flood_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $assoc_flood_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($assoc_flood_thresh) && ($assoc_flood_thresh < 1)) {
            throw new \InvalidArgumentException('invalid value for $assoc_flood_thresh when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setEapolStartThresh($eapol_start_thresh)
    {
        ...
        if (!is_null($eapol_start_thresh) && ($eapol_start_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $eapol_start_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($eapol_start_thresh) && ($eapol_start_thresh < 2)) {
            throw new \InvalidArgumentException('invalid value for $eapol_start_thresh when calling InlineObject614., must be bigger than or equal to 2.');
        }
    ...
    public function setEapolStartIntv($eapol_start_intv)
    {
        ...
        if (!is_null($eapol_start_intv) && ($eapol_start_intv > 3600)) {
            throw new \InvalidArgumentException('invalid value for $eapol_start_intv when calling InlineObject614., must be smaller than or equal to 3600.');
        }
        if (!is_null($eapol_start_intv) && ($eapol_start_intv < 1)) {
            throw new \InvalidArgumentException('invalid value for $eapol_start_intv when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setEapolLogoffThresh($eapol_logoff_thresh)
    {
        ...
        if (!is_null($eapol_logoff_thresh) && ($eapol_logoff_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $eapol_logoff_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($eapol_logoff_thresh) && ($eapol_logoff_thresh < 2)) {
            throw new \InvalidArgumentException('invalid value for $eapol_logoff_thresh when calling InlineObject614., must be bigger than or equal to 2.');
        }
    ...
    public function setEapolLogoffIntv($eapol_logoff_intv)
    {
        ...
        if (!is_null($eapol_logoff_intv) && ($eapol_logoff_intv > 3600)) {
            throw new \InvalidArgumentException('invalid value for $eapol_logoff_intv when calling InlineObject614., must be smaller than or equal to 3600.');
        }
        if (!is_null($eapol_logoff_intv) && ($eapol_logoff_intv < 1)) {
            throw new \InvalidArgumentException('invalid value for $eapol_logoff_intv when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setEapolSuccThresh($eapol_succ_thresh)
    {
        ...
        if (!is_null($eapol_succ_thresh) && ($eapol_succ_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $eapol_succ_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($eapol_succ_thresh) && ($eapol_succ_thresh < 2)) {
            throw new \InvalidArgumentException('invalid value for $eapol_succ_thresh when calling InlineObject614., must be bigger than or equal to 2.');
        }
    ...
    public function setEapolSuccIntv($eapol_succ_intv)
    {
        ...
        if (!is_null($eapol_succ_intv) && ($eapol_succ_intv > 3600)) {
            throw new \InvalidArgumentException('invalid value for $eapol_succ_intv when calling InlineObject614., must be smaller than or equal to 3600.');
        }
        if (!is_null($eapol_succ_intv) && ($eapol_succ_intv < 1)) {
            throw new \InvalidArgumentException('invalid value for $eapol_succ_intv when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setEapolFailThresh($eapol_fail_thresh)
    {
        ...
        if (!is_null($eapol_fail_thresh) && ($eapol_fail_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $eapol_fail_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($eapol_fail_thresh) && ($eapol_fail_thresh < 2)) {
            throw new \InvalidArgumentException('invalid value for $eapol_fail_thresh when calling InlineObject614., must be bigger than or equal to 2.');
        }
    ...
    public function setEapolFailIntv($eapol_fail_intv)
    {
        ...
        if (!is_null($eapol_fail_intv) && ($eapol_fail_intv > 3600)) {
            throw new \InvalidArgumentException('invalid value for $eapol_fail_intv when calling InlineObject614., must be smaller than or equal to 3600.');
        }
        if (!is_null($eapol_fail_intv) && ($eapol_fail_intv < 1)) {
            throw new \InvalidArgumentException('invalid value for $eapol_fail_intv when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setEapolPreSuccThresh($eapol_pre_succ_thresh)
    {
        ...
        if (!is_null($eapol_pre_succ_thresh) && ($eapol_pre_succ_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_succ_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($eapol_pre_succ_thresh) && ($eapol_pre_succ_thresh < 2)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_succ_thresh when calling InlineObject614., must be bigger than or equal to 2.');
        }
    ...
    public function setEapolPreSuccIntv($eapol_pre_succ_intv)
    {
        ...
        if (!is_null($eapol_pre_succ_intv) && ($eapol_pre_succ_intv > 3600)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_succ_intv when calling InlineObject614., must be smaller than or equal to 3600.');
        }
        if (!is_null($eapol_pre_succ_intv) && ($eapol_pre_succ_intv < 1)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_succ_intv when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setEapolPreFailThresh($eapol_pre_fail_thresh)
    {
        ...
        if (!is_null($eapol_pre_fail_thresh) && ($eapol_pre_fail_thresh > 100)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_fail_thresh when calling InlineObject614., must be smaller than or equal to 100.');
        }
        if (!is_null($eapol_pre_fail_thresh) && ($eapol_pre_fail_thresh < 2)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_fail_thresh when calling InlineObject614., must be bigger than or equal to 2.');
        }
    ...
    public function setEapolPreFailIntv($eapol_pre_fail_intv)
    {
        ...
        if (!is_null($eapol_pre_fail_intv) && ($eapol_pre_fail_intv > 3600)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_fail_intv when calling InlineObject614., must be smaller than or equal to 3600.');
        }
        if (!is_null($eapol_pre_fail_intv) && ($eapol_pre_fail_intv < 1)) {
            throw new \InvalidArgumentException('invalid value for $eapol_pre_fail_intv when calling InlineObject614., must be bigger than or equal to 1.');
        }
    ...
    public function setDeauthUnknownSrcThresh($deauth_unknown_src_thresh)
    {
        ...
        if (!is_null($deauth_unknown_src_thresh) && ($deauth_unknown_src_thresh > 65535)) {
            throw new \InvalidArgumentException('invalid value for $deauth_unknown_src_thresh when calling InlineObject614., must be smaller than or equal to 65535.');
        }
        if (!is_null($deauth_unknown_src_thresh) && ($deauth_unknown_src_thresh < 0)) {
            throw new \InvalidArgumentException('invalid value for $deauth_unknown_src_thresh when calling InlineObject614., must be bigger than or equal to 0.');
        }
