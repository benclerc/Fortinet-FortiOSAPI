...
/**
 * InlineObject598 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject598 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_598';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject598., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 63)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject598., must be smaller than or equal to 63.');
        }
    ...
    public function setUplink($uplink)
    {
        ...
        if (!is_null($uplink) && ($uplink > 2097152)) {
            throw new \InvalidArgumentException('invalid value for $uplink when calling InlineObject598., must be smaller than or equal to 2097152.');
        }
        if (!is_null($uplink) && ($uplink < 0)) {
            throw new \InvalidArgumentException('invalid value for $uplink when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setDownlink($downlink)
    {
        ...
        if (!is_null($downlink) && ($downlink > 2097152)) {
            throw new \InvalidArgumentException('invalid value for $downlink when calling InlineObject598., must be smaller than or equal to 2097152.');
        }
        if (!is_null($downlink) && ($downlink < 0)) {
            throw new \InvalidArgumentException('invalid value for $downlink when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setUplinkSta($uplink_sta)
    {
        ...
        if (!is_null($uplink_sta) && ($uplink_sta > 2097152)) {
            throw new \InvalidArgumentException('invalid value for $uplink_sta when calling InlineObject598., must be smaller than or equal to 2097152.');
        }
        if (!is_null($uplink_sta) && ($uplink_sta < 0)) {
            throw new \InvalidArgumentException('invalid value for $uplink_sta when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setDownlinkSta($downlink_sta)
    {
        ...
        if (!is_null($downlink_sta) && ($downlink_sta > 2097152)) {
            throw new \InvalidArgumentException('invalid value for $downlink_sta when calling InlineObject598., must be smaller than or equal to 2097152.');
        }
        if (!is_null($downlink_sta) && ($downlink_sta < 0)) {
            throw new \InvalidArgumentException('invalid value for $downlink_sta when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setCallCapacity($call_capacity)
    {
        ...
        if (!is_null($call_capacity) && ($call_capacity > 60)) {
            throw new \InvalidArgumentException('invalid value for $call_capacity when calling InlineObject598., must be smaller than or equal to 60.');
        }
        if (!is_null($call_capacity) && ($call_capacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $call_capacity when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setBandwidthCapacity($bandwidth_capacity)
    {
        ...
        if (!is_null($bandwidth_capacity) && ($bandwidth_capacity > 600000)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth_capacity when calling InlineObject598., must be smaller than or equal to 600000.');
        }
        if (!is_null($bandwidth_capacity) && ($bandwidth_capacity < 1)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth_capacity when calling InlineObject598., must be bigger than or equal to 1.');
        }
    ...
    public function setDscpWmmVo($dscp_wmm_vo)
    {
        ...
        if (!is_null($dscp_wmm_vo) && (count($dscp_wmm_vo) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dscp_wmm_vo when calling InlineObject598., number of items must be less than or equal to 0.');
        }
    ...
    public function setDscpWmmVi($dscp_wmm_vi)
    {
        ...
        if (!is_null($dscp_wmm_vi) && (count($dscp_wmm_vi) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dscp_wmm_vi when calling InlineObject598., number of items must be less than or equal to 0.');
        }
    ...
    public function setDscpWmmBe($dscp_wmm_be)
    {
        ...
        if (!is_null($dscp_wmm_be) && (count($dscp_wmm_be) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dscp_wmm_be when calling InlineObject598., number of items must be less than or equal to 0.');
        }
    ...
    public function setDscpWmmBk($dscp_wmm_bk)
    {
        ...
        if (!is_null($dscp_wmm_bk) && (count($dscp_wmm_bk) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dscp_wmm_bk when calling InlineObject598., number of items must be less than or equal to 0.');
        }
    ...
    public function setWmmVoDscp($wmm_vo_dscp)
    {
        ...
        if (!is_null($wmm_vo_dscp) && ($wmm_vo_dscp > 63)) {
            throw new \InvalidArgumentException('invalid value for $wmm_vo_dscp when calling InlineObject598., must be smaller than or equal to 63.');
        }
        if (!is_null($wmm_vo_dscp) && ($wmm_vo_dscp < 0)) {
            throw new \InvalidArgumentException('invalid value for $wmm_vo_dscp when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setWmmViDscp($wmm_vi_dscp)
    {
        ...
        if (!is_null($wmm_vi_dscp) && ($wmm_vi_dscp > 63)) {
            throw new \InvalidArgumentException('invalid value for $wmm_vi_dscp when calling InlineObject598., must be smaller than or equal to 63.');
        }
        if (!is_null($wmm_vi_dscp) && ($wmm_vi_dscp < 0)) {
            throw new \InvalidArgumentException('invalid value for $wmm_vi_dscp when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setWmmBeDscp($wmm_be_dscp)
    {
        ...
        if (!is_null($wmm_be_dscp) && ($wmm_be_dscp > 63)) {
            throw new \InvalidArgumentException('invalid value for $wmm_be_dscp when calling InlineObject598., must be smaller than or equal to 63.');
        }
        if (!is_null($wmm_be_dscp) && ($wmm_be_dscp < 0)) {
            throw new \InvalidArgumentException('invalid value for $wmm_be_dscp when calling InlineObject598., must be bigger than or equal to 0.');
        }
    ...
    public function setWmmBkDscp($wmm_bk_dscp)
    {
        ...
        if (!is_null($wmm_bk_dscp) && ($wmm_bk_dscp > 63)) {
            throw new \InvalidArgumentException('invalid value for $wmm_bk_dscp when calling InlineObject598., must be smaller than or equal to 63.');
        }
        if (!is_null($wmm_bk_dscp) && ($wmm_bk_dscp < 0)) {
            throw new \InvalidArgumentException('invalid value for $wmm_bk_dscp when calling InlineObject598., must be bigger than or equal to 0.');
        }
