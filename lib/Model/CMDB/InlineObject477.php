...
/**
 * InlineObject477 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject477 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_477';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 35)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setRemotegwDdns($remotegw_ddns)
    {
        if (!is_null($remotegw_ddns) && (mb_strlen($remotegw_ddns) > 63)) {
            throw new \InvalidArgumentException('invalid length for $remotegw_ddns when calling InlineObject477., must be smaller than or equal to 63.');
        }
    ...
    public function setKeylife($keylife)
    {
        ...
        if (!is_null($keylife) && ($keylife > 172800)) {
            throw new \InvalidArgumentException('invalid value for $keylife when calling InlineObject477., must be smaller than or equal to 172800.');
        }
        if (!is_null($keylife) && ($keylife < 120)) {
            throw new \InvalidArgumentException('invalid value for $keylife when calling InlineObject477., must be bigger than or equal to 120.');
        }
    ...
    public function setCertificate($certificate)
    {
        ...
        if (!is_null($certificate) && (count($certificate) > 0)) {
            throw new \InvalidArgumentException('invalid value for $certificate when calling InlineObject477., number of items must be less than or equal to 0.');
        }
    ...
    public function setPeerid($peerid)
    {
        if (!is_null($peerid) && (mb_strlen($peerid) > 255)) {
            throw new \InvalidArgumentException('invalid length for $peerid when calling InlineObject477., must be smaller than or equal to 255.');
        }
    ...
    public function setUsrgrp($usrgrp)
    {
        if (!is_null($usrgrp) && (mb_strlen($usrgrp) > 35)) {
            throw new \InvalidArgumentException('invalid length for $usrgrp when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setPeer($peer)
    {
        if (!is_null($peer) && (mb_strlen($peer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $peer when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setPeergrp($peergrp)
    {
        if (!is_null($peergrp) && (mb_strlen($peergrp) > 35)) {
            throw new \InvalidArgumentException('invalid length for $peergrp when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setIpv4ExcludeRange($ipv4_exclude_range)
    {
        ...
        if (!is_null($ipv4_exclude_range) && (count($ipv4_exclude_range) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ipv4_exclude_range when calling InlineObject477., number of items must be less than or equal to 0.');
        }
    ...
    public function setIpv4SplitInclude($ipv4_split_include)
    {
        if (!is_null($ipv4_split_include) && (mb_strlen($ipv4_split_include) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ipv4_split_include when calling InlineObject477., must be smaller than or equal to 79.');
        }
    ...
    public function setSplitIncludeService($split_include_service)
    {
        if (!is_null($split_include_service) && (mb_strlen($split_include_service) > 79)) {
            throw new \InvalidArgumentException('invalid length for $split_include_service when calling InlineObject477., must be smaller than or equal to 79.');
        }
    ...
    public function setIpv4Name($ipv4_name)
    {
        if (!is_null($ipv4_name) && (mb_strlen($ipv4_name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ipv4_name when calling InlineObject477., must be smaller than or equal to 79.');
        }
    ...
    public function setIpv6Prefix($ipv6_prefix)
    {
        ...
        if (!is_null($ipv6_prefix) && ($ipv6_prefix > 128)) {
            throw new \InvalidArgumentException('invalid value for $ipv6_prefix when calling InlineObject477., must be smaller than or equal to 128.');
        }
        if (!is_null($ipv6_prefix) && ($ipv6_prefix < 1)) {
            throw new \InvalidArgumentException('invalid value for $ipv6_prefix when calling InlineObject477., must be bigger than or equal to 1.');
        }
    ...
    public function setIpv6ExcludeRange($ipv6_exclude_range)
    {
        ...
        if (!is_null($ipv6_exclude_range) && (count($ipv6_exclude_range) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ipv6_exclude_range when calling InlineObject477., number of items must be less than or equal to 0.');
        }
    ...
    public function setIpv6SplitInclude($ipv6_split_include)
    {
        if (!is_null($ipv6_split_include) && (mb_strlen($ipv6_split_include) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ipv6_split_include when calling InlineObject477., must be smaller than or equal to 79.');
        }
    ...
    public function setIpv6Name($ipv6_name)
    {
        if (!is_null($ipv6_name) && (mb_strlen($ipv6_name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ipv6_name when calling InlineObject477., must be smaller than or equal to 79.');
        }
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 63)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling InlineObject477., must be smaller than or equal to 63.');
        }
    ...
    public function setBanner($banner)
    {
        if (!is_null($banner) && (mb_strlen($banner) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $banner when calling InlineObject477., must be smaller than or equal to 1024.');
        }
    ...
    public function setIpv4SplitExclude($ipv4_split_exclude)
    {
        if (!is_null($ipv4_split_exclude) && (mb_strlen($ipv4_split_exclude) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ipv4_split_exclude when calling InlineObject477., must be smaller than or equal to 79.');
        }
    ...
    public function setIpv6SplitExclude($ipv6_split_exclude)
    {
        if (!is_null($ipv6_split_exclude) && (mb_strlen($ipv6_split_exclude) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ipv6_split_exclude when calling InlineObject477., must be smaller than or equal to 79.');
        }
    ...
    public function setBackupGateway($backup_gateway)
    {
        ...
        if (!is_null($backup_gateway) && (count($backup_gateway) > 0)) {
            throw new \InvalidArgumentException('invalid value for $backup_gateway when calling InlineObject477., number of items must be less than or equal to 0.');
        }
    ...
    public function setKeepalive($keepalive)
    {
        ...
        if (!is_null($keepalive) && ($keepalive > 900)) {
            throw new \InvalidArgumentException('invalid value for $keepalive when calling InlineObject477., must be smaller than or equal to 900.');
        }
        if (!is_null($keepalive) && ($keepalive < 10)) {
            throw new \InvalidArgumentException('invalid value for $keepalive when calling InlineObject477., must be bigger than or equal to 10.');
        }
    ...
    public function setDistance($distance)
    {
        ...
        if (!is_null($distance) && ($distance > 255)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject477., must be smaller than or equal to 255.');
        }
        if (!is_null($distance) && ($distance < 1)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling InlineObject477., must be bigger than or equal to 1.');
        }
    ...
    public function setPriority($priority)
    {
        ...
        if (!is_null($priority) && ($priority > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject477., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($priority) && ($priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject477., must be bigger than or equal to 0.');
        }
    ...
    public function setLocalid($localid)
    {
        if (!is_null($localid) && (mb_strlen($localid) > 63)) {
            throw new \InvalidArgumentException('invalid length for $localid when calling InlineObject477., must be smaller than or equal to 63.');
        }
    ...
    public function setNegotiateTimeout($negotiate_timeout)
    {
        ...
        if (!is_null($negotiate_timeout) && ($negotiate_timeout > 300)) {
            throw new \InvalidArgumentException('invalid value for $negotiate_timeout when calling InlineObject477., must be smaller than or equal to 300.');
        }
        if (!is_null($negotiate_timeout) && ($negotiate_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $negotiate_timeout when calling InlineObject477., must be bigger than or equal to 1.');
        }
    ...
    public function setDpdRetrycount($dpd_retrycount)
    {
        ...
        if (!is_null($dpd_retrycount) && ($dpd_retrycount > 10)) {
            throw new \InvalidArgumentException('invalid value for $dpd_retrycount when calling InlineObject477., must be smaller than or equal to 10.');
        }
        if (!is_null($dpd_retrycount) && ($dpd_retrycount < 0)) {
            throw new \InvalidArgumentException('invalid value for $dpd_retrycount when calling InlineObject477., must be bigger than or equal to 0.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject477., must be smaller than or equal to 255.');
        }
    ...
    public function setEapExcludePeergrp($eap_exclude_peergrp)
    {
        if (!is_null($eap_exclude_peergrp) && (mb_strlen($eap_exclude_peergrp) > 35)) {
            throw new \InvalidArgumentException('invalid length for $eap_exclude_peergrp when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setPpkIdentity($ppk_identity)
    {
        if (!is_null($ppk_identity) && (mb_strlen($ppk_identity) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ppk_identity when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setAuthusr($authusr)
    {
        if (!is_null($authusr) && (mb_strlen($authusr) > 64)) {
            throw new \InvalidArgumentException('invalid length for $authusr when calling InlineObject477., must be smaller than or equal to 64.');
        }
    ...
    public function setAuthusrgrp($authusrgrp)
    {
        if (!is_null($authusrgrp) && (mb_strlen($authusrgrp) > 35)) {
            throw new \InvalidArgumentException('invalid length for $authusrgrp when calling InlineObject477., must be smaller than or equal to 35.');
        }
    ...
    public function setIdleTimeoutinterval($idle_timeoutinterval)
    {
        ...
        if (!is_null($idle_timeoutinterval) && ($idle_timeoutinterval > 43200)) {
            throw new \InvalidArgumentException('invalid value for $idle_timeoutinterval when calling InlineObject477., must be smaller than or equal to 43200.');
        }
        if (!is_null($idle_timeoutinterval) && ($idle_timeoutinterval < 5)) {
            throw new \InvalidArgumentException('invalid value for $idle_timeoutinterval when calling InlineObject477., must be bigger than or equal to 5.');
        }
    ...
    public function setFragmentationMtu($fragmentation_mtu)
    {
        ...
        if (!is_null($fragmentation_mtu) && ($fragmentation_mtu > 16000)) {
            throw new \InvalidArgumentException('invalid value for $fragmentation_mtu when calling InlineObject477., must be smaller than or equal to 16000.');
        }
        if (!is_null($fragmentation_mtu) && ($fragmentation_mtu < 500)) {
            throw new \InvalidArgumentException('invalid value for $fragmentation_mtu when calling InlineObject477., must be bigger than or equal to 500.');
        }
    ...
    public function setFecSendTimeout($fec_send_timeout)
    {
        ...
        if (!is_null($fec_send_timeout) && ($fec_send_timeout > 1000)) {
            throw new \InvalidArgumentException('invalid value for $fec_send_timeout when calling InlineObject477., must be smaller than or equal to 1000.');
        }
        if (!is_null($fec_send_timeout) && ($fec_send_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $fec_send_timeout when calling InlineObject477., must be bigger than or equal to 1.');
        }
    ...
    public function setFecBase($fec_base)
    {
        ...
        if (!is_null($fec_base) && ($fec_base > 100)) {
            throw new \InvalidArgumentException('invalid value for $fec_base when calling InlineObject477., must be smaller than or equal to 100.');
        }
        if (!is_null($fec_base) && ($fec_base < 1)) {
            throw new \InvalidArgumentException('invalid value for $fec_base when calling InlineObject477., must be bigger than or equal to 1.');
        }
    ...
    public function setFecRedundant($fec_redundant)
    {
        ...
        if (!is_null($fec_redundant) && ($fec_redundant > 100)) {
            throw new \InvalidArgumentException('invalid value for $fec_redundant when calling InlineObject477., must be smaller than or equal to 100.');
        }
        if (!is_null($fec_redundant) && ($fec_redundant < 0)) {
            throw new \InvalidArgumentException('invalid value for $fec_redundant when calling InlineObject477., must be bigger than or equal to 0.');
        }
    ...
    public function setFecReceiveTimeout($fec_receive_timeout)
    {
        ...
        if (!is_null($fec_receive_timeout) && ($fec_receive_timeout > 10000)) {
            throw new \InvalidArgumentException('invalid value for $fec_receive_timeout when calling InlineObject477., must be smaller than or equal to 10000.');
        }
        if (!is_null($fec_receive_timeout) && ($fec_receive_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $fec_receive_timeout when calling InlineObject477., must be bigger than or equal to 1.');
        }
    ...
    public function setNetworkId($network_id)
    {
        ...
        if (!is_null($network_id) && ($network_id > 255)) {
            throw new \InvalidArgumentException('invalid value for $network_id when calling InlineObject477., must be smaller than or equal to 255.');
        }
        if (!is_null($network_id) && ($network_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $network_id when calling InlineObject477., must be bigger than or equal to 0.');
        }
