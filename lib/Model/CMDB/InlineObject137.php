...
/**
 * InlineObject137 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject137 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_137';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 71)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject137., must be smaller than or equal to 71.');
        }
    ...
    public function setPolicy($policy)
    {
        ...
        if (!is_null($policy) && ($policy > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $policy when calling InlineObject137., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($policy) && ($policy < 0)) {
            throw new \InvalidArgumentException('invalid value for $policy when calling InlineObject137., must be bigger than or equal to 0.');
        }
    ...
    public function setDrillDownCharts($drill_down_charts)
    {
        ...
        if (!is_null($drill_down_charts) && (count($drill_down_charts) > 0)) {
            throw new \InvalidArgumentException('invalid value for $drill_down_charts when calling InlineObject137., number of items must be less than or equal to 0.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 127)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject137., must be smaller than or equal to 127.');
        }
    ...
    public function setDataset($dataset)
    {
        if (!is_null($dataset) && (mb_strlen($dataset) > 71)) {
            throw new \InvalidArgumentException('invalid length for $dataset when calling InlineObject137., must be smaller than or equal to 71.');
        }
    ...
    public function setXSeries($x_series)
    {
        ...
        if (!is_null($x_series) && (count($x_series) > 0)) {
            throw new \InvalidArgumentException('invalid value for $x_series when calling InlineObject137., number of items must be less than or equal to 0.');
        }
    ...
    public function setYSeries($y_series)
    {
        ...
        if (!is_null($y_series) && (count($y_series) > 0)) {
            throw new \InvalidArgumentException('invalid value for $y_series when calling InlineObject137., number of items must be less than or equal to 0.');
        }
    ...
    public function setCategorySeries($category_series)
    {
        ...
        if (!is_null($category_series) && (count($category_series) > 0)) {
            throw new \InvalidArgumentException('invalid value for $category_series when calling InlineObject137., number of items must be less than or equal to 0.');
        }
    ...
    public function setValueSeries($value_series)
    {
        ...
        if (!is_null($value_series) && (count($value_series) > 0)) {
            throw new \InvalidArgumentException('invalid value for $value_series when calling InlineObject137., number of items must be less than or equal to 0.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 63)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineObject137., must be smaller than or equal to 63.');
        }
    ...
    public function setTitleFontSize($title_font_size)
    {
        ...
        if (!is_null($title_font_size) && ($title_font_size > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $title_font_size when calling InlineObject137., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($title_font_size) && ($title_font_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $title_font_size when calling InlineObject137., must be bigger than or equal to 0.');
        }
    ...
    public function setBackground($background)
    {
        if (!is_null($background) && (mb_strlen($background) > 11)) {
            throw new \InvalidArgumentException('invalid length for $background when calling InlineObject137., must be smaller than or equal to 11.');
        }
    ...
    public function setColorPalette($color_palette)
    {
        if (!is_null($color_palette) && (mb_strlen($color_palette) > 11)) {
            throw new \InvalidArgumentException('invalid length for $color_palette when calling InlineObject137., must be smaller than or equal to 11.');
        }
    ...
    public function setLegendFontSize($legend_font_size)
    {
        ...
        if (!is_null($legend_font_size) && ($legend_font_size > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $legend_font_size when calling InlineObject137., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($legend_font_size) && ($legend_font_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $legend_font_size when calling InlineObject137., must be bigger than or equal to 0.');
        }
    ...
    public function setColumn($column)
    {
        ...
        if (!is_null($column) && (count($column) > 0)) {
            throw new \InvalidArgumentException('invalid value for $column when calling InlineObject137., number of items must be less than or equal to 0.');
        }
