...
/**
 * AntivirusProfileNameHttp Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class AntivirusProfileNameHttp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_antivirus_profile__name__http';
     ...
     * Sets options
     *
     * @param string|null $options Enable/disable HTTP AntiVirus scanning, monitoring, and quarantine.    scan:Enable HTTP antivirus scanning.    avmonitor:Enable HTTP antivirus logging.    quarantine:Enable HTTP antivirus quarantine. Files are quarantined depending on quarantine settings.
     *
     * @return self
     */
