...
/**
 * WafProfileNameHeaderLength Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class WafProfileNameHeaderLength implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_waf_profile__name__header_length';
     ...
     * Sets length
     *
     * @param int|null $length Length of HTTP header in bytes (0 to 2147483647).
     *
     * @return self
     */
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $length when calling WafProfileNameHeaderLength., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($length) && ($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling WafProfileNameHeaderLength., must be bigger than or equal to 0.');
        }
