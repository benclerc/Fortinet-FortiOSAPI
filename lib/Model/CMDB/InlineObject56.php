...
class InlineObject56 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject56., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject56., must be smaller than or equal to 255.');
        }
    ...
    public function setReplacemsgGroup($replacemsg_group)
    {
        if (!is_null($replacemsg_group) && (mb_strlen($replacemsg_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $replacemsg_group when calling InlineObject56., must be smaller than or equal to 35.');
        }
    ...
    public function setImap($imap)
    {
        ...
        if (!is_null($imap) && (count($imap) > 0)) {
            throw new \InvalidArgumentException('invalid value for $imap when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setPop3($pop3)
    {
        ...
        if (!is_null($pop3) && (count($pop3) > 0)) {
            throw new \InvalidArgumentException('invalid value for $pop3 when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setSmtp($smtp)
    {
        ...
        if (!is_null($smtp) && (count($smtp) > 0)) {
            throw new \InvalidArgumentException('invalid value for $smtp when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setMapi($mapi)
    {
        ...
        if (!is_null($mapi) && (count($mapi) > 0)) {
            throw new \InvalidArgumentException('invalid value for $mapi when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setMsnHotmail($msn_hotmail)
    {
        ...
        if (!is_null($msn_hotmail) && (count($msn_hotmail) > 0)) {
            throw new \InvalidArgumentException('invalid value for $msn_hotmail when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setYahooMail($yahoo_mail)
    {
        ...
        if (!is_null($yahoo_mail) && (count($yahoo_mail) > 0)) {
            throw new \InvalidArgumentException('invalid value for $yahoo_mail when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setGmail($gmail)
    {
        ...
        if (!is_null($gmail) && (count($gmail) > 0)) {
            throw new \InvalidArgumentException('invalid value for $gmail when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setOtherWebmails($other_webmails)
    {
        ...
        if (!is_null($other_webmails) && (count($other_webmails) > 0)) {
            throw new \InvalidArgumentException('invalid value for $other_webmails when calling InlineObject56., number of items must be less than or equal to 0.');
        }
    ...
    public function setSpamBwordThreshold($spam_bword_threshold)
    {
        ...
        if (!is_null($spam_bword_threshold) && ($spam_bword_threshold > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $spam_bword_threshold when calling InlineObject56., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($spam_bword_threshold) && ($spam_bword_threshold < 0)) {
            throw new \InvalidArgumentException('invalid value for $spam_bword_threshold when calling InlineObject56., must be bigger than or equal to 0.');
        }
    ...
    public function setSpamBwordTable($spam_bword_table)
    {
        ...
        if (!is_null($spam_bword_table) && ($spam_bword_table > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $spam_bword_table when calling InlineObject56., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($spam_bword_table) && ($spam_bword_table < 0)) {
            throw new \InvalidArgumentException('invalid value for $spam_bword_table when calling InlineObject56., must be bigger than or equal to 0.');
        }
    ...
    public function setSpamBwlTable($spam_bwl_table)
    {
        ...
        if (!is_null($spam_bwl_table) && ($spam_bwl_table > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $spam_bwl_table when calling InlineObject56., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($spam_bwl_table) && ($spam_bwl_table < 0)) {
            throw new \InvalidArgumentException('invalid value for $spam_bwl_table when calling InlineObject56., must be bigger than or equal to 0.');
        }
    ...
    public function setSpamMheaderTable($spam_mheader_table)
    {
        ...
        if (!is_null($spam_mheader_table) && ($spam_mheader_table > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $spam_mheader_table when calling InlineObject56., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($spam_mheader_table) && ($spam_mheader_table < 0)) {
            throw new \InvalidArgumentException('invalid value for $spam_mheader_table when calling InlineObject56., must be bigger than or equal to 0.');
        }
    ...
    public function setSpamRblTable($spam_rbl_table)
    {
        ...
        if (!is_null($spam_rbl_table) && ($spam_rbl_table > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $spam_rbl_table when calling InlineObject56., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($spam_rbl_table) && ($spam_rbl_table < 0)) {
            throw new \InvalidArgumentException('invalid value for $spam_rbl_table when calling InlineObject56., must be bigger than or equal to 0.');
        }
    ...
    public function setSpamIptrustTable($spam_iptrust_table)
    {
        ...
        if (!is_null($spam_iptrust_table) && ($spam_iptrust_table > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $spam_iptrust_table when calling InlineObject56., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($spam_iptrust_table) && ($spam_iptrust_table < 0)) {
            throw new \InvalidArgumentException('invalid value for $spam_iptrust_table when calling InlineObject56., must be bigger than or equal to 0.');
        }
