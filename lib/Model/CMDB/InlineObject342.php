...
/**
 * InlineObject342 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject342 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_342';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject342., must be smaller than or equal to 15.');
        }
    ...
    public function setRoamingInterface($roaming_interface)
    {
        if (!is_null($roaming_interface) && (mb_strlen($roaming_interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $roaming_interface when calling InlineObject342., must be smaller than or equal to 15.');
        }
    ...
    public function setRenewInterval($renew_interval)
    {
        ...
        if (!is_null($renew_interval) && ($renew_interval > 60)) {
            throw new \InvalidArgumentException('invalid value for $renew_interval when calling InlineObject342., must be smaller than or equal to 60.');
        }
        if (!is_null($renew_interval) && ($renew_interval < 5)) {
            throw new \InvalidArgumentException('invalid value for $renew_interval when calling InlineObject342., must be bigger than or equal to 5.');
        }
    ...
    public function setLifetime($lifetime)
    {
        ...
        if (!is_null($lifetime) && ($lifetime > 65535)) {
            throw new \InvalidArgumentException('invalid value for $lifetime when calling InlineObject342., must be smaller than or equal to 65535.');
        }
        if (!is_null($lifetime) && ($lifetime < 180)) {
            throw new \InvalidArgumentException('invalid value for $lifetime when calling InlineObject342., must be bigger than or equal to 180.');
        }
    ...
    public function setRegInterval($reg_interval)
    {
        ...
        if (!is_null($reg_interval) && ($reg_interval > 300)) {
            throw new \InvalidArgumentException('invalid value for $reg_interval when calling InlineObject342., must be smaller than or equal to 300.');
        }
        if (!is_null($reg_interval) && ($reg_interval < 5)) {
            throw new \InvalidArgumentException('invalid value for $reg_interval when calling InlineObject342., must be bigger than or equal to 5.');
        }
    ...
    public function setRegRetry($reg_retry)
    {
        ...
        if (!is_null($reg_retry) && ($reg_retry > 30)) {
            throw new \InvalidArgumentException('invalid value for $reg_retry when calling InlineObject342., must be smaller than or equal to 30.');
        }
        if (!is_null($reg_retry) && ($reg_retry < 1)) {
            throw new \InvalidArgumentException('invalid value for $reg_retry when calling InlineObject342., must be bigger than or equal to 1.');
        }
    ...
    public function setNMhaeSpi($n_mhae_spi)
    {
        ...
        if (!is_null($n_mhae_spi) && ($n_mhae_spi > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $n_mhae_spi when calling InlineObject342., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($n_mhae_spi) && ($n_mhae_spi < 0)) {
            throw new \InvalidArgumentException('invalid value for $n_mhae_spi when calling InlineObject342., must be bigger than or equal to 0.');
        }
    ...
    public function setNetwork($network)
    {
        ...
        if (!is_null($network) && (count($network) > 0)) {
            throw new \InvalidArgumentException('invalid value for $network when calling InlineObject342., number of items must be less than or equal to 0.');
        }
