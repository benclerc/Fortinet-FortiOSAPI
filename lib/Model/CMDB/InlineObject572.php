...
/**
 * InlineObject572 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject572 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_572';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setAnqpDomainId($anqp_domain_id)
    {
        ...
        if (!is_null($anqp_domain_id) && ($anqp_domain_id > 65535)) {
            throw new \InvalidArgumentException('invalid value for $anqp_domain_id when calling InlineObject572., must be smaller than or equal to 65535.');
        }
        if (!is_null($anqp_domain_id) && ($anqp_domain_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $anqp_domain_id when calling InlineObject572., must be bigger than or equal to 0.');
        }
    ...
    public function setDomainName($domain_name)
    {
        if (!is_null($domain_name) && (mb_strlen($domain_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $domain_name when calling InlineObject572., must be smaller than or equal to 255.');
        }
    ...
    public function setOsuSsid($osu_ssid)
    {
        if (!is_null($osu_ssid) && (mb_strlen($osu_ssid) > 255)) {
            throw new \InvalidArgumentException('invalid length for $osu_ssid when calling InlineObject572., must be smaller than or equal to 255.');
        }
    ...
    public function setGasComebackDelay($gas_comeback_delay)
    {
        ...
        if (!is_null($gas_comeback_delay) && ($gas_comeback_delay > 4000)) {
            throw new \InvalidArgumentException('invalid value for $gas_comeback_delay when calling InlineObject572., must be smaller than or equal to 4000.');
        }
        if (!is_null($gas_comeback_delay) && ($gas_comeback_delay < 100)) {
            throw new \InvalidArgumentException('invalid value for $gas_comeback_delay when calling InlineObject572., must be bigger than or equal to 100.');
        }
    ...
    public function setGasFragmentationLimit($gas_fragmentation_limit)
    {
        ...
        if (!is_null($gas_fragmentation_limit) && ($gas_fragmentation_limit > 4096)) {
            throw new \InvalidArgumentException('invalid value for $gas_fragmentation_limit when calling InlineObject572., must be smaller than or equal to 4096.');
        }
        if (!is_null($gas_fragmentation_limit) && ($gas_fragmentation_limit < 512)) {
            throw new \InvalidArgumentException('invalid value for $gas_fragmentation_limit when calling InlineObject572., must be bigger than or equal to 512.');
        }
    ...
    public function setDeauthRequestTimeout($deauth_request_timeout)
    {
        ...
        if (!is_null($deauth_request_timeout) && ($deauth_request_timeout > 120)) {
            throw new \InvalidArgumentException('invalid value for $deauth_request_timeout when calling InlineObject572., must be smaller than or equal to 120.');
        }
        if (!is_null($deauth_request_timeout) && ($deauth_request_timeout < 30)) {
            throw new \InvalidArgumentException('invalid value for $deauth_request_timeout when calling InlineObject572., must be bigger than or equal to 30.');
        }
    ...
    public function setVenueName($venue_name)
    {
        if (!is_null($venue_name) && (mb_strlen($venue_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $venue_name when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setRoamingConsortium($roaming_consortium)
    {
        if (!is_null($roaming_consortium) && (mb_strlen($roaming_consortium) > 35)) {
            throw new \InvalidArgumentException('invalid length for $roaming_consortium when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setNaiRealm($nai_realm)
    {
        if (!is_null($nai_realm) && (mb_strlen($nai_realm) > 35)) {
            throw new \InvalidArgumentException('invalid length for $nai_realm when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setOperFriendlyName($oper_friendly_name)
    {
        if (!is_null($oper_friendly_name) && (mb_strlen($oper_friendly_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $oper_friendly_name when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setOsuProvider($osu_provider)
    {
        ...
        if (!is_null($osu_provider) && (count($osu_provider) > 0)) {
            throw new \InvalidArgumentException('invalid value for $osu_provider when calling InlineObject572., number of items must be less than or equal to 0.');
        }
    ...
    public function setWanMetrics($wan_metrics)
    {
        if (!is_null($wan_metrics) && (mb_strlen($wan_metrics) > 35)) {
            throw new \InvalidArgumentException('invalid length for $wan_metrics when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setNetworkAuth($network_auth)
    {
        if (!is_null($network_auth) && (mb_strlen($network_auth) > 35)) {
            throw new \InvalidArgumentException('invalid length for $network_auth when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function set3gppPlmn($_3gpp_plmn)
    {
        if (!is_null($_3gpp_plmn) && (mb_strlen($_3gpp_plmn) > 35)) {
            throw new \InvalidArgumentException('invalid length for $_3gpp_plmn when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setConnCap($conn_cap)
    {
        if (!is_null($conn_cap) && (mb_strlen($conn_cap) > 35)) {
            throw new \InvalidArgumentException('invalid length for $conn_cap when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setQosMap($qos_map)
    {
        if (!is_null($qos_map) && (mb_strlen($qos_map) > 35)) {
            throw new \InvalidArgumentException('invalid length for $qos_map when calling InlineObject572., must be smaller than or equal to 35.');
        }
    ...
    public function setIpAddrType($ip_addr_type)
    {
        if (!is_null($ip_addr_type) && (mb_strlen($ip_addr_type) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ip_addr_type when calling InlineObject572., must be smaller than or equal to 35.');
        }
