...
/**
 * InlineObject389 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject389 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_389';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject389., must be smaller than or equal to 15.');
        }
    ...
    public function setVdom($vdom)
    {
        if (!is_null($vdom) && (mb_strlen($vdom) > 31)) {
            throw new \InvalidArgumentException('invalid length for $vdom when calling InlineObject389., must be smaller than or equal to 31.');
        }
    ...
    public function setSpanDestPort($span_dest_port)
    {
        if (!is_null($span_dest_port) && (mb_strlen($span_dest_port) > 15)) {
            throw new \InvalidArgumentException('invalid length for $span_dest_port when calling InlineObject389., must be smaller than or equal to 15.');
        }
    ...
    public function setSpanSourcePort($span_source_port)
    {
        ...
        if (!is_null($span_source_port) && (count($span_source_port) > 0)) {
            throw new \InvalidArgumentException('invalid value for $span_source_port when calling InlineObject389., number of items must be less than or equal to 0.');
        }
    ...
    public function setMember($member)
    {
        ...
        if (!is_null($member) && (count($member) > 0)) {
            throw new \InvalidArgumentException('invalid value for $member when calling InlineObject389., number of items must be less than or equal to 0.');
        }
    ...
    public function setMacTtl($mac_ttl)
    {
        ...
        if (!is_null($mac_ttl) && ($mac_ttl > 8640000)) {
            throw new \InvalidArgumentException('invalid value for $mac_ttl when calling InlineObject389., must be smaller than or equal to 8640000.');
        }
        if (!is_null($mac_ttl) && ($mac_ttl < 300)) {
            throw new \InvalidArgumentException('invalid value for $mac_ttl when calling InlineObject389., must be bigger than or equal to 300.');
        }
