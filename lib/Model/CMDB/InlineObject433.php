...
/**
 * InlineObject433 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject433 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_433';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject433., must be smaller than or equal to 35.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject433., must be smaller than or equal to 63.');
        }
    ...
    public function setSecondaryServer($secondary_server)
    {
        if (!is_null($secondary_server) && (mb_strlen($secondary_server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $secondary_server when calling InlineObject433., must be smaller than or equal to 63.');
        }
    ...
    public function setTertiaryServer($tertiary_server)
    {
        if (!is_null($tertiary_server) && (mb_strlen($tertiary_server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $tertiary_server when calling InlineObject433., must be smaller than or equal to 63.');
        }
    ...
    public function setCnid($cnid)
    {
        if (!is_null($cnid) && (mb_strlen($cnid) > 20)) {
            throw new \InvalidArgumentException('invalid length for $cnid when calling InlineObject433., must be smaller than or equal to 20.');
        }
    ...
    public function setDn($dn)
    {
        if (!is_null($dn) && (mb_strlen($dn) > 511)) {
            throw new \InvalidArgumentException('invalid length for $dn when calling InlineObject433., must be smaller than or equal to 511.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 511)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject433., must be smaller than or equal to 511.');
        }
    ...
    public function setGroupSearchBase($group_search_base)
    {
        if (!is_null($group_search_base) && (mb_strlen($group_search_base) > 511)) {
            throw new \InvalidArgumentException('invalid length for $group_search_base when calling InlineObject433., must be smaller than or equal to 511.');
        }
    ...
    public function setGroupObjectFilter($group_object_filter)
    {
        if (!is_null($group_object_filter) && (mb_strlen($group_object_filter) > 2047)) {
            throw new \InvalidArgumentException('invalid length for $group_object_filter when calling InlineObject433., must be smaller than or equal to 2047.');
        }
    ...
    public function setGroupFilter($group_filter)
    {
        if (!is_null($group_filter) && (mb_strlen($group_filter) > 2047)) {
            throw new \InvalidArgumentException('invalid length for $group_filter when calling InlineObject433., must be smaller than or equal to 2047.');
        }
    ...
    public function setCaCert($ca_cert)
    {
        if (!is_null($ca_cert) && (mb_strlen($ca_cert) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ca_cert when calling InlineObject433., must be smaller than or equal to 79.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject433., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject433., must be bigger than or equal to 1.');
        }
    ...
    public function setMemberAttr($member_attr)
    {
        if (!is_null($member_attr) && (mb_strlen($member_attr) > 63)) {
            throw new \InvalidArgumentException('invalid length for $member_attr when calling InlineObject433., must be smaller than or equal to 63.');
        }
    ...
    public function setAccountKeyFilter($account_key_filter)
    {
        if (!is_null($account_key_filter) && (mb_strlen($account_key_filter) > 2047)) {
            throw new \InvalidArgumentException('invalid length for $account_key_filter when calling InlineObject433., must be smaller than or equal to 2047.');
        }
    ...
    public function setUserInfoExchangeServer($user_info_exchange_server)
    {
        if (!is_null($user_info_exchange_server) && (mb_strlen($user_info_exchange_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $user_info_exchange_server when calling InlineObject433., must be smaller than or equal to 35.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject433., must be smaller than or equal to 15.');
        }
