...
/**
 * InlineObject205 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject205 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_205';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject205., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject205., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 127)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject205., must be smaller than or equal to 127.');
        }
    ...
    public function setLastKnownSwitch($last_known_switch)
    {
        if (!is_null($last_known_switch) && (mb_strlen($last_known_switch) > 63)) {
            throw new \InvalidArgumentException('invalid length for $last_known_switch when calling InlineObject205., must be smaller than or equal to 63.');
        }
    ...
    public function setLastKnownPort($last_known_port)
    {
        if (!is_null($last_known_port) && (mb_strlen($last_known_port) > 35)) {
            throw new \InvalidArgumentException('invalid length for $last_known_port when calling InlineObject205., must be smaller than or equal to 35.');
        }
    ...
    public function setMatchedNacPolicy($matched_nac_policy)
    {
        if (!is_null($matched_nac_policy) && (mb_strlen($matched_nac_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $matched_nac_policy when calling InlineObject205., must be smaller than or equal to 63.');
        }
    ...
    public function setPortPolicy($port_policy)
    {
        if (!is_null($port_policy) && (mb_strlen($port_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $port_policy when calling InlineObject205., must be smaller than or equal to 63.');
        }
    ...
    public function setMacPolicy($mac_policy)
    {
        if (!is_null($mac_policy) && (mb_strlen($mac_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $mac_policy when calling InlineObject205., must be smaller than or equal to 63.');
        }
    ...
    public function setLastSeen($last_seen)
    {
        ...
        if (!is_null($last_seen) && ($last_seen > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $last_seen when calling InlineObject205., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($last_seen) && ($last_seen < 0)) {
            throw new \InvalidArgumentException('invalid value for $last_seen when calling InlineObject205., must be bigger than or equal to 0.');
        }
