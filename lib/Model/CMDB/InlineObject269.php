...
/**
 * InlineObject269 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject269 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_269';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject269., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject269., must be smaller than or equal to 255.');
        }
    ...
    public function setAccprofile($accprofile)
    {
        if (!is_null($accprofile) && (mb_strlen($accprofile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $accprofile when calling InlineObject269., must be smaller than or equal to 35.');
        }
    ...
    public function setVdom($vdom)
    {
        ...
        if (!is_null($vdom) && (count($vdom) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vdom when calling InlineObject269., number of items must be less than or equal to 0.');
        }
    ...
    public function setSchedule($schedule)
    {
        if (!is_null($schedule) && (mb_strlen($schedule) > 35)) {
            throw new \InvalidArgumentException('invalid length for $schedule when calling InlineObject269., must be smaller than or equal to 35.');
        }
    ...
    public function setCorsAllowOrigin($cors_allow_origin)
    {
        if (!is_null($cors_allow_origin) && (mb_strlen($cors_allow_origin) > 269)) {
            throw new \InvalidArgumentException('invalid length for $cors_allow_origin when calling InlineObject269., must be smaller than or equal to 269.');
        }
    ...
    public function setPeerGroup($peer_group)
    {
        if (!is_null($peer_group) && (mb_strlen($peer_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $peer_group when calling InlineObject269., must be smaller than or equal to 35.');
        }
    ...
    public function setTrusthost($trusthost)
    {
        ...
        if (!is_null($trusthost) && (count($trusthost) > 0)) {
            throw new \InvalidArgumentException('invalid value for $trusthost when calling InlineObject269., number of items must be less than or equal to 0.');
        }
