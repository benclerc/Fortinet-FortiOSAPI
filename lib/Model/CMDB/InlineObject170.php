...
/**
 * InlineObject170 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject170 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_170';
    ...
    public function setSeqNum($seq_num)
    {
        ...
        if (!is_null($seq_num) && ($seq_num > 65535)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject170., must be smaller than or equal to 65535.');
        }
        if (!is_null($seq_num) && ($seq_num < 1)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject170., must be bigger than or equal to 1.');
        }
    ...
    public function setInputDevice($input_device)
    {
        ...
        if (!is_null($input_device) && (count($input_device) > 0)) {
            throw new \InvalidArgumentException('invalid value for $input_device when calling InlineObject170., number of items must be less than or equal to 0.');
        }
    ...
    public function setSrc($src)
    {
        ...
        if (!is_null($src) && (count($src) > 0)) {
            throw new \InvalidArgumentException('invalid value for $src when calling InlineObject170., number of items must be less than or equal to 0.');
        }
    ...
    public function setSrcaddr($srcaddr)
    {
        ...
        if (!is_null($srcaddr) && (count($srcaddr) > 0)) {
            throw new \InvalidArgumentException('invalid value for $srcaddr when calling InlineObject170., number of items must be less than or equal to 0.');
        }
    ...
    public function setDst($dst)
    {
        ...
        if (!is_null($dst) && (count($dst) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dst when calling InlineObject170., number of items must be less than or equal to 0.');
        }
    ...
    public function setDstaddr($dstaddr)
    {
        ...
        if (!is_null($dstaddr) && (count($dstaddr) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dstaddr when calling InlineObject170., number of items must be less than or equal to 0.');
        }
    ...
    public function setProtocol($protocol)
    {
        ...
        if (!is_null($protocol) && ($protocol > 255)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject170., must be smaller than or equal to 255.');
        }
        if (!is_null($protocol) && ($protocol < 0)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject170., must be bigger than or equal to 0.');
        }
    ...
    public function setStartPort($start_port)
    {
        ...
        if (!is_null($start_port) && ($start_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $start_port when calling InlineObject170., must be smaller than or equal to 65535.');
        }
        if (!is_null($start_port) && ($start_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $start_port when calling InlineObject170., must be bigger than or equal to 0.');
        }
    ...
    public function setEndPort($end_port)
    {
        ...
        if (!is_null($end_port) && ($end_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $end_port when calling InlineObject170., must be smaller than or equal to 65535.');
        }
        if (!is_null($end_port) && ($end_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $end_port when calling InlineObject170., must be bigger than or equal to 0.');
        }
    ...
    public function setStartSourcePort($start_source_port)
    {
        ...
        if (!is_null($start_source_port) && ($start_source_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $start_source_port when calling InlineObject170., must be smaller than or equal to 65535.');
        }
        if (!is_null($start_source_port) && ($start_source_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $start_source_port when calling InlineObject170., must be bigger than or equal to 0.');
        }
    ...
    public function setEndSourcePort($end_source_port)
    {
        ...
        if (!is_null($end_source_port) && ($end_source_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $end_source_port when calling InlineObject170., must be smaller than or equal to 65535.');
        }
        if (!is_null($end_source_port) && ($end_source_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $end_source_port when calling InlineObject170., must be bigger than or equal to 0.');
        }
    ...
    public function setOutputDevice($output_device)
    {
        if (!is_null($output_device) && (mb_strlen($output_device) > 35)) {
            throw new \InvalidArgumentException('invalid length for $output_device when calling InlineObject170., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject170., must be smaller than or equal to 255.');
        }
    ...
    public function setInternetServiceId($internet_service_id)
    {
        ...
        if (!is_null($internet_service_id) && (count($internet_service_id) > 0)) {
            throw new \InvalidArgumentException('invalid value for $internet_service_id when calling InlineObject170., number of items must be less than or equal to 0.');
        }
    ...
    public function setInternetServiceCustom($internet_service_custom)
    {
        ...
        if (!is_null($internet_service_custom) && (count($internet_service_custom) > 0)) {
            throw new \InvalidArgumentException('invalid value for $internet_service_custom when calling InlineObject170., number of items must be less than or equal to 0.');
        }
