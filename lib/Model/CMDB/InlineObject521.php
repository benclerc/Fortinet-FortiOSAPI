...
/**
 * InlineObject521 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject521 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_521';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject521., must be smaller than or equal to 63.');
        }
    ...
    public function setFqdn($fqdn)
    {
        if (!is_null($fqdn) && (mb_strlen($fqdn) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fqdn when calling InlineObject521., must be smaller than or equal to 255.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject521., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject521., must be bigger than or equal to 1.');
        }
    ...
    public function setMonitor($monitor)
    {
        if (!is_null($monitor) && (mb_strlen($monitor) > 255)) {
            throw new \InvalidArgumentException('invalid length for $monitor when calling InlineObject521., must be smaller than or equal to 255.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject521., must be smaller than or equal to 64.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 63)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject521., must be smaller than or equal to 63.');
        }
