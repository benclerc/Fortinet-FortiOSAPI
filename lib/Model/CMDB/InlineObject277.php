...
/**
 * InlineObject277 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject277 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_277';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject277., must be smaller than or equal to 64.');
        }
    ...
    public function setTlsCertificate($tls_certificate)
    {
        if (!is_null($tls_certificate) && (mb_strlen($tls_certificate) > 35)) {
            throw new \InvalidArgumentException('invalid length for $tls_certificate when calling InlineObject277., must be smaller than or equal to 35.');
        }
    ...
    public function setEmailTo($email_to)
    {
        ...
        if (!is_null($email_to) && (count($email_to) > 0)) {
            throw new \InvalidArgumentException('invalid value for $email_to when calling InlineObject277., number of items must be less than or equal to 0.');
        }
    ...
    public function setEmailFrom($email_from)
    {
        if (!is_null($email_from) && (mb_strlen($email_from) > 127)) {
            throw new \InvalidArgumentException('invalid length for $email_from when calling InlineObject277., must be smaller than or equal to 127.');
        }
    ...
    public function setEmailSubject($email_subject)
    {
        if (!is_null($email_subject) && (mb_strlen($email_subject) > 511)) {
            throw new \InvalidArgumentException('invalid length for $email_subject when calling InlineObject277., must be smaller than or equal to 511.');
        }
    ...
    public function setMinimumInterval($minimum_interval)
    {
        ...
        if (!is_null($minimum_interval) && ($minimum_interval > 2592000)) {
            throw new \InvalidArgumentException('invalid value for $minimum_interval when calling InlineObject277., must be smaller than or equal to 2592000.');
        }
        if (!is_null($minimum_interval) && ($minimum_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $minimum_interval when calling InlineObject277., must be bigger than or equal to 0.');
        }
    ...
    public function setDelay($delay)
    {
        ...
        if (!is_null($delay) && ($delay > 3600)) {
            throw new \InvalidArgumentException('invalid value for $delay when calling InlineObject277., must be smaller than or equal to 3600.');
        }
        if (!is_null($delay) && ($delay < 0)) {
            throw new \InvalidArgumentException('invalid value for $delay when calling InlineObject277., must be bigger than or equal to 0.');
        }
    ...
    public function setAwsApiId($aws_api_id)
    {
        if (!is_null($aws_api_id) && (mb_strlen($aws_api_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $aws_api_id when calling InlineObject277., must be smaller than or equal to 35.');
        }
    ...
    public function setAwsRegion($aws_region)
    {
        if (!is_null($aws_region) && (mb_strlen($aws_region) > 35)) {
            throw new \InvalidArgumentException('invalid length for $aws_region when calling InlineObject277., must be smaller than or equal to 35.');
        }
    ...
    public function setAwsDomain($aws_domain)
    {
        if (!is_null($aws_domain) && (mb_strlen($aws_domain) > 63)) {
            throw new \InvalidArgumentException('invalid length for $aws_domain when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAwsApiStage($aws_api_stage)
    {
        if (!is_null($aws_api_stage) && (mb_strlen($aws_api_stage) > 63)) {
            throw new \InvalidArgumentException('invalid length for $aws_api_stage when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAwsApiPath($aws_api_path)
    {
        if (!is_null($aws_api_path) && (mb_strlen($aws_api_path) > 63)) {
            throw new \InvalidArgumentException('invalid length for $aws_api_path when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAzureApp($azure_app)
    {
        if (!is_null($azure_app) && (mb_strlen($azure_app) > 63)) {
            throw new \InvalidArgumentException('invalid length for $azure_app when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAzureFunction($azure_function)
    {
        if (!is_null($azure_function) && (mb_strlen($azure_function) > 63)) {
            throw new \InvalidArgumentException('invalid length for $azure_function when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAzureDomain($azure_domain)
    {
        if (!is_null($azure_domain) && (mb_strlen($azure_domain) > 63)) {
            throw new \InvalidArgumentException('invalid length for $azure_domain when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setGcpFunctionRegion($gcp_function_region)
    {
        if (!is_null($gcp_function_region) && (mb_strlen($gcp_function_region) > 63)) {
            throw new \InvalidArgumentException('invalid length for $gcp_function_region when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setGcpProject($gcp_project)
    {
        if (!is_null($gcp_project) && (mb_strlen($gcp_project) > 63)) {
            throw new \InvalidArgumentException('invalid length for $gcp_project when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setGcpFunctionDomain($gcp_function_domain)
    {
        if (!is_null($gcp_function_domain) && (mb_strlen($gcp_function_domain) > 63)) {
            throw new \InvalidArgumentException('invalid length for $gcp_function_domain when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setGcpFunction($gcp_function)
    {
        if (!is_null($gcp_function) && (mb_strlen($gcp_function) > 63)) {
            throw new \InvalidArgumentException('invalid length for $gcp_function when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAlicloudAccountId($alicloud_account_id)
    {
        if (!is_null($alicloud_account_id) && (mb_strlen($alicloud_account_id) > 63)) {
            throw new \InvalidArgumentException('invalid length for $alicloud_account_id when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAlicloudRegion($alicloud_region)
    {
        if (!is_null($alicloud_region) && (mb_strlen($alicloud_region) > 63)) {
            throw new \InvalidArgumentException('invalid length for $alicloud_region when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAlicloudFunctionDomain($alicloud_function_domain)
    {
        if (!is_null($alicloud_function_domain) && (mb_strlen($alicloud_function_domain) > 63)) {
            throw new \InvalidArgumentException('invalid length for $alicloud_function_domain when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAlicloudVersion($alicloud_version)
    {
        if (!is_null($alicloud_version) && (mb_strlen($alicloud_version) > 63)) {
            throw new \InvalidArgumentException('invalid length for $alicloud_version when calling InlineObject277., must be smaller than or equal to 63.');
        }
    ...
    public function setAlicloudService($alicloud_service)
    {
        if (!is_null($alicloud_service) && (mb_strlen($alicloud_service) > 128)) {
            throw new \InvalidArgumentException('invalid length for $alicloud_service when calling InlineObject277., must be smaller than or equal to 128.');
        }
    ...
    public function setAlicloudFunction($alicloud_function)
    {
        if (!is_null($alicloud_function) && (mb_strlen($alicloud_function) > 128)) {
            throw new \InvalidArgumentException('invalid length for $alicloud_function when calling InlineObject277., must be smaller than or equal to 128.');
        }
    ...
    public function setAlicloudAccessKeyId($alicloud_access_key_id)
    {
        if (!is_null($alicloud_access_key_id) && (mb_strlen($alicloud_access_key_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $alicloud_access_key_id when calling InlineObject277., must be smaller than or equal to 35.');
        }
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $message when calling InlineObject277., must be smaller than or equal to 1023.');
        }
    ...
    public function setUri($uri)
    {
        if (!is_null($uri) && (mb_strlen($uri) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $uri when calling InlineObject277., must be smaller than or equal to 1023.');
        }
    ...
    public function setHttpBody($http_body)
    {
        if (!is_null($http_body) && (mb_strlen($http_body) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $http_body when calling InlineObject277., must be smaller than or equal to 1023.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject277., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject277., must be bigger than or equal to 1.');
        }
    ...
    public function setHeaders($headers)
    {
        ...
        if (!is_null($headers) && (count($headers) > 0)) {
            throw new \InvalidArgumentException('invalid value for $headers when calling InlineObject277., number of items must be less than or equal to 0.');
        }
    ...
    public function setScript($script)
    {
        if (!is_null($script) && (mb_strlen($script) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $script when calling InlineObject277., must be smaller than or equal to 1023.');
        }
    ...
    public function setSecurityTag($security_tag)
    {
        if (!is_null($security_tag) && (mb_strlen($security_tag) > 255)) {
            throw new \InvalidArgumentException('invalid length for $security_tag when calling InlineObject277., must be smaller than or equal to 255.');
        }
    ...
    public function setSdnConnector($sdn_connector)
    {
        ...
        if (!is_null($sdn_connector) && (count($sdn_connector) > 0)) {
            throw new \InvalidArgumentException('invalid value for $sdn_connector when calling InlineObject277., number of items must be less than or equal to 0.');
        }
