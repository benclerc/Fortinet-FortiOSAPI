...
/**
 * InlineObject85 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject85 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_85';
     ...
     * Sets severity
     *
     * @param string|null $severity Log to disk every message above and including this severity level.    emergency:Emergency level.    alert:Alert level.    critical:Critical level.    error:Error level.    warning:Warning level.    notification:Notification level.    information:Information level.    debug:Debug level.
     *
     * @return self
     */
     ...
     * Sets filter
     *
     * @param string|null $filter Disk log filter.
     *
     * @return self
     */
    public function setFilter($filter)
    {
        if (!is_null($filter) && (mb_strlen($filter) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $filter when calling InlineObject85., must be smaller than or equal to 1023.');
        }
