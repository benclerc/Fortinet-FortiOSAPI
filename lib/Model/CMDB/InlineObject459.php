...
/**
 * InlineObject459 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject459 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_459';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 79)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject459., must be smaller than or equal to 79.');
        }
    ...
    public function setScepUrl($scep_url)
    {
        if (!is_null($scep_url) && (mb_strlen($scep_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $scep_url when calling InlineObject459., must be smaller than or equal to 255.');
        }
    ...
    public function setAutoUpdateDays($auto_update_days)
    {
        ...
        if (!is_null($auto_update_days) && ($auto_update_days > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_update_days when calling InlineObject459., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_update_days) && ($auto_update_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_update_days when calling InlineObject459., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoUpdateDaysWarning($auto_update_days_warning)
    {
        ...
        if (!is_null($auto_update_days_warning) && ($auto_update_days_warning > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_update_days_warning when calling InlineObject459., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_update_days_warning) && ($auto_update_days_warning < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_update_days_warning when calling InlineObject459., must be bigger than or equal to 0.');
        }
