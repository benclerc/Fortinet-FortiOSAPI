...
/**
 * InlineObject262 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject262 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_262';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject262., must be smaller than or equal to 32.');
        }
    ...
    public function setTrapLport($trap_lport)
    {
        ...
        if (!is_null($trap_lport) && ($trap_lport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $trap_lport when calling InlineObject262., must be smaller than or equal to 65535.');
        }
        if (!is_null($trap_lport) && ($trap_lport < 0)) {
            throw new \InvalidArgumentException('invalid value for $trap_lport when calling InlineObject262., must be bigger than or equal to 0.');
        }
    ...
    public function setTrapRport($trap_rport)
    {
        ...
        if (!is_null($trap_rport) && ($trap_rport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $trap_rport when calling InlineObject262., must be smaller than or equal to 65535.');
        }
        if (!is_null($trap_rport) && ($trap_rport < 0)) {
            throw new \InvalidArgumentException('invalid value for $trap_rport when calling InlineObject262., must be bigger than or equal to 0.');
        }
    ...
    public function setQueryPort($query_port)
    {
        ...
        if (!is_null($query_port) && ($query_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $query_port when calling InlineObject262., must be smaller than or equal to 65535.');
        }
        if (!is_null($query_port) && ($query_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $query_port when calling InlineObject262., must be bigger than or equal to 0.');
        }
