...
/**
 * InlineObject219 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject219 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_219';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject219., must be smaller than or equal to 63.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 63)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject219., must be smaller than or equal to 63.');
        }
    ...
    public function setFortilink($fortilink)
    {
        if (!is_null($fortilink) && (mb_strlen($fortilink) > 15)) {
            throw new \InvalidArgumentException('invalid length for $fortilink when calling InlineObject219., must be smaller than or equal to 15.');
        }
    ...
    public function setVlan($vlan)
    {
        if (!is_null($vlan) && (mb_strlen($vlan) > 15)) {
            throw new \InvalidArgumentException('invalid length for $vlan when calling InlineObject219., must be smaller than or equal to 15.');
        }
    ...
    public function setAllowedVlans($allowed_vlans)
    {
        ...
        if (!is_null($allowed_vlans) && (count($allowed_vlans) > 0)) {
            throw new \InvalidArgumentException('invalid value for $allowed_vlans when calling InlineObject219., number of items must be less than or equal to 0.');
        }
    ...
    public function setUntaggedVlans($untagged_vlans)
    {
        ...
        if (!is_null($untagged_vlans) && (count($untagged_vlans) > 0)) {
            throw new \InvalidArgumentException('invalid value for $untagged_vlans when calling InlineObject219., number of items must be less than or equal to 0.');
        }
