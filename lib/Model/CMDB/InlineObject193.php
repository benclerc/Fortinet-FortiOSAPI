 ...
 */
class InlineObject193 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 31)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject193., must be smaller than or equal to 31.');
        }
    ...
    public function setUserGroup($user_group)
    {
        ...
        if (!is_null($user_group) && (count($user_group) > 0)) {
            throw new \InvalidArgumentException('invalid value for $user_group when calling InlineObject193., number of items must be less than or equal to 0.');
        }
    ...
    public function setGuestVlanId($guest_vlan_id)
    {
        if (!is_null($guest_vlan_id) && (mb_strlen($guest_vlan_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $guest_vlan_id when calling InlineObject193., must be smaller than or equal to 15.');
        }
    ...
    public function setGuestAuthDelay($guest_auth_delay)
    {
        ...
        if (!is_null($guest_auth_delay) && ($guest_auth_delay > 900)) {
            throw new \InvalidArgumentException('invalid value for $guest_auth_delay when calling InlineObject193., must be smaller than or equal to 900.');
        }
        if (!is_null($guest_auth_delay) && ($guest_auth_delay < 1)) {
            throw new \InvalidArgumentException('invalid value for $guest_auth_delay when calling InlineObject193., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthFailVlanId($auth_fail_vlan_id)
    {
        if (!is_null($auth_fail_vlan_id) && (mb_strlen($auth_fail_vlan_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $auth_fail_vlan_id when calling InlineObject193., must be smaller than or equal to 15.');
        }
    ...
    public function setAuthserverTimeoutPeriod($authserver_timeout_period)
    {
        ...
        if (!is_null($authserver_timeout_period) && ($authserver_timeout_period > 15)) {
            throw new \InvalidArgumentException('invalid value for $authserver_timeout_period when calling InlineObject193., must be smaller than or equal to 15.');
        }
        if (!is_null($authserver_timeout_period) && ($authserver_timeout_period < 3)) {
            throw new \InvalidArgumentException('invalid value for $authserver_timeout_period when calling InlineObject193., must be bigger than or equal to 3.');
        }
    ...
    public function setAuthserverTimeoutVlanid($authserver_timeout_vlanid)
    {
        if (!is_null($authserver_timeout_vlanid) && (mb_strlen($authserver_timeout_vlanid) > 15)) {
            throw new \InvalidArgumentException('invalid length for $authserver_timeout_vlanid when calling InlineObject193., must be smaller than or equal to 15.');
        }
