...
/**
 * AntivirusProfileNameSsh Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class AntivirusProfileNameSsh implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_antivirus_profile__name__ssh';
     ...
     * Sets options
     *
     * @param string|null $options Enable/disable SFTP and SCP AntiVirus scanning, monitoring, and quarantine.    scan:Enable SSH antivirus scanning.    avmonitor:Enable SSH antivirus logging.    quarantine:Enable SSH antivirus quarantine. Files are quarantined depending on quarantine settings.
     *
     * @return self
     */
