...
/**
 * InlineObject145 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject145 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_145';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject145., must be smaller than or equal to 35.');
        }
    ...
    public function setDefaultHtmlStyle($default_html_style)
    {
        if (!is_null($default_html_style) && (mb_strlen($default_html_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $default_html_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setDefaultPdfStyle($default_pdf_style)
    {
        if (!is_null($default_pdf_style) && (mb_strlen($default_pdf_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $default_pdf_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setPageStyle($page_style)
    {
        if (!is_null($page_style) && (mb_strlen($page_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $page_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setPageHeaderStyle($page_header_style)
    {
        if (!is_null($page_header_style) && (mb_strlen($page_header_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $page_header_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setPageFooterStyle($page_footer_style)
    {
        if (!is_null($page_footer_style) && (mb_strlen($page_footer_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $page_footer_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setReportTitleStyle($report_title_style)
    {
        if (!is_null($report_title_style) && (mb_strlen($report_title_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $report_title_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setReportSubtitleStyle($report_subtitle_style)
    {
        if (!is_null($report_subtitle_style) && (mb_strlen($report_subtitle_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $report_subtitle_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTocTitleStyle($toc_title_style)
    {
        if (!is_null($toc_title_style) && (mb_strlen($toc_title_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $toc_title_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTocHeading1Style($toc_heading1_style)
    {
        if (!is_null($toc_heading1_style) && (mb_strlen($toc_heading1_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $toc_heading1_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTocHeading2Style($toc_heading2_style)
    {
        if (!is_null($toc_heading2_style) && (mb_strlen($toc_heading2_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $toc_heading2_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTocHeading3Style($toc_heading3_style)
    {
        if (!is_null($toc_heading3_style) && (mb_strlen($toc_heading3_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $toc_heading3_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTocHeading4Style($toc_heading4_style)
    {
        if (!is_null($toc_heading4_style) && (mb_strlen($toc_heading4_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $toc_heading4_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setHeading1Style($heading1_style)
    {
        if (!is_null($heading1_style) && (mb_strlen($heading1_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $heading1_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setHeading2Style($heading2_style)
    {
        if (!is_null($heading2_style) && (mb_strlen($heading2_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $heading2_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setHeading3Style($heading3_style)
    {
        if (!is_null($heading3_style) && (mb_strlen($heading3_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $heading3_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setHeading4Style($heading4_style)
    {
        if (!is_null($heading4_style) && (mb_strlen($heading4_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $heading4_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setNormalTextStyle($normal_text_style)
    {
        if (!is_null($normal_text_style) && (mb_strlen($normal_text_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $normal_text_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setBulletListStyle($bullet_list_style)
    {
        if (!is_null($bullet_list_style) && (mb_strlen($bullet_list_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $bullet_list_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setNumberedListStyle($numbered_list_style)
    {
        if (!is_null($numbered_list_style) && (mb_strlen($numbered_list_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $numbered_list_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setImageStyle($image_style)
    {
        if (!is_null($image_style) && (mb_strlen($image_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $image_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setHlineStyle($hline_style)
    {
        if (!is_null($hline_style) && (mb_strlen($hline_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $hline_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setGraphChartStyle($graph_chart_style)
    {
        if (!is_null($graph_chart_style) && (mb_strlen($graph_chart_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $graph_chart_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTableChartStyle($table_chart_style)
    {
        if (!is_null($table_chart_style) && (mb_strlen($table_chart_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $table_chart_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTableChartCaptionStyle($table_chart_caption_style)
    {
        if (!is_null($table_chart_caption_style) && (mb_strlen($table_chart_caption_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $table_chart_caption_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTableChartHeadStyle($table_chart_head_style)
    {
        if (!is_null($table_chart_head_style) && (mb_strlen($table_chart_head_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $table_chart_head_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTableChartOddRowStyle($table_chart_odd_row_style)
    {
        if (!is_null($table_chart_odd_row_style) && (mb_strlen($table_chart_odd_row_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $table_chart_odd_row_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
    ...
    public function setTableChartEvenRowStyle($table_chart_even_row_style)
    {
        if (!is_null($table_chart_even_row_style) && (mb_strlen($table_chart_even_row_style) > 71)) {
            throw new \InvalidArgumentException('invalid length for $table_chart_even_row_style when calling InlineObject145., must be smaller than or equal to 71.');
        }
