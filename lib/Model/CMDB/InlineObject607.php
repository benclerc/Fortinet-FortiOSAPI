...
/**
 * InlineObject607 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject607 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_607';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject607., must be smaller than or equal to 15.');
        }
    ...
    public function setAtfWeight($atf_weight)
    {
        ...
        if (!is_null($atf_weight) && ($atf_weight > 100)) {
            throw new \InvalidArgumentException('invalid value for $atf_weight when calling InlineObject607., must be smaller than or equal to 100.');
        }
        if (!is_null($atf_weight) && ($atf_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $atf_weight when calling InlineObject607., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxClients($max_clients)
    {
        ...
        if (!is_null($max_clients) && ($max_clients > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $max_clients when calling InlineObject607., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($max_clients) && ($max_clients < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_clients when calling InlineObject607., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxClientsAp($max_clients_ap)
    {
        ...
        if (!is_null($max_clients_ap) && ($max_clients_ap > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $max_clients_ap when calling InlineObject607., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($max_clients_ap) && ($max_clients_ap < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_clients_ap when calling InlineObject607., must be bigger than or equal to 0.');
        }
    ...
    public function setSsid($ssid)
    {
        if (!is_null($ssid) && (mb_strlen($ssid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling InlineObject607., must be smaller than or equal to 32.');
        }
    ...
    public function setPmfAssocComebackTimeout($pmf_assoc_comeback_timeout)
    {
        ...
        if (!is_null($pmf_assoc_comeback_timeout) && ($pmf_assoc_comeback_timeout > 20)) {
            throw new \InvalidArgumentException('invalid value for $pmf_assoc_comeback_timeout when calling InlineObject607., must be smaller than or equal to 20.');
        }
        if (!is_null($pmf_assoc_comeback_timeout) && ($pmf_assoc_comeback_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $pmf_assoc_comeback_timeout when calling InlineObject607., must be bigger than or equal to 1.');
        }
    ...
    public function setPmfSaQueryRetryTimeout($pmf_sa_query_retry_timeout)
    {
        ...
        if (!is_null($pmf_sa_query_retry_timeout) && ($pmf_sa_query_retry_timeout > 5)) {
            throw new \InvalidArgumentException('invalid value for $pmf_sa_query_retry_timeout when calling InlineObject607., must be smaller than or equal to 5.');
        }
        if (!is_null($pmf_sa_query_retry_timeout) && ($pmf_sa_query_retry_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $pmf_sa_query_retry_timeout when calling InlineObject607., must be bigger than or equal to 1.');
        }
    ...
    public function setFtMobilityDomain($ft_mobility_domain)
    {
        ...
        if (!is_null($ft_mobility_domain) && ($ft_mobility_domain > 65535)) {
            throw new \InvalidArgumentException('invalid value for $ft_mobility_domain when calling InlineObject607., must be smaller than or equal to 65535.');
        }
        if (!is_null($ft_mobility_domain) && ($ft_mobility_domain < 1)) {
            throw new \InvalidArgumentException('invalid value for $ft_mobility_domain when calling InlineObject607., must be bigger than or equal to 1.');
        }
    ...
    public function setFtR0KeyLifetime($ft_r0_key_lifetime)
    {
        ...
        if (!is_null($ft_r0_key_lifetime) && ($ft_r0_key_lifetime > 65535)) {
            throw new \InvalidArgumentException('invalid value for $ft_r0_key_lifetime when calling InlineObject607., must be smaller than or equal to 65535.');
        }
        if (!is_null($ft_r0_key_lifetime) && ($ft_r0_key_lifetime < 1)) {
            throw new \InvalidArgumentException('invalid value for $ft_r0_key_lifetime when calling InlineObject607., must be bigger than or equal to 1.');
        }
    ...
    public function setOweTransitionSsid($owe_transition_ssid)
    {
        if (!is_null($owe_transition_ssid) && (mb_strlen($owe_transition_ssid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $owe_transition_ssid when calling InlineObject607., must be smaller than or equal to 32.');
        }
    ...
    public function setExternalWeb($external_web)
    {
        if (!is_null($external_web) && (mb_strlen($external_web) > 127)) {
            throw new \InvalidArgumentException('invalid length for $external_web when calling InlineObject607., must be smaller than or equal to 127.');
        }
    ...
    public function setExternalLogout($external_logout)
    {
        if (!is_null($external_logout) && (mb_strlen($external_logout) > 127)) {
            throw new \InvalidArgumentException('invalid length for $external_logout when calling InlineObject607., must be smaller than or equal to 127.');
        }
    ...
    public function setRadiusMacAuthServer($radius_mac_auth_server)
    {
        if (!is_null($radius_mac_auth_server) && (mb_strlen($radius_mac_auth_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $radius_mac_auth_server when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setRadiusMacAuthUsergroups($radius_mac_auth_usergroups)
    {
        ...
        if (!is_null($radius_mac_auth_usergroups) && (count($radius_mac_auth_usergroups) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radius_mac_auth_usergroups when calling InlineObject607., number of items must be less than or equal to 0.');
        }
    ...
    public function setKeyindex($keyindex)
    {
        ...
        if (!is_null($keyindex) && ($keyindex > 4)) {
            throw new \InvalidArgumentException('invalid value for $keyindex when calling InlineObject607., must be smaller than or equal to 4.');
        }
        if (!is_null($keyindex) && ($keyindex < 1)) {
            throw new \InvalidArgumentException('invalid value for $keyindex when calling InlineObject607., must be bigger than or equal to 1.');
        }
    ...
    public function setRadiusServer($radius_server)
    {
        if (!is_null($radius_server) && (mb_strlen($radius_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $radius_server when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setDhcpLeaseTime($dhcp_lease_time)
    {
        ...
        if (!is_null($dhcp_lease_time) && ($dhcp_lease_time > 8640000)) {
            throw new \InvalidArgumentException('invalid value for $dhcp_lease_time when calling InlineObject607., must be smaller than or equal to 8640000.');
        }
        if (!is_null($dhcp_lease_time) && ($dhcp_lease_time < 300)) {
            throw new \InvalidArgumentException('invalid value for $dhcp_lease_time when calling InlineObject607., must be bigger than or equal to 300.');
        }
    ...
    public function setUsergroup($usergroup)
    {
        ...
        if (!is_null($usergroup) && (count($usergroup) > 0)) {
            throw new \InvalidArgumentException('invalid value for $usergroup when calling InlineObject607., number of items must be less than or equal to 0.');
        }
    ...
    public function setPortalMessageOverrideGroup($portal_message_override_group)
    {
        if (!is_null($portal_message_override_group) && (mb_strlen($portal_message_override_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $portal_message_override_group when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setPortalMessageOverrides($portal_message_overrides)
    {
        ...
        if (!is_null($portal_message_overrides) && (count($portal_message_overrides) > 0)) {
            throw new \InvalidArgumentException('invalid value for $portal_message_overrides when calling InlineObject607., number of items must be less than or equal to 0.');
        }
    ...
    public function setSelectedUsergroups($selected_usergroups)
    {
        ...
        if (!is_null($selected_usergroups) && (count($selected_usergroups) > 0)) {
            throw new \InvalidArgumentException('invalid value for $selected_usergroups when calling InlineObject607., number of items must be less than or equal to 0.');
        }
    ...
    public function setSecurityExemptList($security_exempt_list)
    {
        if (!is_null($security_exempt_list) && (mb_strlen($security_exempt_list) > 35)) {
            throw new \InvalidArgumentException('invalid length for $security_exempt_list when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setSecurityRedirectUrl($security_redirect_url)
    {
        if (!is_null($security_redirect_url) && (mb_strlen($security_redirect_url) > 127)) {
            throw new \InvalidArgumentException('invalid length for $security_redirect_url when calling InlineObject607., must be smaller than or equal to 127.');
        }
    ...
    public function setSchedule($schedule)
    {
        ...
        if (!is_null($schedule) && (count($schedule) > 16)) {
            throw new \InvalidArgumentException('invalid value for $schedule when calling InlineObject607., number of items must be less than or equal to 16.');
        }
    ...
    public function setPortMacauthTimeout($port_macauth_timeout)
    {
        ...
        if (!is_null($port_macauth_timeout) && ($port_macauth_timeout > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port_macauth_timeout when calling InlineObject607., must be smaller than or equal to 65535.');
        }
        if (!is_null($port_macauth_timeout) && ($port_macauth_timeout < 60)) {
            throw new \InvalidArgumentException('invalid value for $port_macauth_timeout when calling InlineObject607., must be bigger than or equal to 60.');
        }
    ...
    public function setPortMacauthReauthTimeout($port_macauth_reauth_timeout)
    {
        ...
        if (!is_null($port_macauth_reauth_timeout) && ($port_macauth_reauth_timeout > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port_macauth_reauth_timeout when calling InlineObject607., must be smaller than or equal to 65535.');
        }
        if (!is_null($port_macauth_reauth_timeout) && ($port_macauth_reauth_timeout < 120)) {
            throw new \InvalidArgumentException('invalid value for $port_macauth_reauth_timeout when calling InlineObject607., must be bigger than or equal to 120.');
        }
    ...
    public function setMpskProfile($mpsk_profile)
    {
        if (!is_null($mpsk_profile) && (mb_strlen($mpsk_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $mpsk_profile when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setVlanid($vlanid)
    {
        ...
        if (!is_null($vlanid) && ($vlanid > 4094)) {
            throw new \InvalidArgumentException('invalid value for $vlanid when calling InlineObject607., must be smaller than or equal to 4094.');
        }
        if (!is_null($vlanid) && ($vlanid < 0)) {
            throw new \InvalidArgumentException('invalid value for $vlanid when calling InlineObject607., must be bigger than or equal to 0.');
        }
    ...
    public function setCaptivePortalAcName($captive_portal_ac_name)
    {
        if (!is_null($captive_portal_ac_name) && (mb_strlen($captive_portal_ac_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $captive_portal_ac_name when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setCaptivePortalAuthTimeout($captive_portal_auth_timeout)
    {
        ...
        if (!is_null($captive_portal_auth_timeout) && ($captive_portal_auth_timeout > 864000)) {
            throw new \InvalidArgumentException('invalid value for $captive_portal_auth_timeout when calling InlineObject607., must be smaller than or equal to 864000.');
        }
        if (!is_null($captive_portal_auth_timeout) && ($captive_portal_auth_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $captive_portal_auth_timeout when calling InlineObject607., must be bigger than or equal to 0.');
        }
    ...
    public function setMeDisableThresh($me_disable_thresh)
    {
        ...
        if (!is_null($me_disable_thresh) && ($me_disable_thresh > 256)) {
            throw new \InvalidArgumentException('invalid value for $me_disable_thresh when calling InlineObject607., must be smaller than or equal to 256.');
        }
        if (!is_null($me_disable_thresh) && ($me_disable_thresh < 2)) {
            throw new \InvalidArgumentException('invalid value for $me_disable_thresh when calling InlineObject607., must be bigger than or equal to 2.');
        }
    ...
    public function setProbeRespThreshold($probe_resp_threshold)
    {
        if (!is_null($probe_resp_threshold) && (mb_strlen($probe_resp_threshold) > 7)) {
            throw new \InvalidArgumentException('invalid length for $probe_resp_threshold when calling InlineObject607., must be smaller than or equal to 7.');
        }
    ...
    public function setRadio5gThreshold($radio_5g_threshold)
    {
        if (!is_null($radio_5g_threshold) && (mb_strlen($radio_5g_threshold) > 7)) {
            throw new \InvalidArgumentException('invalid length for $radio_5g_threshold when calling InlineObject607., must be smaller than or equal to 7.');
        }
    ...
    public function setRadio2gThreshold($radio_2g_threshold)
    {
        if (!is_null($radio_2g_threshold) && (mb_strlen($radio_2g_threshold) > 7)) {
            throw new \InvalidArgumentException('invalid length for $radio_2g_threshold when calling InlineObject607., must be smaller than or equal to 7.');
        }
    ...
    public function setVlanPool($vlan_pool)
    {
        ...
        if (!is_null($vlan_pool) && (count($vlan_pool) > 16)) {
            throw new \InvalidArgumentException('invalid value for $vlan_pool when calling InlineObject607., number of items must be less than or equal to 16.');
        }
    ...
    public function setPtkRekeyIntv($ptk_rekey_intv)
    {
        ...
        if (!is_null($ptk_rekey_intv) && ($ptk_rekey_intv > 864000)) {
            throw new \InvalidArgumentException('invalid value for $ptk_rekey_intv when calling InlineObject607., must be smaller than or equal to 864000.');
        }
        if (!is_null($ptk_rekey_intv) && ($ptk_rekey_intv < 1800)) {
            throw new \InvalidArgumentException('invalid value for $ptk_rekey_intv when calling InlineObject607., must be bigger than or equal to 1800.');
        }
    ...
    public function setGtkRekeyIntv($gtk_rekey_intv)
    {
        ...
        if (!is_null($gtk_rekey_intv) && ($gtk_rekey_intv > 864000)) {
            throw new \InvalidArgumentException('invalid value for $gtk_rekey_intv when calling InlineObject607., must be smaller than or equal to 864000.');
        }
        if (!is_null($gtk_rekey_intv) && ($gtk_rekey_intv < 1800)) {
            throw new \InvalidArgumentException('invalid value for $gtk_rekey_intv when calling InlineObject607., must be bigger than or equal to 1800.');
        }
    ...
    public function setEapReauthIntv($eap_reauth_intv)
    {
        ...
        if (!is_null($eap_reauth_intv) && ($eap_reauth_intv > 864000)) {
            throw new \InvalidArgumentException('invalid value for $eap_reauth_intv when calling InlineObject607., must be smaller than or equal to 864000.');
        }
        if (!is_null($eap_reauth_intv) && ($eap_reauth_intv < 1800)) {
            throw new \InvalidArgumentException('invalid value for $eap_reauth_intv when calling InlineObject607., must be bigger than or equal to 1800.');
        }
    ...
    public function setQosProfile($qos_profile)
    {
        if (!is_null($qos_profile) && (mb_strlen($qos_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $qos_profile when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setHotspot20Profile($hotspot20_profile)
    {
        if (!is_null($hotspot20_profile) && (mb_strlen($hotspot20_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $hotspot20_profile when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setAccessControlList($access_control_list)
    {
        if (!is_null($access_control_list) && (mb_strlen($access_control_list) > 35)) {
            throw new \InvalidArgumentException('invalid length for $access_control_list when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setPrimaryWagProfile($primary_wag_profile)
    {
        if (!is_null($primary_wag_profile) && (mb_strlen($primary_wag_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $primary_wag_profile when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setSecondaryWagProfile($secondary_wag_profile)
    {
        if (!is_null($secondary_wag_profile) && (mb_strlen($secondary_wag_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $secondary_wag_profile when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setTunnelEchoInterval($tunnel_echo_interval)
    {
        ...
        if (!is_null($tunnel_echo_interval) && ($tunnel_echo_interval > 65535)) {
            throw new \InvalidArgumentException('invalid value for $tunnel_echo_interval when calling InlineObject607., must be smaller than or equal to 65535.');
        }
        if (!is_null($tunnel_echo_interval) && ($tunnel_echo_interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $tunnel_echo_interval when calling InlineObject607., must be bigger than or equal to 1.');
        }
    ...
    public function setTunnelFallbackInterval($tunnel_fallback_interval)
    {
        ...
        if (!is_null($tunnel_fallback_interval) && ($tunnel_fallback_interval > 65535)) {
            throw new \InvalidArgumentException('invalid value for $tunnel_fallback_interval when calling InlineObject607., must be smaller than or equal to 65535.');
        }
        if (!is_null($tunnel_fallback_interval) && ($tunnel_fallback_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $tunnel_fallback_interval when calling InlineObject607., must be bigger than or equal to 0.');
        }
    ...
    public function setUtmProfile($utm_profile)
    {
        if (!is_null($utm_profile) && (mb_strlen($utm_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $utm_profile when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setAddressGroup($address_group)
    {
        if (!is_null($address_group) && (mb_strlen($address_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address_group when calling InlineObject607., must be smaller than or equal to 35.');
        }
    ...
    public function setMacFilterList($mac_filter_list)
    {
        ...
        if (!is_null($mac_filter_list) && (count($mac_filter_list) > 0)) {
            throw new \InvalidArgumentException('invalid value for $mac_filter_list when calling InlineObject607., number of items must be less than or equal to 0.');
        }
    ...
    public function setStickyClientThreshold5g($sticky_client_threshold_5g)
    {
        if (!is_null($sticky_client_threshold_5g) && (mb_strlen($sticky_client_threshold_5g) > 7)) {
            throw new \InvalidArgumentException('invalid length for $sticky_client_threshold_5g when calling InlineObject607., must be smaller than or equal to 7.');
        }
    ...
    public function setStickyClientThreshold2g($sticky_client_threshold_2g)
    {
        if (!is_null($sticky_client_threshold_2g) && (mb_strlen($sticky_client_threshold_2g) > 7)) {
            throw new \InvalidArgumentException('invalid length for $sticky_client_threshold_2g when calling InlineObject607., must be smaller than or equal to 7.');
        }
