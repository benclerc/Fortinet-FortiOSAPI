...
/**
 * AntivirusProfileNameCifs Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class AntivirusProfileNameCifs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_antivirus_profile__name__cifs';
     ...
     * Sets options
     *
     * @param string|null $options Enable/disable CIFS AntiVirus scanning, monitoring, and quarantine.    scan:Enable CIFS antivirus scanning.    avmonitor:Enable CIFS antivirus logging.    quarantine:Enable CIFS antivirus quarantine. Files are quarantined depending on quarantine settings.
     *
     * @return self
     */
