...
/**
 * InlineObject266 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject266 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_266';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject266., must be smaller than or equal to 64.');
        }
    ...
    public function setRemoteGroup($remote_group)
    {
        if (!is_null($remote_group) && (mb_strlen($remote_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $remote_group when calling InlineObject266., must be smaller than or equal to 35.');
        }
    ...
    public function setPeerGroup($peer_group)
    {
        if (!is_null($peer_group) && (mb_strlen($peer_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $peer_group when calling InlineObject266., must be smaller than or equal to 35.');
        }
    ...
    public function setAccprofile($accprofile)
    {
        if (!is_null($accprofile) && (mb_strlen($accprofile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $accprofile when calling InlineObject266., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject266., must be smaller than or equal to 255.');
        }
    ...
    public function setVdom($vdom)
    {
        ...
        if (!is_null($vdom) && (count($vdom) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vdom when calling InlineObject266., number of items must be less than or equal to 0.');
        }
    ...
    public function setSshCertificate($ssh_certificate)
    {
        if (!is_null($ssh_certificate) && (mb_strlen($ssh_certificate) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ssh_certificate when calling InlineObject266., must be smaller than or equal to 35.');
        }
    ...
    public function setSchedule($schedule)
    {
        if (!is_null($schedule) && (mb_strlen($schedule) > 35)) {
            throw new \InvalidArgumentException('invalid length for $schedule when calling InlineObject266., must be smaller than or equal to 35.');
        }
    ...
    public function setFortitoken($fortitoken)
    {
        if (!is_null($fortitoken) && (mb_strlen($fortitoken) > 16)) {
            throw new \InvalidArgumentException('invalid length for $fortitoken when calling InlineObject266., must be smaller than or equal to 16.');
        }
    ...
    public function setEmailTo($email_to)
    {
        if (!is_null($email_to) && (mb_strlen($email_to) > 63)) {
            throw new \InvalidArgumentException('invalid length for $email_to when calling InlineObject266., must be smaller than or equal to 63.');
        }
    ...
    public function setSmsCustomServer($sms_custom_server)
    {
        if (!is_null($sms_custom_server) && (mb_strlen($sms_custom_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sms_custom_server when calling InlineObject266., must be smaller than or equal to 35.');
        }
    ...
    public function setSmsPhone($sms_phone)
    {
        if (!is_null($sms_phone) && (mb_strlen($sms_phone) > 15)) {
            throw new \InvalidArgumentException('invalid length for $sms_phone when calling InlineObject266., must be smaller than or equal to 15.');
        }
    ...
    public function setGuestUsergroups($guest_usergroups)
    {
        ...
        if (!is_null($guest_usergroups) && (count($guest_usergroups) > 0)) {
            throw new \InvalidArgumentException('invalid value for $guest_usergroups when calling InlineObject266., number of items must be less than or equal to 0.');
        }
    ...
    public function setGuestLang($guest_lang)
    {
        if (!is_null($guest_lang) && (mb_strlen($guest_lang) > 35)) {
            throw new \InvalidArgumentException('invalid length for $guest_lang when calling InlineObject266., must be smaller than or equal to 35.');
        }
