...
/**
 * InlineObject302 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject302 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_302';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject302., must be smaller than or equal to 35.');
        }
    ...
    public function setCategory($category)
    {
        ...
        if (!is_null($category) && ($category > 221)) {
            throw new \InvalidArgumentException('invalid value for $category when calling InlineObject302., must be smaller than or equal to 221.');
        }
        if (!is_null($category) && ($category < 192)) {
            throw new \InvalidArgumentException('invalid value for $category when calling InlineObject302., must be bigger than or equal to 192.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject302., must be smaller than or equal to 64.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject302., must be smaller than or equal to 255.');
        }
    ...
    public function setResource($resource)
    {
        if (!is_null($resource) && (mb_strlen($resource) > 511)) {
            throw new \InvalidArgumentException('invalid length for $resource when calling InlineObject302., must be smaller than or equal to 511.');
        }
    ...
    public function setUserAgent($user_agent)
    {
        if (!is_null($user_agent) && (mb_strlen($user_agent) > 127)) {
            throw new \InvalidArgumentException('invalid length for $user_agent when calling InlineObject302., must be smaller than or equal to 127.');
        }
    ...
    public function setRefreshRate($refresh_rate)
    {
        ...
        if (!is_null($refresh_rate) && ($refresh_rate > 43200)) {
            throw new \InvalidArgumentException('invalid value for $refresh_rate when calling InlineObject302., must be smaller than or equal to 43200.');
        }
        if (!is_null($refresh_rate) && ($refresh_rate < 1)) {
            throw new \InvalidArgumentException('invalid value for $refresh_rate when calling InlineObject302., must be bigger than or equal to 1.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject302., must be smaller than or equal to 15.');
        }
