...
/**
 * InlineObject454 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject454 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_454';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject454., must be smaller than or equal to 35.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject454., must be smaller than or equal to 63.');
        }
    ...
    public function setSecondaryServer($secondary_server)
    {
        if (!is_null($secondary_server) && (mb_strlen($secondary_server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $secondary_server when calling InlineObject454., must be smaller than or equal to 63.');
        }
    ...
    public function setTertiaryServer($tertiary_server)
    {
        if (!is_null($tertiary_server) && (mb_strlen($tertiary_server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $tertiary_server when calling InlineObject454., must be smaller than or equal to 63.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject454., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject454., must be bigger than or equal to 1.');
        }
    ...
    public function setSourceIp($source_ip)
    {
        if (!is_null($source_ip) && (mb_strlen($source_ip) > 63)) {
            throw new \InvalidArgumentException('invalid length for $source_ip when calling InlineObject454., must be smaller than or equal to 63.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject454., must be smaller than or equal to 15.');
        }
