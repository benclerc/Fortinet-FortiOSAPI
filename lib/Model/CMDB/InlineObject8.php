...
class InlineObject8 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'category' => '\Fortigate\FortiOS\Model\CMDB\ApplicationGroupNameCategory[]'
    ];
     ...
     * Sets name
     *
     * @param string|null $name Application group name.
     *
     * @return self
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject8., must be smaller than or equal to 63.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject8., must be smaller than or equal to 255.');
        }
     ...
     * Sets type
     *
     * @param string|null $type Application group type.    application:Application ID.    category:Application category ID.
     *
     * @return self
     */
     ...
     * Sets application
     *
     * @param \Fortigate\FortiOS\Model\CMDB\ApplicationGroupNameApplication[]|null $application Application ID list.
     *
     * @return self
     */
    public function setApplication($application)
    {
        ...
        if (!is_null($application) && (count($application) > 0)) {
            throw new \InvalidArgumentException('invalid value for $application when calling InlineObject8., number of items must be less than or equal to 0.');
        }
     ...
     * Gets category
     *
     * @return \Fortigate\FortiOS\Model\CMDB\ApplicationGroupNameCategory[]|null
     */
     ...
     * Sets category
     *
     * @param \Fortigate\FortiOS\Model\CMDB\ApplicationGroupNameCategory[]|null $category Application category ID list.
     *
     * @return self
     */
    public function setCategory($category)
    {
        ...
        if (!is_null($category) && (count($category) > 0)) {
            throw new \InvalidArgumentException('invalid value for $category when calling InlineObject8., number of items must be less than or equal to 0.');
        }
