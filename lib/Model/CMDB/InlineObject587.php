...
/**
 * InlineObject587 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject587 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_587';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject587., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject587., must be smaller than or equal to 255.');
        }
    ...
    public function setSelectionPeriod($selection_period)
    {
        ...
        if (!is_null($selection_period) && ($selection_period > 65535)) {
            throw new \InvalidArgumentException('invalid value for $selection_period when calling InlineObject587., must be smaller than or equal to 65535.');
        }
        if (!is_null($selection_period) && ($selection_period < 0)) {
            throw new \InvalidArgumentException('invalid value for $selection_period when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setMonitorPeriod($monitor_period)
    {
        ...
        if (!is_null($monitor_period) && ($monitor_period > 65535)) {
            throw new \InvalidArgumentException('invalid value for $monitor_period when calling InlineObject587., must be smaller than or equal to 65535.');
        }
        if (!is_null($monitor_period) && ($monitor_period < 0)) {
            throw new \InvalidArgumentException('invalid value for $monitor_period when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setWeightManagedAp($weight_managed_ap)
    {
        ...
        if (!is_null($weight_managed_ap) && ($weight_managed_ap > 2000)) {
            throw new \InvalidArgumentException('invalid value for $weight_managed_ap when calling InlineObject587., must be smaller than or equal to 2000.');
        }
        if (!is_null($weight_managed_ap) && ($weight_managed_ap < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight_managed_ap when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setWeightRogueAp($weight_rogue_ap)
    {
        ...
        if (!is_null($weight_rogue_ap) && ($weight_rogue_ap > 2000)) {
            throw new \InvalidArgumentException('invalid value for $weight_rogue_ap when calling InlineObject587., must be smaller than or equal to 2000.');
        }
        if (!is_null($weight_rogue_ap) && ($weight_rogue_ap < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight_rogue_ap when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setWeightNoiseFloor($weight_noise_floor)
    {
        ...
        if (!is_null($weight_noise_floor) && ($weight_noise_floor > 2000)) {
            throw new \InvalidArgumentException('invalid value for $weight_noise_floor when calling InlineObject587., must be smaller than or equal to 2000.');
        }
        if (!is_null($weight_noise_floor) && ($weight_noise_floor < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight_noise_floor when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setWeightChannelLoad($weight_channel_load)
    {
        ...
        if (!is_null($weight_channel_load) && ($weight_channel_load > 2000)) {
            throw new \InvalidArgumentException('invalid value for $weight_channel_load when calling InlineObject587., must be smaller than or equal to 2000.');
        }
        if (!is_null($weight_channel_load) && ($weight_channel_load < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight_channel_load when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setWeightSpectralRssi($weight_spectral_rssi)
    {
        ...
        if (!is_null($weight_spectral_rssi) && ($weight_spectral_rssi > 2000)) {
            throw new \InvalidArgumentException('invalid value for $weight_spectral_rssi when calling InlineObject587., must be smaller than or equal to 2000.');
        }
        if (!is_null($weight_spectral_rssi) && ($weight_spectral_rssi < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight_spectral_rssi when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setWeightWeatherChannel($weight_weather_channel)
    {
        ...
        if (!is_null($weight_weather_channel) && ($weight_weather_channel > 2000)) {
            throw new \InvalidArgumentException('invalid value for $weight_weather_channel when calling InlineObject587., must be smaller than or equal to 2000.');
        }
        if (!is_null($weight_weather_channel) && ($weight_weather_channel < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight_weather_channel when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setWeightDfsChannel($weight_dfs_channel)
    {
        ...
        if (!is_null($weight_dfs_channel) && ($weight_dfs_channel > 2000)) {
            throw new \InvalidArgumentException('invalid value for $weight_dfs_channel when calling InlineObject587., must be smaller than or equal to 2000.');
        }
        if (!is_null($weight_dfs_channel) && ($weight_dfs_channel < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight_dfs_channel when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setThresholdAp($threshold_ap)
    {
        ...
        if (!is_null($threshold_ap) && ($threshold_ap > 500)) {
            throw new \InvalidArgumentException('invalid value for $threshold_ap when calling InlineObject587., must be smaller than or equal to 500.');
        }
        if (!is_null($threshold_ap) && ($threshold_ap < 0)) {
            throw new \InvalidArgumentException('invalid value for $threshold_ap when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setThresholdNoiseFloor($threshold_noise_floor)
    {
        if (!is_null($threshold_noise_floor) && (mb_strlen($threshold_noise_floor) > 7)) {
            throw new \InvalidArgumentException('invalid length for $threshold_noise_floor when calling InlineObject587., must be smaller than or equal to 7.');
        }
    ...
    public function setThresholdChannelLoad($threshold_channel_load)
    {
        ...
        if (!is_null($threshold_channel_load) && ($threshold_channel_load > 100)) {
            throw new \InvalidArgumentException('invalid value for $threshold_channel_load when calling InlineObject587., must be smaller than or equal to 100.');
        }
        if (!is_null($threshold_channel_load) && ($threshold_channel_load < 0)) {
            throw new \InvalidArgumentException('invalid value for $threshold_channel_load when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setThresholdSpectralRssi($threshold_spectral_rssi)
    {
        if (!is_null($threshold_spectral_rssi) && (mb_strlen($threshold_spectral_rssi) > 7)) {
            throw new \InvalidArgumentException('invalid length for $threshold_spectral_rssi when calling InlineObject587., must be smaller than or equal to 7.');
        }
    ...
    public function setThresholdTxRetries($threshold_tx_retries)
    {
        ...
        if (!is_null($threshold_tx_retries) && ($threshold_tx_retries > 1000)) {
            throw new \InvalidArgumentException('invalid value for $threshold_tx_retries when calling InlineObject587., must be smaller than or equal to 1000.');
        }
        if (!is_null($threshold_tx_retries) && ($threshold_tx_retries < 0)) {
            throw new \InvalidArgumentException('invalid value for $threshold_tx_retries when calling InlineObject587., must be bigger than or equal to 0.');
        }
    ...
    public function setThresholdRxErrors($threshold_rx_errors)
    {
        ...
        if (!is_null($threshold_rx_errors) && ($threshold_rx_errors > 100)) {
            throw new \InvalidArgumentException('invalid value for $threshold_rx_errors when calling InlineObject587., must be smaller than or equal to 100.');
        }
        if (!is_null($threshold_rx_errors) && ($threshold_rx_errors < 0)) {
            throw new \InvalidArgumentException('invalid value for $threshold_rx_errors when calling InlineObject587., must be bigger than or equal to 0.');
        }
