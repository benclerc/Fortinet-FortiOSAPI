 ...
 */
class InlineObject16 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject16., must be smaller than or equal to 35.');
        }
    ...
    public function setSrcaddr($srcaddr)
    {
        ...
        if (!is_null($srcaddr) && (count($srcaddr) > 0)) {
            throw new \InvalidArgumentException('invalid value for $srcaddr when calling InlineObject16., number of items must be less than or equal to 0.');
        }
    ...
    public function setSrcaddr6($srcaddr6)
    {
        ...
        if (!is_null($srcaddr6) && (count($srcaddr6) > 0)) {
            throw new \InvalidArgumentException('invalid value for $srcaddr6 when calling InlineObject16., number of items must be less than or equal to 0.');
        }
    ...
    public function setActiveAuthMethod($active_auth_method)
    {
        if (!is_null($active_auth_method) && (mb_strlen($active_auth_method) > 35)) {
            throw new \InvalidArgumentException('invalid length for $active_auth_method when calling InlineObject16., must be smaller than or equal to 35.');
        }
    ...
    public function setSsoAuthMethod($sso_auth_method)
    {
        if (!is_null($sso_auth_method) && (mb_strlen($sso_auth_method) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sso_auth_method when calling InlineObject16., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject16., must be smaller than or equal to 1023.');
        }
