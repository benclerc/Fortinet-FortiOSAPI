...
/**
 * InlineObject440 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject440 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_440';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject440., must be smaller than or equal to 35.');
        }
    ...
    public function setCa($ca)
    {
        if (!is_null($ca) && (mb_strlen($ca) > 127)) {
            throw new \InvalidArgumentException('invalid length for $ca when calling InlineObject440., must be smaller than or equal to 127.');
        }
    ...
    public function setSubject($subject)
    {
        if (!is_null($subject) && (mb_strlen($subject) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling InlineObject440., must be smaller than or equal to 255.');
        }
    ...
    public function setCn($cn)
    {
        if (!is_null($cn) && (mb_strlen($cn) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cn when calling InlineObject440., must be smaller than or equal to 255.');
        }
    ...
    public function setLdapServer($ldap_server)
    {
        if (!is_null($ldap_server) && (mb_strlen($ldap_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ldap_server when calling InlineObject440., must be smaller than or equal to 35.');
        }
    ...
    public function setLdapUsername($ldap_username)
    {
        if (!is_null($ldap_username) && (mb_strlen($ldap_username) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ldap_username when calling InlineObject440., must be smaller than or equal to 35.');
        }
    ...
    public function setOcspOverrideServer($ocsp_override_server)
    {
        if (!is_null($ocsp_override_server) && (mb_strlen($ocsp_override_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ocsp_override_server when calling InlineObject440., must be smaller than or equal to 35.');
        }
