 ...
 */
class InlineObject76 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject76., must be smaller than or equal to 63.');
        }
    ...
    public function setGroup($group)
    {
        if (!is_null($group) && (mb_strlen($group) > 63)) {
            throw new \InvalidArgumentException('invalid length for $group when calling InlineObject76., must be smaller than or equal to 63.');
        }
    ...
    public function setRuleId($rule_id)
    {
        ...
        if (!is_null($rule_id) && ($rule_id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling InlineObject76., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($rule_id) && ($rule_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling InlineObject76., must be bigger than or equal to 0.');
        }
    ...
    public function setRev($rev)
    {
        ...
        if (!is_null($rev) && ($rev > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $rev when calling InlineObject76., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($rev) && ($rev < 0)) {
            throw new \InvalidArgumentException('invalid value for $rev when calling InlineObject76., must be bigger than or equal to 0.');
        }
    ...
    public function setDate($date)
    {
        ...
        if (!is_null($date) && ($date > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $date when calling InlineObject76., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($date) && ($date < 0)) {
            throw new \InvalidArgumentException('invalid value for $date when calling InlineObject76., must be bigger than or equal to 0.');
        }
    ...
    public function setMetadata($metadata)
    {
        ...
        if (!is_null($metadata) && (count($metadata) > 0)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling InlineObject76., number of items must be less than or equal to 0.');
        }
