...
/**
 * InlineObject200 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_200';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject200., must be smaller than or equal to 63.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 63)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject200., must be smaller than or equal to 63.');
        }
    ...
    public function setFortilink($fortilink)
    {
        if (!is_null($fortilink) && (mb_strlen($fortilink) > 15)) {
            throw new \InvalidArgumentException('invalid length for $fortilink when calling InlineObject200., must be smaller than or equal to 15.');
        }
    ...
    public function setVlan($vlan)
    {
        if (!is_null($vlan) && (mb_strlen($vlan) > 15)) {
            throw new \InvalidArgumentException('invalid length for $vlan when calling InlineObject200., must be smaller than or equal to 15.');
        }
    ...
    public function setTrafficPolicy($traffic_policy)
    {
        if (!is_null($traffic_policy) && (mb_strlen($traffic_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $traffic_policy when calling InlineObject200., must be smaller than or equal to 63.');
        }
