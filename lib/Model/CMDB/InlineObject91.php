 ...
 */
class InlineObject91 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setFilter($filter)
    {
        if (!is_null($filter) && (mb_strlen($filter) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $filter when calling InlineObject91., must be smaller than or equal to 1023.');
        }
