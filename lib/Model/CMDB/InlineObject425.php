...
/**
 * InlineObject425 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject425 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_425';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject425., must be smaller than or equal to 35.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject425., must be smaller than or equal to 63.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject425., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject425., must be bigger than or equal to 1.');
        }
    ...
    public function setServer2($server2)
    {
        if (!is_null($server2) && (mb_strlen($server2) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server2 when calling InlineObject425., must be smaller than or equal to 63.');
        }
    ...
    public function setPort2($port2)
    {
        ...
        if (!is_null($port2) && ($port2 > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port2 when calling InlineObject425., must be smaller than or equal to 65535.');
        }
        if (!is_null($port2) && ($port2 < 1)) {
            throw new \InvalidArgumentException('invalid value for $port2 when calling InlineObject425., must be bigger than or equal to 1.');
        }
    ...
    public function setServer3($server3)
    {
        if (!is_null($server3) && (mb_strlen($server3) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server3 when calling InlineObject425., must be smaller than or equal to 63.');
        }
    ...
    public function setPort3($port3)
    {
        ...
        if (!is_null($port3) && ($port3 > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port3 when calling InlineObject425., must be smaller than or equal to 65535.');
        }
        if (!is_null($port3) && ($port3 < 1)) {
            throw new \InvalidArgumentException('invalid value for $port3 when calling InlineObject425., must be bigger than or equal to 1.');
        }
    ...
    public function setServer4($server4)
    {
        if (!is_null($server4) && (mb_strlen($server4) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server4 when calling InlineObject425., must be smaller than or equal to 63.');
        }
    ...
    public function setPort4($port4)
    {
        ...
        if (!is_null($port4) && ($port4 > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port4 when calling InlineObject425., must be smaller than or equal to 65535.');
        }
        if (!is_null($port4) && ($port4 < 1)) {
            throw new \InvalidArgumentException('invalid value for $port4 when calling InlineObject425., must be bigger than or equal to 1.');
        }
    ...
    public function setServer5($server5)
    {
        if (!is_null($server5) && (mb_strlen($server5) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server5 when calling InlineObject425., must be smaller than or equal to 63.');
        }
    ...
    public function setPort5($port5)
    {
        ...
        if (!is_null($port5) && ($port5 > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port5 when calling InlineObject425., must be smaller than or equal to 65535.');
        }
        if (!is_null($port5) && ($port5 < 1)) {
            throw new \InvalidArgumentException('invalid value for $port5 when calling InlineObject425., must be bigger than or equal to 1.');
        }
    ...
    public function setLdapServer($ldap_server)
    {
        if (!is_null($ldap_server) && (mb_strlen($ldap_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ldap_server when calling InlineObject425., must be smaller than or equal to 35.');
        }
    ...
    public function setGroupPollInterval($group_poll_interval)
    {
        ...
        if (!is_null($group_poll_interval) && ($group_poll_interval > 2880)) {
            throw new \InvalidArgumentException('invalid value for $group_poll_interval when calling InlineObject425., must be smaller than or equal to 2880.');
        }
        if (!is_null($group_poll_interval) && ($group_poll_interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $group_poll_interval when calling InlineObject425., must be bigger than or equal to 1.');
        }
    ...
    public function setLdapPollInterval($ldap_poll_interval)
    {
        ...
        if (!is_null($ldap_poll_interval) && ($ldap_poll_interval > 2880)) {
            throw new \InvalidArgumentException('invalid value for $ldap_poll_interval when calling InlineObject425., must be smaller than or equal to 2880.');
        }
        if (!is_null($ldap_poll_interval) && ($ldap_poll_interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $ldap_poll_interval when calling InlineObject425., must be bigger than or equal to 1.');
        }
    ...
    public function setLdapPollFilter($ldap_poll_filter)
    {
        if (!is_null($ldap_poll_filter) && (mb_strlen($ldap_poll_filter) > 2047)) {
            throw new \InvalidArgumentException('invalid length for $ldap_poll_filter when calling InlineObject425., must be smaller than or equal to 2047.');
        }
    ...
    public function setUserInfoServer($user_info_server)
    {
        if (!is_null($user_info_server) && (mb_strlen($user_info_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $user_info_server when calling InlineObject425., must be smaller than or equal to 35.');
        }
    ...
    public function setSslTrustedCert($ssl_trusted_cert)
    {
        if (!is_null($ssl_trusted_cert) && (mb_strlen($ssl_trusted_cert) > 79)) {
            throw new \InvalidArgumentException('invalid length for $ssl_trusted_cert when calling InlineObject425., must be smaller than or equal to 79.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject425., must be smaller than or equal to 15.');
        }
