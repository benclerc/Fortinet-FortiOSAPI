...
/**
 * InlineObject416 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject416 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_416';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 511)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject416., must be smaller than or equal to 511.');
        }
    ...
    public function setServerName($server_name)
    {
        if (!is_null($server_name) && (mb_strlen($server_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $server_name when calling InlineObject416., must be smaller than or equal to 35.');
        }
    ...
    public function setConnectorSource($connector_source)
    {
        if (!is_null($connector_source) && (mb_strlen($connector_source) > 35)) {
            throw new \InvalidArgumentException('invalid length for $connector_source when calling InlineObject416., must be smaller than or equal to 35.');
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject416., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject416., must be bigger than or equal to 0.');
        }
