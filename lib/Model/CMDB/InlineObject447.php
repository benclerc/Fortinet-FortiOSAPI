...
/**
 * InlineObject447 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject447 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_447';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject447., must be smaller than or equal to 35.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject447., must be smaller than or equal to 63.');
        }
    ...
    public function setSecondaryServer($secondary_server)
    {
        if (!is_null($secondary_server) && (mb_strlen($secondary_server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $secondary_server when calling InlineObject447., must be smaller than or equal to 63.');
        }
    ...
    public function setTertiaryServer($tertiary_server)
    {
        if (!is_null($tertiary_server) && (mb_strlen($tertiary_server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $tertiary_server when calling InlineObject447., must be smaller than or equal to 63.');
        }
    ...
    public function setTimeout($timeout)
    {
        ...
        if (!is_null($timeout) && ($timeout > 300)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling InlineObject447., must be smaller than or equal to 300.');
        }
        if (!is_null($timeout) && ($timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling InlineObject447., must be bigger than or equal to 1.');
        }
    ...
    public function setAcctInterimInterval($acct_interim_interval)
    {
        ...
        if (!is_null($acct_interim_interval) && ($acct_interim_interval > 86400)) {
            throw new \InvalidArgumentException('invalid value for $acct_interim_interval when calling InlineObject447., must be smaller than or equal to 86400.');
        }
        if (!is_null($acct_interim_interval) && ($acct_interim_interval < 60)) {
            throw new \InvalidArgumentException('invalid value for $acct_interim_interval when calling InlineObject447., must be bigger than or equal to 60.');
        }
    ...
    public function setRadiusPort($radius_port)
    {
        ...
        if (!is_null($radius_port) && ($radius_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $radius_port when calling InlineObject447., must be smaller than or equal to 65535.');
        }
        if (!is_null($radius_port) && ($radius_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $radius_port when calling InlineObject447., must be bigger than or equal to 0.');
        }
    ...
    public function setSourceIp($source_ip)
    {
        if (!is_null($source_ip) && (mb_strlen($source_ip) > 63)) {
            throw new \InvalidArgumentException('invalid length for $source_ip when calling InlineObject447., must be smaller than or equal to 63.');
        }
    ...
    public function setClass($class)
    {
        ...
        if (!is_null($class) && (count($class) > 0)) {
            throw new \InvalidArgumentException('invalid value for $class when calling InlineObject447., number of items must be less than or equal to 0.');
        }
    ...
    public function setSwitchControllerAcctFastFramedipDetect($switch_controller_acct_fast_framedip_detect)
    {
        ...
        if (!is_null($switch_controller_acct_fast_framedip_detect) && ($switch_controller_acct_fast_framedip_detect > 600)) {
            throw new \InvalidArgumentException('invalid value for $switch_controller_acct_fast_framedip_detect when calling InlineObject447., must be smaller than or equal to 600.');
        }
        if (!is_null($switch_controller_acct_fast_framedip_detect) && ($switch_controller_acct_fast_framedip_detect < 2)) {
            throw new \InvalidArgumentException('invalid value for $switch_controller_acct_fast_framedip_detect when calling InlineObject447., must be bigger than or equal to 2.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject447., must be smaller than or equal to 15.');
        }
    ...
    public function setRssoRadiusServerPort($rsso_radius_server_port)
    {
        ...
        if (!is_null($rsso_radius_server_port) && ($rsso_radius_server_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $rsso_radius_server_port when calling InlineObject447., must be smaller than or equal to 65535.');
        }
        if (!is_null($rsso_radius_server_port) && ($rsso_radius_server_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $rsso_radius_server_port when calling InlineObject447., must be bigger than or equal to 0.');
        }
    ...
    public function setSsoAttributeKey($sso_attribute_key)
    {
        if (!is_null($sso_attribute_key) && (mb_strlen($sso_attribute_key) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sso_attribute_key when calling InlineObject447., must be smaller than or equal to 35.');
        }
    ...
    public function setRssoContextTimeout($rsso_context_timeout)
    {
        ...
        if (!is_null($rsso_context_timeout) && ($rsso_context_timeout > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $rsso_context_timeout when calling InlineObject447., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($rsso_context_timeout) && ($rsso_context_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $rsso_context_timeout when calling InlineObject447., must be bigger than or equal to 0.');
        }
    ...
    public function setRssoLogPeriod($rsso_log_period)
    {
        ...
        if (!is_null($rsso_log_period) && ($rsso_log_period > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $rsso_log_period when calling InlineObject447., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($rsso_log_period) && ($rsso_log_period < 0)) {
            throw new \InvalidArgumentException('invalid value for $rsso_log_period when calling InlineObject447., must be bigger than or equal to 0.');
        }
    ...
    public function setAccountingServer($accounting_server)
    {
        ...
        if (!is_null($accounting_server) && (count($accounting_server) > 4)) {
            throw new \InvalidArgumentException('invalid value for $accounting_server when calling InlineObject447., number of items must be less than or equal to 4.');
        }
