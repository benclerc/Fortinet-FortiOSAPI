 ...
 */
class InlineObject171 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSeqNum($seq_num)
    {
        ...
        if (!is_null($seq_num) && ($seq_num > 65535)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject171., must be smaller than or equal to 65535.');
        }
        if (!is_null($seq_num) && ($seq_num < 1)) {
            throw new \InvalidArgumentException('invalid value for $seq_num when calling InlineObject171., must be bigger than or equal to 1.');
        }
    ...
    public function setInputDevice($input_device)
    {
        ...
        if (!is_null($input_device) && (count($input_device) > 0)) {
            throw new \InvalidArgumentException('invalid value for $input_device when calling InlineObject171., number of items must be less than or equal to 0.');
        }
    ...
    public function setProtocol($protocol)
    {
        ...
        if (!is_null($protocol) && ($protocol > 255)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject171., must be smaller than or equal to 255.');
        }
        if (!is_null($protocol) && ($protocol < 0)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject171., must be bigger than or equal to 0.');
        }
    ...
    public function setStartPort($start_port)
    {
        ...
        if (!is_null($start_port) && ($start_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $start_port when calling InlineObject171., must be smaller than or equal to 65535.');
        }
        if (!is_null($start_port) && ($start_port < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_port when calling InlineObject171., must be bigger than or equal to 1.');
        }
    ...
    public function setEndPort($end_port)
    {
        ...
        if (!is_null($end_port) && ($end_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $end_port when calling InlineObject171., must be smaller than or equal to 65535.');
        }
        if (!is_null($end_port) && ($end_port < 1)) {
            throw new \InvalidArgumentException('invalid value for $end_port when calling InlineObject171., must be bigger than or equal to 1.');
        }
    ...
    public function setOutputDevice($output_device)
    {
        if (!is_null($output_device) && (mb_strlen($output_device) > 35)) {
            throw new \InvalidArgumentException('invalid length for $output_device when calling InlineObject171., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject171., must be smaller than or equal to 255.');
        }
