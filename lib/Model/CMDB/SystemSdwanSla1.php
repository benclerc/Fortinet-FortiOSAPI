...
/**
 * SystemSdwanSla1 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class SystemSdwanSla1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_system_sdwan_sla_1';
     ...
     * Sets health_check
     *
     * @param string|null $health_check SD-WAN health-check.
     *
     * @return self
     */
    public function setHealthCheck($health_check)
    {
        if (!is_null($health_check) && (mb_strlen($health_check) > 35)) {
            throw new \InvalidArgumentException('invalid length for $health_check when calling SystemSdwanSla1., must be smaller than or equal to 35.');
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling SystemSdwanSla1., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling SystemSdwanSla1., must be bigger than or equal to 0.');
        }
