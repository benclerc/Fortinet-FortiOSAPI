...
/**
 * ReportChartNameCategorySeries Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class ReportChartNameCategorySeries implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_report_chart__name__category_series';
     ...
     * Sets databind
     *
     * @param string|null $databind Category series value expression.
     *
     * @return self
     */
    public function setDatabind($databind)
    {
        if (!is_null($databind) && (mb_strlen($databind) > 127)) {
            throw new \InvalidArgumentException('invalid length for $databind when calling ReportChartNameCategorySeries., must be smaller than or equal to 127.');
        }
     ...
     * Sets font_size
     *
     * @param int|null $font_size Font size of category-series title.
     *
     * @return self
     */
    public function setFontSize($font_size)
    {
        ...
        if (!is_null($font_size) && ($font_size > 20)) {
            throw new \InvalidArgumentException('invalid value for $font_size when calling ReportChartNameCategorySeries., must be smaller than or equal to 20.');
        }
        if (!is_null($font_size) && ($font_size < 5)) {
            throw new \InvalidArgumentException('invalid value for $font_size when calling ReportChartNameCategorySeries., must be bigger than or equal to 5.');
        }
