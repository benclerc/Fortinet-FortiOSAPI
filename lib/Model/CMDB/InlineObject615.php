...
/**
 * InlineObject615 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject615 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_615';
    ...
    public function setWtpId($wtp_id)
    {
        if (!is_null($wtp_id) && (mb_strlen($wtp_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $wtp_id when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setIndex($index)
    {
        ...
        if (!is_null($index) && ($index > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $index when calling InlineObject615., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($index) && ($index < 0)) {
            throw new \InvalidArgumentException('invalid value for $index when calling InlineObject615., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setLocation($location)
    {
        if (!is_null($location) && (mb_strlen($location) > 35)) {
            throw new \InvalidArgumentException('invalid length for $location when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setRegion($region)
    {
        if (!is_null($region) && (mb_strlen($region) > 35)) {
            throw new \InvalidArgumentException('invalid length for $region when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setRegionX($region_x)
    {
        if (!is_null($region_x) && (mb_strlen($region_x) > 15)) {
            throw new \InvalidArgumentException('invalid length for $region_x when calling InlineObject615., must be smaller than or equal to 15.');
        }
    ...
    public function setRegionY($region_y)
    {
        if (!is_null($region_y) && (mb_strlen($region_y) > 15)) {
            throw new \InvalidArgumentException('invalid length for $region_y when calling InlineObject615., must be smaller than or equal to 15.');
        }
    ...
    public function setFirmwareProvision($firmware_provision)
    {
        if (!is_null($firmware_provision) && (mb_strlen($firmware_provision) > 35)) {
            throw new \InvalidArgumentException('invalid length for $firmware_provision when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setWtpProfile($wtp_profile)
    {
        if (!is_null($wtp_profile) && (mb_strlen($wtp_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $wtp_profile when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setApcfgProfile($apcfg_profile)
    {
        if (!is_null($apcfg_profile) && (mb_strlen($apcfg_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $apcfg_profile when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setBonjourProfile($bonjour_profile)
    {
        if (!is_null($bonjour_profile) && (mb_strlen($bonjour_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $bonjour_profile when calling InlineObject615., must be smaller than or equal to 35.');
        }
    ...
    public function setTunMtuUplink($tun_mtu_uplink)
    {
        ...
        if (!is_null($tun_mtu_uplink) && ($tun_mtu_uplink > 1500)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_uplink when calling InlineObject615., must be smaller than or equal to 1500.');
        }
        if (!is_null($tun_mtu_uplink) && ($tun_mtu_uplink < 576)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_uplink when calling InlineObject615., must be bigger than or equal to 576.');
        }
    ...
    public function setTunMtuDownlink($tun_mtu_downlink)
    {
        ...
        if (!is_null($tun_mtu_downlink) && ($tun_mtu_downlink > 1500)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_downlink when calling InlineObject615., must be smaller than or equal to 1500.');
        }
        if (!is_null($tun_mtu_downlink) && ($tun_mtu_downlink < 576)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_downlink when calling InlineObject615., must be bigger than or equal to 576.');
        }
    ...
    public function setSplitTunnelingAcl($split_tunneling_acl)
    {
        ...
        if (!is_null($split_tunneling_acl) && (count($split_tunneling_acl) > 16)) {
            throw new \InvalidArgumentException('invalid value for $split_tunneling_acl when calling InlineObject615., number of items must be less than or equal to 16.');
        }
    ...
    public function setLan($lan)
    {
        ...
        if (!is_null($lan) && (count($lan) > 0)) {
            throw new \InvalidArgumentException('invalid value for $lan when calling InlineObject615., number of items must be less than or equal to 0.');
        }
    ...
    public function setRadio1($radio_1)
    {
        ...
        if (!is_null($radio_1) && (count($radio_1) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_1 when calling InlineObject615., number of items must be less than or equal to 0.');
        }
    ...
    public function setRadio2($radio_2)
    {
        ...
        if (!is_null($radio_2) && (count($radio_2) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_2 when calling InlineObject615., number of items must be less than or equal to 0.');
        }
    ...
    public function setRadio3($radio_3)
    {
        ...
        if (!is_null($radio_3) && (count($radio_3) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_3 when calling InlineObject615., number of items must be less than or equal to 0.');
        }
    ...
    public function setRadio4($radio_4)
    {
        ...
        if (!is_null($radio_4) && (count($radio_4) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_4 when calling InlineObject615., number of items must be less than or equal to 0.');
        }
    ...
    public function setCoordinateLatitude($coordinate_latitude)
    {
        if (!is_null($coordinate_latitude) && (mb_strlen($coordinate_latitude) > 19)) {
            throw new \InvalidArgumentException('invalid length for $coordinate_latitude when calling InlineObject615., must be smaller than or equal to 19.');
        }
    ...
    public function setCoordinateLongitude($coordinate_longitude)
    {
        if (!is_null($coordinate_longitude) && (mb_strlen($coordinate_longitude) > 19)) {
            throw new \InvalidArgumentException('invalid length for $coordinate_longitude when calling InlineObject615., must be smaller than or equal to 19.');
        }
