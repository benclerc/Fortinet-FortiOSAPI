<?php
/**
 * WirelessControllerWtpWtpIdRadio4
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * WirelessControllerWtpWtpIdRadio4 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class WirelessControllerWtpWtpIdRadio4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_wireless_controller_wtp__wtp_id__radio_4';
     ...
     * Sets band
     *
     * @param string|null $band WiFi band that Radio 4 operates on.    802.11a:802.11a.    802.11b:802.11b.    802.11g:802.11g/b.    802.11n:802.11n/g/b at 2.4GHz.    802.11n-5G:802.11n/a at 5GHz.    802.11ac:802.11ac/n/a.    802.11ax-5G:802.11ax/ac/n/a at 5GHz.    802.11ax:802.11ax/n/g/b at 2.4GHz.    802.11ac-2G:802.11ac at 2.4GHz.    802.11n,g-only:802.11n/g at 2.4GHz.    802.11g-only:802.11g.    802.11n-only:802.11n at 2.4GHz.    802.11n-5G-only:802.11n at 5GHz.    802.11ac,n-only:802.11ac/n.    802.11ac-only:802.11ac.    802.11ax,ac-only:802.11ax/ac at 5GHz.    802.11ax,ac,n-only:802.11ax/ac/n at 5GHz.    802.11ax-5G-only:802.11ax at 5GHz.    802.11ax,n-only:802.11ax/n at 2.4GHz.    802.11ax,n,g-only:802.11ax/n/g at 2.4GHz.    802.11ax-only:802.11ax at 2.4GHz.
     *
     * @return self
     */
    ...
    public function setAutoPowerHigh($auto_power_high)
    {
        ...
        if (!is_null($auto_power_high) && ($auto_power_high > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_high when calling WirelessControllerWtpWtpIdRadio4., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_power_high) && ($auto_power_high < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_high when calling WirelessControllerWtpWtpIdRadio4., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoPowerLow($auto_power_low)
    {
        ...
        if (!is_null($auto_power_low) && ($auto_power_low > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_low when calling WirelessControllerWtpWtpIdRadio4., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_power_low) && ($auto_power_low < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_low when calling WirelessControllerWtpWtpIdRadio4., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoPowerTarget($auto_power_target)
    {
        if (!is_null($auto_power_target) && (mb_strlen($auto_power_target) > 7)) {
            throw new \InvalidArgumentException('invalid length for $auto_power_target when calling WirelessControllerWtpWtpIdRadio4., must be smaller than or equal to 7.');
        }
    ...
    public function setPowerLevel($power_level)
    {
        ...
        if (!is_null($power_level) && ($power_level > 100)) {
            throw new \InvalidArgumentException('invalid value for $power_level when calling WirelessControllerWtpWtpIdRadio4., must be smaller than or equal to 100.');
        }
        if (!is_null($power_level) && ($power_level < 0)) {
            throw new \InvalidArgumentException('invalid value for $power_level when calling WirelessControllerWtpWtpIdRadio4., must be bigger than or equal to 0.');
        }
    ...
    public function setVaps($vaps)
    {
        ...
        if (!is_null($vaps) && (count($vaps) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vaps when calling WirelessControllerWtpWtpIdRadio4., number of items must be less than or equal to 0.');
        }
    ...
    public function setChannel($channel)
    {
        ...
        if (!is_null($channel) && (count($channel) > 0)) {
            throw new \InvalidArgumentException('invalid value for $channel when calling WirelessControllerWtpWtpIdRadio4., number of items must be less than or equal to 0.');
        }
