...
class InlineObject123 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 127)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject123., must be smaller than or equal to 127.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject123., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject123., must be bigger than or equal to 0.');
        }
    ...
    public function setSourceIp($source_ip)
    {
        if (!is_null($source_ip) && (mb_strlen($source_ip) > 63)) {
            throw new \InvalidArgumentException('invalid length for $source_ip when calling InlineObject123., must be smaller than or equal to 63.');
        }
    ...
    public function setMaxLogRate($max_log_rate)
    {
        ...
        if (!is_null($max_log_rate) && ($max_log_rate > 100000)) {
            throw new \InvalidArgumentException('invalid value for $max_log_rate when calling InlineObject123., must be smaller than or equal to 100000.');
        }
        if (!is_null($max_log_rate) && ($max_log_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_log_rate when calling InlineObject123., must be bigger than or equal to 0.');
        }
    ...
    public function setCertificate($certificate)
    {
        if (!is_null($certificate) && (mb_strlen($certificate) > 35)) {
            throw new \InvalidArgumentException('invalid length for $certificate when calling InlineObject123., must be smaller than or equal to 35.');
        }
    ...
    public function setCustomFieldName($custom_field_name)
    {
        ...
        if (!is_null($custom_field_name) && (count($custom_field_name) > 0)) {
            throw new \InvalidArgumentException('invalid value for $custom_field_name when calling InlineObject123., number of items must be less than or equal to 0.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject123., must be smaller than or equal to 15.');
        }
