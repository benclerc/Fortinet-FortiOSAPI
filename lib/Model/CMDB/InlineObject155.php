 ...
 */
class InlineObject155 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'neighbor' => '\Fortigate\FortiOS\Model\CMDB\RouterBfdNeighbor[]'
    ];
     ...
     * Gets neighbor
     *
     * @return \Fortigate\FortiOS\Model\CMDB\RouterBfdNeighbor[]|null
     */
     ...
     * Sets neighbor
     *
     * @param \Fortigate\FortiOS\Model\CMDB\RouterBfdNeighbor[]|null $neighbor neighbor
     *
     * @return self
     */
    public function setNeighbor($neighbor)
    {
        ...
        if (!is_null($neighbor) && (count($neighbor) > 0)) {
            throw new \InvalidArgumentException('invalid value for $neighbor when calling InlineObject155., number of items must be less than or equal to 0.');
        }
