...
/**
 * InlineObject413 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject413 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_413';
    ...
    public function setServiceId($service_id)
    {
        if (!is_null($service_id) && (mb_strlen($service_id) > 3)) {
            throw new \InvalidArgumentException('invalid length for $service_id when calling InlineObject413., must be smaller than or equal to 3.');
        }
    ...
    public function setPriority($priority)
    {
        ...
        if (!is_null($priority) && ($priority > 255)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject413., must be smaller than or equal to 255.');
        }
        if (!is_null($priority) && ($priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling InlineObject413., must be bigger than or equal to 0.');
        }
    ...
    public function setProtocol($protocol)
    {
        ...
        if (!is_null($protocol) && ($protocol > 255)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject413., must be smaller than or equal to 255.');
        }
        if (!is_null($protocol) && ($protocol < 0)) {
            throw new \InvalidArgumentException('invalid value for $protocol when calling InlineObject413., must be bigger than or equal to 0.');
        }
    ...
    public function setAssignmentWeight($assignment_weight)
    {
        ...
        if (!is_null($assignment_weight) && ($assignment_weight > 255)) {
            throw new \InvalidArgumentException('invalid value for $assignment_weight when calling InlineObject413., must be smaller than or equal to 255.');
        }
        if (!is_null($assignment_weight) && ($assignment_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $assignment_weight when calling InlineObject413., must be bigger than or equal to 0.');
        }
