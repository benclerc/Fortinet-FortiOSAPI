...
/**
 * InlineObject548 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject548 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_548';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject548., must be smaller than or equal to 35.');
        }
    ...
    public function setHostname($hostname)
    {
        if (!is_null($hostname) && (mb_strlen($hostname) > 127)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling InlineObject548., must be smaller than or equal to 127.');
        }
    ...
    public function setUrl($url)
    {
        if (!is_null($url) && (mb_strlen($url) > 127)) {
            throw new \InvalidArgumentException('invalid length for $url when calling InlineObject548., must be smaller than or equal to 127.');
        }
    ...
    public function setQuery($query)
    {
        if (!is_null($query) && (mb_strlen($query) > 15)) {
            throw new \InvalidArgumentException('invalid length for $query when calling InlineObject548., must be smaller than or equal to 15.');
        }
    ...
    public function setSafesearchStr($safesearch_str)
    {
        if (!is_null($safesearch_str) && (mb_strlen($safesearch_str) > 79)) {
            throw new \InvalidArgumentException('invalid length for $safesearch_str when calling InlineObject548., must be smaller than or equal to 79.');
        }
