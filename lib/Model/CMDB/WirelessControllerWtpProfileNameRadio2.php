<?php
/**
 * WirelessControllerWtpProfileNameRadio2
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * WirelessControllerWtpProfileNameRadio2 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class WirelessControllerWtpProfileNameRadio2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_wireless_controller_wtp_profile__name__radio_2';
    ...
    public function setBssColor($bss_color)
    {
        ...
        if (!is_null($bss_color) && ($bss_color > 63)) {
            throw new \InvalidArgumentException('invalid value for $bss_color when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 63.');
        }
        if (!is_null($bss_color) && ($bss_color < 0)) {
            throw new \InvalidArgumentException('invalid value for $bss_color when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoPowerHigh($auto_power_high)
    {
        ...
        if (!is_null($auto_power_high) && ($auto_power_high > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_high when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_power_high) && ($auto_power_high < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_high when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoPowerLow($auto_power_low)
    {
        ...
        if (!is_null($auto_power_low) && ($auto_power_low > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_low when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_power_low) && ($auto_power_low < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_power_low when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoPowerTarget($auto_power_target)
    {
        if (!is_null($auto_power_target) && (mb_strlen($auto_power_target) > 7)) {
            throw new \InvalidArgumentException('invalid length for $auto_power_target when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 7.');
        }
    ...
    public function setPowerLevel($power_level)
    {
        ...
        if (!is_null($power_level) && ($power_level > 100)) {
            throw new \InvalidArgumentException('invalid value for $power_level when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 100.');
        }
        if (!is_null($power_level) && ($power_level < 0)) {
            throw new \InvalidArgumentException('invalid value for $power_level when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setDtim($dtim)
    {
        ...
        if (!is_null($dtim) && ($dtim > 255)) {
            throw new \InvalidArgumentException('invalid value for $dtim when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 255.');
        }
        if (!is_null($dtim) && ($dtim < 1)) {
            throw new \InvalidArgumentException('invalid value for $dtim when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 1.');
        }
    ...
    public function setBeaconInterval($beacon_interval)
    {
        ...
        if (!is_null($beacon_interval) && ($beacon_interval > 65535)) {
            throw new \InvalidArgumentException('invalid value for $beacon_interval when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 65535.');
        }
        if (!is_null($beacon_interval) && ($beacon_interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $beacon_interval when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setRtsThreshold($rts_threshold)
    {
        ...
        if (!is_null($rts_threshold) && ($rts_threshold > 2346)) {
            throw new \InvalidArgumentException('invalid value for $rts_threshold when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 2346.');
        }
        if (!is_null($rts_threshold) && ($rts_threshold < 256)) {
            throw new \InvalidArgumentException('invalid value for $rts_threshold when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 256.');
        }
    ...
    public function setFragThreshold($frag_threshold)
    {
        ...
        if (!is_null($frag_threshold) && ($frag_threshold > 2346)) {
            throw new \InvalidArgumentException('invalid value for $frag_threshold when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 2346.');
        }
        if (!is_null($frag_threshold) && ($frag_threshold < 800)) {
            throw new \InvalidArgumentException('invalid value for $frag_threshold when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 800.');
        }
    ...
    public function setApSnifferBufsize($ap_sniffer_bufsize)
    {
        ...
        if (!is_null($ap_sniffer_bufsize) && ($ap_sniffer_bufsize > 32)) {
            throw new \InvalidArgumentException('invalid value for $ap_sniffer_bufsize when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 32.');
        }
        if (!is_null($ap_sniffer_bufsize) && ($ap_sniffer_bufsize < 1)) {
            throw new \InvalidArgumentException('invalid value for $ap_sniffer_bufsize when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 1.');
        }
    ...
    public function setApSnifferChan($ap_sniffer_chan)
    {
        ...
        if (!is_null($ap_sniffer_chan) && ($ap_sniffer_chan > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $ap_sniffer_chan when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($ap_sniffer_chan) && ($ap_sniffer_chan < 0)) {
            throw new \InvalidArgumentException('invalid value for $ap_sniffer_chan when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setWidsProfile($wids_profile)
    {
        if (!is_null($wids_profile) && (mb_strlen($wids_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $wids_profile when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 35.');
        }
    ...
    public function setMaxClients($max_clients)
    {
        ...
        if (!is_null($max_clients) && ($max_clients > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $max_clients when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($max_clients) && ($max_clients < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_clients when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxDistance($max_distance)
    {
        ...
        if (!is_null($max_distance) && ($max_distance > 54000)) {
            throw new \InvalidArgumentException('invalid value for $max_distance when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 54000.');
        }
        if (!is_null($max_distance) && ($max_distance < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_distance when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setVaps($vaps)
    {
        ...
        if (!is_null($vaps) && (count($vaps) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vaps when calling WirelessControllerWtpProfileNameRadio2., number of items must be less than or equal to 0.');
        }
    ...
    public function setChannel($channel)
    {
        ...
        if (!is_null($channel) && (count($channel) > 0)) {
            throw new \InvalidArgumentException('invalid value for $channel when calling WirelessControllerWtpProfileNameRadio2., number of items must be less than or equal to 0.');
        }
    ...
    public function setCallCapacity($call_capacity)
    {
        ...
        if (!is_null($call_capacity) && ($call_capacity > 60)) {
            throw new \InvalidArgumentException('invalid value for $call_capacity when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 60.');
        }
        if (!is_null($call_capacity) && ($call_capacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $call_capacity when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 0.');
        }
    ...
    public function setBandwidthCapacity($bandwidth_capacity)
    {
        ...
        if (!is_null($bandwidth_capacity) && ($bandwidth_capacity > 600000)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth_capacity when calling WirelessControllerWtpProfileNameRadio2., must be smaller than or equal to 600000.');
        }
        if (!is_null($bandwidth_capacity) && ($bandwidth_capacity < 1)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth_capacity when calling WirelessControllerWtpProfileNameRadio2., must be bigger than or equal to 1.');
        }
