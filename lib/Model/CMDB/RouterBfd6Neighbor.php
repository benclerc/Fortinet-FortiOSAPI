...
/**
 * RouterBfd6Neighbor Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class RouterBfd6Neighbor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_router_bfd6_neighbor';
     ...
     * Sets ip6_address
     *
     * @param string|null $ip6_address IPv6 address of the BFD neighbor.
     *
     * @return self
     */
     ...
     * Sets interface
     *
     * @param string|null $interface Interface to the BFD neighbor.
     *
     * @return self
     */
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling RouterBfd6Neighbor., must be smaller than or equal to 15.');
        }
