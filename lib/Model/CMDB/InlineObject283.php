...
/**
 * InlineObject283 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject283 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_283';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject283., must be smaller than or equal to 35.');
        }
    ...
    public function setLogid($logid)
    {
        ...
        if (!is_null($logid) && ($logid > 65535)) {
            throw new \InvalidArgumentException('invalid value for $logid when calling InlineObject283., must be smaller than or equal to 65535.');
        }
        if (!is_null($logid) && ($logid < 1)) {
            throw new \InvalidArgumentException('invalid value for $logid when calling InlineObject283., must be bigger than or equal to 1.');
        }
    ...
    public function setTriggerDay($trigger_day)
    {
        ...
        if (!is_null($trigger_day) && ($trigger_day > 31)) {
            throw new \InvalidArgumentException('invalid value for $trigger_day when calling InlineObject283., must be smaller than or equal to 31.');
        }
        if (!is_null($trigger_day) && ($trigger_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $trigger_day when calling InlineObject283., must be bigger than or equal to 1.');
        }
    ...
    public function setTriggerHour($trigger_hour)
    {
        ...
        if (!is_null($trigger_hour) && ($trigger_hour > 23)) {
            throw new \InvalidArgumentException('invalid value for $trigger_hour when calling InlineObject283., must be smaller than or equal to 23.');
        }
        if (!is_null($trigger_hour) && ($trigger_hour < 0)) {
            throw new \InvalidArgumentException('invalid value for $trigger_hour when calling InlineObject283., must be bigger than or equal to 0.');
        }
    ...
    public function setTriggerMinute($trigger_minute)
    {
        ...
        if (!is_null($trigger_minute) && ($trigger_minute > 59)) {
            throw new \InvalidArgumentException('invalid value for $trigger_minute when calling InlineObject283., must be smaller than or equal to 59.');
        }
        if (!is_null($trigger_minute) && ($trigger_minute < 0)) {
            throw new \InvalidArgumentException('invalid value for $trigger_minute when calling InlineObject283., must be bigger than or equal to 0.');
        }
    ...
    public function setFields($fields)
    {
        ...
        if (!is_null($fields) && (count($fields) > 5)) {
            throw new \InvalidArgumentException('invalid value for $fields when calling InlineObject283., number of items must be less than or equal to 5.');
        }
    ...
    public function setFazEventName($faz_event_name)
    {
        if (!is_null($faz_event_name) && (mb_strlen($faz_event_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $faz_event_name when calling InlineObject283., must be smaller than or equal to 255.');
        }
    ...
    public function setFazEventSeverity($faz_event_severity)
    {
        if (!is_null($faz_event_severity) && (mb_strlen($faz_event_severity) > 255)) {
            throw new \InvalidArgumentException('invalid length for $faz_event_severity when calling InlineObject283., must be smaller than or equal to 255.');
        }
    ...
    public function setFazEventTags($faz_event_tags)
    {
        if (!is_null($faz_event_tags) && (mb_strlen($faz_event_tags) > 255)) {
            throw new \InvalidArgumentException('invalid length for $faz_event_tags when calling InlineObject283., must be smaller than or equal to 255.');
        }
