 ...
 */
class InlineObject235 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMsgType($msg_type)
    {
        if (!is_null($msg_type) && (mb_strlen($msg_type) > 28)) {
            throw new \InvalidArgumentException('invalid length for $msg_type when calling InlineObject235., must be smaller than or equal to 28.');
        }
    ...
    public function setBuffer($buffer)
    {
        if (!is_null($buffer) && (mb_strlen($buffer) > 32768)) {
            throw new \InvalidArgumentException('invalid length for $buffer when calling InlineObject235., must be smaller than or equal to 32768.');
        }
