...
/**
 * InlineObject434 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject434 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_434';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject434., must be smaller than or equal to 64.');
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject434., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject434., must be bigger than or equal to 0.');
        }
    ...
    public function setLdapServer($ldap_server)
    {
        if (!is_null($ldap_server) && (mb_strlen($ldap_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ldap_server when calling InlineObject434., must be smaller than or equal to 35.');
        }
    ...
    public function setRadiusServer($radius_server)
    {
        if (!is_null($radius_server) && (mb_strlen($radius_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $radius_server when calling InlineObject434., must be smaller than or equal to 35.');
        }
    ...
    public function setTacacsServer($tacacs_server)
    {
        if (!is_null($tacacs_server) && (mb_strlen($tacacs_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $tacacs_server when calling InlineObject434., must be smaller than or equal to 35.');
        }
    ...
    public function setFortitoken($fortitoken)
    {
        if (!is_null($fortitoken) && (mb_strlen($fortitoken) > 16)) {
            throw new \InvalidArgumentException('invalid length for $fortitoken when calling InlineObject434., must be smaller than or equal to 16.');
        }
    ...
    public function setEmailTo($email_to)
    {
        if (!is_null($email_to) && (mb_strlen($email_to) > 63)) {
            throw new \InvalidArgumentException('invalid length for $email_to when calling InlineObject434., must be smaller than or equal to 63.');
        }
    ...
    public function setSmsCustomServer($sms_custom_server)
    {
        if (!is_null($sms_custom_server) && (mb_strlen($sms_custom_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sms_custom_server when calling InlineObject434., must be smaller than or equal to 35.');
        }
    ...
    public function setSmsPhone($sms_phone)
    {
        if (!is_null($sms_phone) && (mb_strlen($sms_phone) > 15)) {
            throw new \InvalidArgumentException('invalid length for $sms_phone when calling InlineObject434., must be smaller than or equal to 15.');
        }
    ...
    public function setPasswdPolicy($passwd_policy)
    {
        if (!is_null($passwd_policy) && (mb_strlen($passwd_policy) > 35)) {
            throw new \InvalidArgumentException('invalid length for $passwd_policy when calling InlineObject434., must be smaller than or equal to 35.');
        }
    ...
    public function setAuthtimeout($authtimeout)
    {
        ...
        if (!is_null($authtimeout) && ($authtimeout > 1440)) {
            throw new \InvalidArgumentException('invalid value for $authtimeout when calling InlineObject434., must be smaller than or equal to 1440.');
        }
        if (!is_null($authtimeout) && ($authtimeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $authtimeout when calling InlineObject434., must be bigger than or equal to 0.');
        }
    ...
    public function setWorkstation($workstation)
    {
        if (!is_null($workstation) && (mb_strlen($workstation) > 35)) {
            throw new \InvalidArgumentException('invalid length for $workstation when calling InlineObject434., must be smaller than or equal to 35.');
        }
    ...
    public function setAuthConcurrentValue($auth_concurrent_value)
    {
        ...
        if (!is_null($auth_concurrent_value) && ($auth_concurrent_value > 100)) {
            throw new \InvalidArgumentException('invalid value for $auth_concurrent_value when calling InlineObject434., must be smaller than or equal to 100.');
        }
        if (!is_null($auth_concurrent_value) && ($auth_concurrent_value < 0)) {
            throw new \InvalidArgumentException('invalid value for $auth_concurrent_value when calling InlineObject434., must be bigger than or equal to 0.');
        }
    ...
    public function setPpkIdentity($ppk_identity)
    {
        if (!is_null($ppk_identity) && (mb_strlen($ppk_identity) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ppk_identity when calling InlineObject434., must be smaller than or equal to 35.');
        }
