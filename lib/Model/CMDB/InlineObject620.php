...
/**
 * InlineObject620 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject620 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_620';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject620., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject620., must be smaller than or equal to 255.');
        }
    ...
    public function setPlatform($platform)
    {
        ...
        if (!is_null($platform) && (count($platform) > 0)) {
            throw new \InvalidArgumentException('invalid value for $platform when calling InlineObject620., number of items must be less than or equal to 0.');
        }
    ...
    public function setApcfgProfile($apcfg_profile)
    {
        if (!is_null($apcfg_profile) && (mb_strlen($apcfg_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $apcfg_profile when calling InlineObject620., must be smaller than or equal to 35.');
        }
    ...
    public function setBleProfile($ble_profile)
    {
        if (!is_null($ble_profile) && (mb_strlen($ble_profile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $ble_profile when calling InlineObject620., must be smaller than or equal to 35.');
        }
    ...
    public function setLan($lan)
    {
        ...
        if (!is_null($lan) && (count($lan) > 0)) {
            throw new \InvalidArgumentException('invalid value for $lan when calling InlineObject620., number of items must be less than or equal to 0.');
        }
    ...
    public function setLedSchedules($led_schedules)
    {
        ...
        if (!is_null($led_schedules) && (count($led_schedules) > 16)) {
            throw new \InvalidArgumentException('invalid value for $led_schedules when calling InlineObject620., number of items must be less than or equal to 16.');
        }
    ...
    public function setMaxClients($max_clients)
    {
        ...
        if (!is_null($max_clients) && ($max_clients > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $max_clients when calling InlineObject620., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($max_clients) && ($max_clients < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_clients when calling InlineObject620., must be bigger than or equal to 0.');
        }
    ...
    public function setHandoffRssi($handoff_rssi)
    {
        ...
        if (!is_null($handoff_rssi) && ($handoff_rssi > 30)) {
            throw new \InvalidArgumentException('invalid value for $handoff_rssi when calling InlineObject620., must be smaller than or equal to 30.');
        }
        if (!is_null($handoff_rssi) && ($handoff_rssi < 20)) {
            throw new \InvalidArgumentException('invalid value for $handoff_rssi when calling InlineObject620., must be bigger than or equal to 20.');
        }
    ...
    public function setHandoffStaThresh($handoff_sta_thresh)
    {
        ...
        if (!is_null($handoff_sta_thresh) && ($handoff_sta_thresh > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $handoff_sta_thresh when calling InlineObject620., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($handoff_sta_thresh) && ($handoff_sta_thresh < 0)) {
            throw new \InvalidArgumentException('invalid value for $handoff_sta_thresh when calling InlineObject620., must be bigger than or equal to 0.');
        }
    ...
    public function setDenyMacList($deny_mac_list)
    {
        ...
        if (!is_null($deny_mac_list) && (count($deny_mac_list) > 256)) {
            throw new \InvalidArgumentException('invalid value for $deny_mac_list when calling InlineObject620., number of items must be less than or equal to 256.');
        }
    ...
    public function setTunMtuUplink($tun_mtu_uplink)
    {
        ...
        if (!is_null($tun_mtu_uplink) && ($tun_mtu_uplink > 1500)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_uplink when calling InlineObject620., must be smaller than or equal to 1500.');
        }
        if (!is_null($tun_mtu_uplink) && ($tun_mtu_uplink < 576)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_uplink when calling InlineObject620., must be bigger than or equal to 576.');
        }
    ...
    public function setTunMtuDownlink($tun_mtu_downlink)
    {
        ...
        if (!is_null($tun_mtu_downlink) && ($tun_mtu_downlink > 1500)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_downlink when calling InlineObject620., must be smaller than or equal to 1500.');
        }
        if (!is_null($tun_mtu_downlink) && ($tun_mtu_downlink < 576)) {
            throw new \InvalidArgumentException('invalid value for $tun_mtu_downlink when calling InlineObject620., must be bigger than or equal to 576.');
        }
    ...
    public function setSplitTunnelingAcl($split_tunneling_acl)
    {
        ...
        if (!is_null($split_tunneling_acl) && (count($split_tunneling_acl) > 16)) {
            throw new \InvalidArgumentException('invalid value for $split_tunneling_acl when calling InlineObject620., number of items must be less than or equal to 16.');
        }
    ...
    public function setRadio1($radio_1)
    {
        ...
        if (!is_null($radio_1) && (count($radio_1) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_1 when calling InlineObject620., number of items must be less than or equal to 0.');
        }
    ...
    public function setRadio2($radio_2)
    {
        ...
        if (!is_null($radio_2) && (count($radio_2) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_2 when calling InlineObject620., number of items must be less than or equal to 0.');
        }
    ...
    public function setRadio3($radio_3)
    {
        ...
        if (!is_null($radio_3) && (count($radio_3) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_3 when calling InlineObject620., number of items must be less than or equal to 0.');
        }
    ...
    public function setRadio4($radio_4)
    {
        ...
        if (!is_null($radio_4) && (count($radio_4) > 0)) {
            throw new \InvalidArgumentException('invalid value for $radio_4 when calling InlineObject620., number of items must be less than or equal to 0.');
        }
    ...
    public function setLbs($lbs)
    {
        ...
        if (!is_null($lbs) && (count($lbs) > 0)) {
            throw new \InvalidArgumentException('invalid value for $lbs when calling InlineObject620., number of items must be less than or equal to 0.');
        }
