...
/**
 * InlineObject209 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject209 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_209';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject209., must be smaller than or equal to 63.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 63)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject209., must be smaller than or equal to 63.');
        }
    ...
    public function setFortilink($fortilink)
    {
        if (!is_null($fortilink) && (mb_strlen($fortilink) > 15)) {
            throw new \InvalidArgumentException('invalid length for $fortilink when calling InlineObject209., must be smaller than or equal to 15.');
        }
    ...
    public function setLldpProfile($lldp_profile)
    {
        if (!is_null($lldp_profile) && (mb_strlen($lldp_profile) > 63)) {
            throw new \InvalidArgumentException('invalid length for $lldp_profile when calling InlineObject209., must be smaller than or equal to 63.');
        }
    ...
    public function setQosPolicy($qos_policy)
    {
        if (!is_null($qos_policy) && (mb_strlen($qos_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $qos_policy when calling InlineObject209., must be smaller than or equal to 63.');
        }
    ...
    public function set8021x($_802_1x)
    {
        if (!is_null($_802_1x) && (mb_strlen($_802_1x) > 31)) {
            throw new \InvalidArgumentException('invalid length for $_802_1x when calling InlineObject209., must be smaller than or equal to 31.');
        }
    ...
    public function setVlanPolicy($vlan_policy)
    {
        if (!is_null($vlan_policy) && (mb_strlen($vlan_policy) > 63)) {
            throw new \InvalidArgumentException('invalid length for $vlan_policy when calling InlineObject209., must be smaller than or equal to 63.');
        }
