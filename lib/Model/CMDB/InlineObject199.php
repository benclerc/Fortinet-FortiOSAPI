...
/**
 * InlineObject199 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject199 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_199';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject199., must be smaller than or equal to 63.');
        }
    ...
    public function setAddressCivic($address_civic)
    {
        ...
        if (!is_null($address_civic) && (count($address_civic) > 0)) {
            throw new \InvalidArgumentException('invalid value for $address_civic when calling InlineObject199., number of items must be less than or equal to 0.');
        }
    ...
    public function setCoordinates($coordinates)
    {
        ...
        if (!is_null($coordinates) && (count($coordinates) > 0)) {
            throw new \InvalidArgumentException('invalid value for $coordinates when calling InlineObject199., number of items must be less than or equal to 0.');
        }
    ...
    public function setElinNumber($elin_number)
    {
        ...
        if (!is_null($elin_number) && (count($elin_number) > 0)) {
            throw new \InvalidArgumentException('invalid value for $elin_number when calling InlineObject199., number of items must be less than or equal to 0.');
        }
