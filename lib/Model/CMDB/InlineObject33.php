...
class InlineObject33 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject33., must be smaller than or equal to 35.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $server when calling InlineObject33., must be smaller than or equal to 35.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 35)) {
            throw new \InvalidArgumentException('invalid length for $username when calling InlineObject33., must be smaller than or equal to 35.');
        }
    ...
    public function setFilePath($file_path)
    {
        if (!is_null($file_path) && (mb_strlen($file_path) > 119)) {
            throw new \InvalidArgumentException('invalid length for $file_path when calling InlineObject33., must be smaller than or equal to 119.');
        }
    ...
    public function setFilePattern($file_pattern)
    {
        if (!is_null($file_pattern) && (mb_strlen($file_pattern) > 35)) {
            throw new \InvalidArgumentException('invalid length for $file_pattern when calling InlineObject33., must be smaller than or equal to 35.');
        }
    ...
    public function setSensitivity($sensitivity)
    {
        if (!is_null($sensitivity) && (mb_strlen($sensitivity) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sensitivity when calling InlineObject33., must be smaller than or equal to 35.');
        }
    ...
    public function setTodHour($tod_hour)
    {
        ...
        if (!is_null($tod_hour) && ($tod_hour > 23)) {
            throw new \InvalidArgumentException('invalid value for $tod_hour when calling InlineObject33., must be smaller than or equal to 23.');
        }
        if (!is_null($tod_hour) && ($tod_hour < 0)) {
            throw new \InvalidArgumentException('invalid value for $tod_hour when calling InlineObject33., must be bigger than or equal to 0.');
        }
    ...
    public function setTodMin($tod_min)
    {
        ...
        if (!is_null($tod_min) && ($tod_min > 59)) {
            throw new \InvalidArgumentException('invalid value for $tod_min when calling InlineObject33., must be smaller than or equal to 59.');
        }
        if (!is_null($tod_min) && ($tod_min < 0)) {
            throw new \InvalidArgumentException('invalid value for $tod_min when calling InlineObject33., must be bigger than or equal to 0.');
        }
    ...
    public function setDate($date)
    {
        ...
        if (!is_null($date) && ($date > 31)) {
            throw new \InvalidArgumentException('invalid value for $date when calling InlineObject33., must be smaller than or equal to 31.');
        }
        if (!is_null($date) && ($date < 1)) {
            throw new \InvalidArgumentException('invalid value for $date when calling InlineObject33., must be bigger than or equal to 1.');
        }
