...
class InlineObject71 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTag($tag)
    {
        if (!is_null($tag) && (mb_strlen($tag) > 63)) {
            throw new \InvalidArgumentException('invalid length for $tag when calling InlineObject71., must be smaller than or equal to 63.');
        }
    ...
    public function setSignature($signature)
    {
        if (!is_null($signature) && (mb_strlen($signature) > 4095)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling InlineObject71., must be smaller than or equal to 4095.');
        }
    ...
    public function setRuleId($rule_id)
    {
        ...
        if (!is_null($rule_id) && ($rule_id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling InlineObject71., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($rule_id) && ($rule_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling InlineObject71., must be bigger than or equal to 0.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 63)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject71., must be smaller than or equal to 63.');
        }
