...
/**
 * InlineObject274 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject274 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_274';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject274., must be smaller than or equal to 35.');
        }
    ...
    public function setInterval($interval)
    {
        ...
        if (!is_null($interval) && ($interval > 31557600)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling InlineObject274., must be smaller than or equal to 31557600.');
        }
        if (!is_null($interval) && ($interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling InlineObject274., must be bigger than or equal to 0.');
        }
    ...
    public function setRepeat($repeat)
    {
        ...
        if (!is_null($repeat) && ($repeat > 65535)) {
            throw new \InvalidArgumentException('invalid value for $repeat when calling InlineObject274., must be smaller than or equal to 65535.');
        }
        if (!is_null($repeat) && ($repeat < 0)) {
            throw new \InvalidArgumentException('invalid value for $repeat when calling InlineObject274., must be bigger than or equal to 0.');
        }
    ...
    public function setScript($script)
    {
        if (!is_null($script) && (mb_strlen($script) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $script when calling InlineObject274., must be smaller than or equal to 1023.');
        }
    ...
    public function setOutputSize($output_size)
    {
        ...
        if (!is_null($output_size) && ($output_size > 1024)) {
            throw new \InvalidArgumentException('invalid value for $output_size when calling InlineObject274., must be smaller than or equal to 1024.');
        }
        if (!is_null($output_size) && ($output_size < 10)) {
            throw new \InvalidArgumentException('invalid value for $output_size when calling InlineObject274., must be bigger than or equal to 10.');
        }
    ...
    public function setTimeout($timeout)
    {
        ...
        if (!is_null($timeout) && ($timeout > 300)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling InlineObject274., must be smaller than or equal to 300.');
        }
        if (!is_null($timeout) && ($timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling InlineObject274., must be bigger than or equal to 0.');
        }
