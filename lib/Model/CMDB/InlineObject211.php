 ...
 */
class InlineObject211 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject211., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject211., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject211., must be smaller than or equal to 35.');
        }
    ...
    public function setHosts($hosts)
    {
        ...
        if (!is_null($hosts) && (count($hosts) > 0)) {
            throw new \InvalidArgumentException('invalid value for $hosts when calling InlineObject211., number of items must be less than or equal to 0.');
        }
    ...
    public function setQueryV1Port($query_v1_port)
    {
        ...
        if (!is_null($query_v1_port) && ($query_v1_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $query_v1_port when calling InlineObject211., must be smaller than or equal to 65535.');
        }
        if (!is_null($query_v1_port) && ($query_v1_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $query_v1_port when calling InlineObject211., must be bigger than or equal to 0.');
        }
    ...
    public function setQueryV2cPort($query_v2c_port)
    {
        ...
        if (!is_null($query_v2c_port) && ($query_v2c_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $query_v2c_port when calling InlineObject211., must be smaller than or equal to 65535.');
        }
        if (!is_null($query_v2c_port) && ($query_v2c_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $query_v2c_port when calling InlineObject211., must be bigger than or equal to 0.');
        }
    ...
    public function setTrapV1Lport($trap_v1_lport)
    {
        ...
        if (!is_null($trap_v1_lport) && ($trap_v1_lport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $trap_v1_lport when calling InlineObject211., must be smaller than or equal to 65535.');
        }
        if (!is_null($trap_v1_lport) && ($trap_v1_lport < 0)) {
            throw new \InvalidArgumentException('invalid value for $trap_v1_lport when calling InlineObject211., must be bigger than or equal to 0.');
        }
    ...
    public function setTrapV1Rport($trap_v1_rport)
    {
        ...
        if (!is_null($trap_v1_rport) && ($trap_v1_rport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $trap_v1_rport when calling InlineObject211., must be smaller than or equal to 65535.');
        }
        if (!is_null($trap_v1_rport) && ($trap_v1_rport < 0)) {
            throw new \InvalidArgumentException('invalid value for $trap_v1_rport when calling InlineObject211., must be bigger than or equal to 0.');
        }
    ...
    public function setTrapV2cLport($trap_v2c_lport)
    {
        ...
        if (!is_null($trap_v2c_lport) && ($trap_v2c_lport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $trap_v2c_lport when calling InlineObject211., must be smaller than or equal to 65535.');
        }
        if (!is_null($trap_v2c_lport) && ($trap_v2c_lport < 0)) {
            throw new \InvalidArgumentException('invalid value for $trap_v2c_lport when calling InlineObject211., must be bigger than or equal to 0.');
        }
    ...
    public function setTrapV2cRport($trap_v2c_rport)
    {
        ...
        if (!is_null($trap_v2c_rport) && ($trap_v2c_rport > 65535)) {
            throw new \InvalidArgumentException('invalid value for $trap_v2c_rport when calling InlineObject211., must be smaller than or equal to 65535.');
        }
        if (!is_null($trap_v2c_rport) && ($trap_v2c_rport < 0)) {
            throw new \InvalidArgumentException('invalid value for $trap_v2c_rport when calling InlineObject211., must be bigger than or equal to 0.');
        }
