...
/**
 * InlineObject70 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject70 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_70';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject70., must be smaller than or equal to 35.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject70., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject70., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxConnections($max_connections)
    {
        ...
        if (!is_null($max_connections) && ($max_connections > 65535)) {
            throw new \InvalidArgumentException('invalid value for $max_connections when calling InlineObject70., must be smaller than or equal to 65535.');
        }
        if (!is_null($max_connections) && ($max_connections < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_connections when calling InlineObject70., must be bigger than or equal to 1.');
        }
