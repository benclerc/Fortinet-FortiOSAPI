 ...
 */
class InlineObject195 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject195., must be smaller than or equal to 63.');
        }
    ...
    public function setAutoIslHelloTimer($auto_isl_hello_timer)
    {
        ...
        if (!is_null($auto_isl_hello_timer) && ($auto_isl_hello_timer > 30)) {
            throw new \InvalidArgumentException('invalid value for $auto_isl_hello_timer when calling InlineObject195., must be smaller than or equal to 30.');
        }
        if (!is_null($auto_isl_hello_timer) && ($auto_isl_hello_timer < 1)) {
            throw new \InvalidArgumentException('invalid value for $auto_isl_hello_timer when calling InlineObject195., must be bigger than or equal to 1.');
        }
    ...
    public function setAutoIslReceiveTimeout($auto_isl_receive_timeout)
    {
        ...
        if (!is_null($auto_isl_receive_timeout) && ($auto_isl_receive_timeout > 90)) {
            throw new \InvalidArgumentException('invalid value for $auto_isl_receive_timeout when calling InlineObject195., must be smaller than or equal to 90.');
        }
        if (!is_null($auto_isl_receive_timeout) && ($auto_isl_receive_timeout < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_isl_receive_timeout when calling InlineObject195., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoIslPortGroup($auto_isl_port_group)
    {
        ...
        if (!is_null($auto_isl_port_group) && ($auto_isl_port_group > 9)) {
            throw new \InvalidArgumentException('invalid value for $auto_isl_port_group when calling InlineObject195., must be smaller than or equal to 9.');
        }
        if (!is_null($auto_isl_port_group) && ($auto_isl_port_group < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_isl_port_group when calling InlineObject195., must be bigger than or equal to 0.');
        }
    ...
    public function setMedNetworkPolicy($med_network_policy)
    {
        ...
        if (!is_null($med_network_policy) && (count($med_network_policy) > 0)) {
            throw new \InvalidArgumentException('invalid value for $med_network_policy when calling InlineObject195., number of items must be less than or equal to 0.');
        }
    ...
    public function setMedLocationService($med_location_service)
    {
        ...
        if (!is_null($med_location_service) && (count($med_location_service) > 0)) {
            throw new \InvalidArgumentException('invalid value for $med_location_service when calling InlineObject195., number of items must be less than or equal to 0.');
        }
    ...
    public function setCustomTlvs($custom_tlvs)
    {
        ...
        if (!is_null($custom_tlvs) && (count($custom_tlvs) > 0)) {
            throw new \InvalidArgumentException('invalid value for $custom_tlvs when calling InlineObject195., number of items must be less than or equal to 0.');
        }
