...
/**
 * InlineObject415 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject415 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_415';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject415., must be smaller than or equal to 35.');
        }
    ...
    public function setTagging($tagging)
    {
        ...
        if (!is_null($tagging) && (count($tagging) > 0)) {
            throw new \InvalidArgumentException('invalid value for $tagging when calling InlineObject415., number of items must be less than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 127)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject415., must be smaller than or equal to 127.');
        }
    ...
    public function setInterface($interface)
    {
        ...
        if (!is_null($interface) && (count($interface) > 0)) {
            throw new \InvalidArgumentException('invalid value for $interface when calling InlineObject415., number of items must be less than or equal to 0.');
        }
