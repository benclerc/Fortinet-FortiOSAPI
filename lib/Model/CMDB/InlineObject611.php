...
/**
 * InlineObject611 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject611 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_611';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject611., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject611., must be smaller than or equal to 255.');
        }
    ...
    public function setWagPort($wag_port)
    {
        ...
        if (!is_null($wag_port) && ($wag_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $wag_port when calling InlineObject611., must be smaller than or equal to 65535.');
        }
        if (!is_null($wag_port) && ($wag_port < 0)) {
            throw new \InvalidArgumentException('invalid value for $wag_port when calling InlineObject611., must be bigger than or equal to 0.');
        }
    ...
    public function setPingInterval($ping_interval)
    {
        ...
        if (!is_null($ping_interval) && ($ping_interval > 65535)) {
            throw new \InvalidArgumentException('invalid value for $ping_interval when calling InlineObject611., must be smaller than or equal to 65535.');
        }
        if (!is_null($ping_interval) && ($ping_interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $ping_interval when calling InlineObject611., must be bigger than or equal to 1.');
        }
    ...
    public function setPingNumber($ping_number)
    {
        ...
        if (!is_null($ping_number) && ($ping_number > 65535)) {
            throw new \InvalidArgumentException('invalid value for $ping_number when calling InlineObject611., must be smaller than or equal to 65535.');
        }
        if (!is_null($ping_number) && ($ping_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $ping_number when calling InlineObject611., must be bigger than or equal to 1.');
        }
    ...
    public function setReturnPacketTimeout($return_packet_timeout)
    {
        ...
        if (!is_null($return_packet_timeout) && ($return_packet_timeout > 65535)) {
            throw new \InvalidArgumentException('invalid value for $return_packet_timeout when calling InlineObject611., must be smaller than or equal to 65535.');
        }
        if (!is_null($return_packet_timeout) && ($return_packet_timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $return_packet_timeout when calling InlineObject611., must be bigger than or equal to 1.');
        }
