...
/**
 * InlineObject567 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject567 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_567';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject567., must be smaller than or equal to 35.');
        }
    ...
    public function setFriendlyName($friendly_name)
    {
        ...
        if (!is_null($friendly_name) && (count($friendly_name) > 0)) {
            throw new \InvalidArgumentException('invalid value for $friendly_name when calling InlineObject567., number of items must be less than or equal to 0.');
        }
    ...
    public function setServerUri($server_uri)
    {
        if (!is_null($server_uri) && (mb_strlen($server_uri) > 255)) {
            throw new \InvalidArgumentException('invalid length for $server_uri when calling InlineObject567., must be smaller than or equal to 255.');
        }
    ...
    public function setOsuNai($osu_nai)
    {
        if (!is_null($osu_nai) && (mb_strlen($osu_nai) > 255)) {
            throw new \InvalidArgumentException('invalid length for $osu_nai when calling InlineObject567., must be smaller than or equal to 255.');
        }
    ...
    public function setServiceDescription($service_description)
    {
        ...
        if (!is_null($service_description) && (count($service_description) > 0)) {
            throw new \InvalidArgumentException('invalid value for $service_description when calling InlineObject567., number of items must be less than or equal to 0.');
        }
    ...
    public function setIcon($icon)
    {
        if (!is_null($icon) && (mb_strlen($icon) > 35)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling InlineObject567., must be smaller than or equal to 35.');
        }
