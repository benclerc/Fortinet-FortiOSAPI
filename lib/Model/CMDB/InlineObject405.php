...
/**
 * InlineObject405 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject405 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_405';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject405., must be smaller than or equal to 15.');
        }
    ...
    public function setPhysicalSwitch($physical_switch)
    {
        if (!is_null($physical_switch) && (mb_strlen($physical_switch) > 15)) {
            throw new \InvalidArgumentException('invalid length for $physical_switch when calling InlineObject405., must be smaller than or equal to 15.');
        }
    ...
    public function setVlan($vlan)
    {
        ...
        if (!is_null($vlan) && ($vlan > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $vlan when calling InlineObject405., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($vlan) && ($vlan < 0)) {
            throw new \InvalidArgumentException('invalid value for $vlan when calling InlineObject405., must be bigger than or equal to 0.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && (count($port) > 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject405., number of items must be less than or equal to 0.');
        }
    ...
    public function setSpanSourcePort($span_source_port)
    {
        if (!is_null($span_source_port) && (mb_strlen($span_source_port) > 15)) {
            throw new \InvalidArgumentException('invalid length for $span_source_port when calling InlineObject405., must be smaller than or equal to 15.');
        }
    ...
    public function setSpanDestPort($span_dest_port)
    {
        if (!is_null($span_dest_port) && (mb_strlen($span_dest_port) > 15)) {
            throw new \InvalidArgumentException('invalid length for $span_dest_port when calling InlineObject405., must be smaller than or equal to 15.');
        }
