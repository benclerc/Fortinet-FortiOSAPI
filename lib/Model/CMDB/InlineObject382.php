...
/**
 * InlineObject382 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject382 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_382';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject382., must be smaller than or equal to 64.');
        }
    ...
    public function setAccprofile($accprofile)
    {
        if (!is_null($accprofile) && (mb_strlen($accprofile) > 35)) {
            throw new \InvalidArgumentException('invalid length for $accprofile when calling InlineObject382., must be smaller than or equal to 35.');
        }
    ...
    public function setVdom($vdom)
    {
        ...
        if (!is_null($vdom) && (count($vdom) > 0)) {
            throw new \InvalidArgumentException('invalid value for $vdom when calling InlineObject382., number of items must be less than or equal to 0.');
        }
