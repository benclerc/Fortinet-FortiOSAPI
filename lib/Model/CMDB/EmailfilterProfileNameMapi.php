...
/**
 * EmailfilterProfileNameMapi Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class EmailfilterProfileNameMapi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_emailfilter_profile__name__mapi';
     ...
     * Sets action
     *
     * @param string|null $action Action for spam email.    pass:Allow spam email to pass through.    discard:Discard (block) spam email.
     *
     * @return self
     */
