...
/**
 * InlineObject596 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject596 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_596';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject596., must be smaller than or equal to 35.');
        }
    ...
    public function setMpskConcurrentClients($mpsk_concurrent_clients)
    {
        ...
        if (!is_null($mpsk_concurrent_clients) && ($mpsk_concurrent_clients > 65535)) {
            throw new \InvalidArgumentException('invalid value for $mpsk_concurrent_clients when calling InlineObject596., must be smaller than or equal to 65535.');
        }
        if (!is_null($mpsk_concurrent_clients) && ($mpsk_concurrent_clients < 0)) {
            throw new \InvalidArgumentException('invalid value for $mpsk_concurrent_clients when calling InlineObject596., must be bigger than or equal to 0.');
        }
    ...
    public function setMpskGroup($mpsk_group)
    {
        ...
        if (!is_null($mpsk_group) && (count($mpsk_group) > 0)) {
            throw new \InvalidArgumentException('invalid value for $mpsk_group when calling InlineObject596., number of items must be less than or equal to 0.');
        }
