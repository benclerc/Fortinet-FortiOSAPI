...
/**
 * InlineObject462 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject462 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_462';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject462., must be smaller than or equal to 35.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 511)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling InlineObject462., must be smaller than or equal to 511.');
        }
    ...
    public function setScepUrl($scep_url)
    {
        if (!is_null($scep_url) && (mb_strlen($scep_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $scep_url when calling InlineObject462., must be smaller than or equal to 255.');
        }
    ...
    public function setAutoRegenerateDays($auto_regenerate_days)
    {
        ...
        if (!is_null($auto_regenerate_days) && ($auto_regenerate_days > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_regenerate_days when calling InlineObject462., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_regenerate_days) && ($auto_regenerate_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_regenerate_days when calling InlineObject462., must be bigger than or equal to 0.');
        }
    ...
    public function setAutoRegenerateDaysWarning($auto_regenerate_days_warning)
    {
        ...
        if (!is_null($auto_regenerate_days_warning) && ($auto_regenerate_days_warning > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $auto_regenerate_days_warning when calling InlineObject462., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($auto_regenerate_days_warning) && ($auto_regenerate_days_warning < 0)) {
            throw new \InvalidArgumentException('invalid value for $auto_regenerate_days_warning when calling InlineObject462., must be bigger than or equal to 0.');
        }
    ...
    public function setCaIdentifier($ca_identifier)
    {
        if (!is_null($ca_identifier) && (mb_strlen($ca_identifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $ca_identifier when calling InlineObject462., must be smaller than or equal to 255.');
        }
    ...
    public function setIkeLocalid($ike_localid)
    {
        if (!is_null($ike_localid) && (mb_strlen($ike_localid) > 63)) {
            throw new \InvalidArgumentException('invalid length for $ike_localid when calling InlineObject462., must be smaller than or equal to 63.');
        }
    ...
    public function setCmpServer($cmp_server)
    {
        if (!is_null($cmp_server) && (mb_strlen($cmp_server) > 63)) {
            throw new \InvalidArgumentException('invalid length for $cmp_server when calling InlineObject462., must be smaller than or equal to 63.');
        }
    ...
    public function setCmpPath($cmp_path)
    {
        if (!is_null($cmp_path) && (mb_strlen($cmp_path) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cmp_path when calling InlineObject462., must be smaller than or equal to 255.');
        }
    ...
    public function setCmpServerCert($cmp_server_cert)
    {
        if (!is_null($cmp_server_cert) && (mb_strlen($cmp_server_cert) > 79)) {
            throw new \InvalidArgumentException('invalid length for $cmp_server_cert when calling InlineObject462., must be smaller than or equal to 79.');
        }
