...
/**
 * InlineObject258 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject258 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_258';
    ...
    public function setMsgType($msg_type)
    {
        if (!is_null($msg_type) && (mb_strlen($msg_type) > 28)) {
            throw new \InvalidArgumentException('invalid length for $msg_type when calling InlineObject258., must be smaller than or equal to 28.');
        }
    ...
    public function setBuffer($buffer)
    {
        if (!is_null($buffer) && (mb_strlen($buffer) > 32768)) {
            throw new \InvalidArgumentException('invalid length for $buffer when calling InlineObject258., must be smaller than or equal to 32768.');
        }
