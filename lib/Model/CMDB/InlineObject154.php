...
/**
 * InlineObject154 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject154 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_154';
     ...
     * Sets name
     *
     * @param string|null $name Name of the entry.
     *
     * @return self
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject154., must be smaller than or equal to 15.');
        }
     ...
     * Sets device
     *
     * @param string|null $device Outgoing interface.
     *
     * @return self
     */
    public function setDevice($device)
    {
        if (!is_null($device) && (mb_strlen($device) > 35)) {
            throw new \InvalidArgumentException('invalid length for $device when calling InlineObject154., must be smaller than or equal to 35.');
        }
