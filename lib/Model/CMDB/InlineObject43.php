...
class InlineObject43 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject43., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject43., must be smaller than or equal to 255.');
        }
    ...
    public function setDomainFilter($domain_filter)
    {
        ...
        if (!is_null($domain_filter) && (count($domain_filter) > 0)) {
            throw new \InvalidArgumentException('invalid value for $domain_filter when calling InlineObject43., number of items must be less than or equal to 0.');
        }
    ...
    public function setFtgdDns($ftgd_dns)
    {
        ...
        if (!is_null($ftgd_dns) && (count($ftgd_dns) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ftgd_dns when calling InlineObject43., number of items must be less than or equal to 0.');
        }
    ...
    public function setExternalIpBlocklist($external_ip_blocklist)
    {
        ...
        if (!is_null($external_ip_blocklist) && (count($external_ip_blocklist) > 0)) {
            throw new \InvalidArgumentException('invalid value for $external_ip_blocklist when calling InlineObject43., number of items must be less than or equal to 0.');
        }
    ...
    public function setDnsTranslation($dns_translation)
    {
        ...
        if (!is_null($dns_translation) && (count($dns_translation) > 0)) {
            throw new \InvalidArgumentException('invalid value for $dns_translation when calling InlineObject43., number of items must be less than or equal to 0.');
        }
