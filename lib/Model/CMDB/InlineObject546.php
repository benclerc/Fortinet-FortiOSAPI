...
/**
 * InlineObject546 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject546 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_546';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject546., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject546., must be smaller than or equal to 255.');
        }
    ...
    public function setReplacemsgGroup($replacemsg_group)
    {
        if (!is_null($replacemsg_group) && (mb_strlen($replacemsg_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $replacemsg_group when calling InlineObject546., must be smaller than or equal to 35.');
        }
    ...
    public function setOverride($override)
    {
        ...
        if (!is_null($override) && (count($override) > 0)) {
            throw new \InvalidArgumentException('invalid value for $override when calling InlineObject546., number of items must be less than or equal to 0.');
        }
    ...
    public function setWeb($web)
    {
        ...
        if (!is_null($web) && (count($web) > 0)) {
            throw new \InvalidArgumentException('invalid value for $web when calling InlineObject546., number of items must be less than or equal to 0.');
        }
    ...
    public function setYoutubeChannelFilter($youtube_channel_filter)
    {
        ...
        if (!is_null($youtube_channel_filter) && (count($youtube_channel_filter) > 0)) {
            throw new \InvalidArgumentException('invalid value for $youtube_channel_filter when calling InlineObject546., number of items must be less than or equal to 0.');
        }
    ...
    public function setFtgdWf($ftgd_wf)
    {
        ...
        if (!is_null($ftgd_wf) && (count($ftgd_wf) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ftgd_wf when calling InlineObject546., number of items must be less than or equal to 0.');
        }
    ...
    public function setAntiphish($antiphish)
    {
        ...
        if (!is_null($antiphish) && (count($antiphish) > 0)) {
            throw new \InvalidArgumentException('invalid value for $antiphish when calling InlineObject546., number of items must be less than or equal to 0.');
        }
    ...
    public function setWispServers($wisp_servers)
    {
        ...
        if (!is_null($wisp_servers) && (count($wisp_servers) > 0)) {
            throw new \InvalidArgumentException('invalid value for $wisp_servers when calling InlineObject546., number of items must be less than or equal to 0.');
        }
