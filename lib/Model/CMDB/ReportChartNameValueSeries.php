...
/**
 * ReportChartNameValueSeries Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class ReportChartNameValueSeries implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_report_chart__name__value_series';
     ...
     * Sets databind
     *
     * @param string|null $databind Value series value expression.
     *
     * @return self
     */
    public function setDatabind($databind)
    {
        if (!is_null($databind) && (mb_strlen($databind) > 127)) {
            throw new \InvalidArgumentException('invalid length for $databind when calling ReportChartNameValueSeries., must be smaller than or equal to 127.');
        }
