...
/**
 * InlineObject92 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject92 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_92';
     ...
     * Sets filter
     *
     * @param string|null $filter FortiAnalyzer log filter.
     *
     * @return self
     */
    public function setFilter($filter)
    {
        if (!is_null($filter) && (mb_strlen($filter) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $filter when calling InlineObject92., must be smaller than or equal to 1023.');
        }
