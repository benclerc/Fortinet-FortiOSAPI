...
/**
 * InlineObject95 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject95 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_95';
    ...
    const DLP_ARCHIVE_ENABLE = 'enable';
    const DLP_ARCHIVE_DISABLE = 'disable';
     ...
     * @return string[]
     */
    public function getDlpArchiveAllowableValues()
    {
        return [
            self::DLP_ARCHIVE_ENABLE,
            self::DLP_ARCHIVE_DISABLE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['dlp_archive'] = $data['dlp_archive'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getDlpArchiveAllowableValues();
        if (!is_null($this->container['dlp_archive']) && !in_array($this->container['dlp_archive'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'dlp_archive', must be one of '%s'",
                $this->container['dlp_archive'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets severity
     *
     * @param string|null $severity Log every message above and including this severity level.    emergency:Emergency level.    alert:Alert level.    critical:Critical level.    error:Error level.    warning:Warning level.    notification:Notification level.    information:Information level.    debug:Debug level.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getDlpArchive()
    {
        return $this->container['dlp_archive'];
    }

    /**
     * Sets dlp_archive
     *
     * @param string|null $dlp_archive Enable/disable DLP archive logging.    enable:Enable DLP archive logging.    disable:Disable DLP archive logging.
     *
     * @return self
     */
    public function setDlpArchive($dlp_archive)
    {
        $allowedValues = $this->getDlpArchiveAllowableValues();
        if (!is_null($dlp_archive) && !in_array($dlp_archive, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'dlp_archive', must be one of '%s'",
                    $dlp_archive,
        ...
        $this->container['dlp_archive'] = $dlp_archive;
     ...
     * Sets filter
     *
     * @param string|null $filter FortiAnalyzer 2 log filter.
     *
     * @return self
     */
    public function setFilter($filter)
    {
        if (!is_null($filter) && (mb_strlen($filter) > 1023)) {
            throw new \InvalidArgumentException('invalid length for $filter when calling InlineObject95., must be smaller than or equal to 1023.');
        }
