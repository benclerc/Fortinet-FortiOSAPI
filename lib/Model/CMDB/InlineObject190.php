...
/**
 * InlineObject190 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject190 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_190';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject190., must be smaller than or equal to 63.');
        }
    ...
    public function setVlanid($vlanid)
    {
        ...
        if (!is_null($vlanid) && ($vlanid > 4094)) {
            throw new \InvalidArgumentException('invalid value for $vlanid when calling InlineObject190., must be smaller than or equal to 4094.');
        }
        if (!is_null($vlanid) && ($vlanid < 1)) {
            throw new \InvalidArgumentException('invalid value for $vlanid when calling InlineObject190., must be bigger than or equal to 1.');
        }
