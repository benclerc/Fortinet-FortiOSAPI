...
/**
 * InlineObject529 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject529 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_529';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject529., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject529., must be smaller than or equal to 255.');
        }
    ...
    public function setServerPort($server_port)
    {
        ...
        if (!is_null($server_port) && ($server_port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $server_port when calling InlineObject529., must be smaller than or equal to 65535.');
        }
        if (!is_null($server_port) && ($server_port < 1)) {
            throw new \InvalidArgumentException('invalid value for $server_port when calling InlineObject529., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxConnections($max_connections)
    {
        ...
        if (!is_null($max_connections) && ($max_connections > 4096)) {
            throw new \InvalidArgumentException('invalid value for $max_connections when calling InlineObject529., must be smaller than or equal to 4096.');
        }
        if (!is_null($max_connections) && ($max_connections < 4)) {
            throw new \InvalidArgumentException('invalid value for $max_connections when calling InlineObject529., must be bigger than or equal to 4.');
        }
    ...
    public function setTimeout($timeout)
    {
        ...
        if (!is_null($timeout) && ($timeout > 15)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling InlineObject529., must be smaller than or equal to 15.');
        }
        if (!is_null($timeout) && ($timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling InlineObject529., must be bigger than or equal to 1.');
        }
