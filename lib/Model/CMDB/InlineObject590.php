...
/**
 * InlineObject590 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject590 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_590';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject590., must be smaller than or equal to 35.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 63)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject590., must be smaller than or equal to 63.');
        }
    ...
    public function setIbeaconUuid($ibeacon_uuid)
    {
        if (!is_null($ibeacon_uuid) && (mb_strlen($ibeacon_uuid) > 63)) {
            throw new \InvalidArgumentException('invalid length for $ibeacon_uuid when calling InlineObject590., must be smaller than or equal to 63.');
        }
    ...
    public function setMajorId($major_id)
    {
        ...
        if (!is_null($major_id) && ($major_id > 65535)) {
            throw new \InvalidArgumentException('invalid value for $major_id when calling InlineObject590., must be smaller than or equal to 65535.');
        }
        if (!is_null($major_id) && ($major_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $major_id when calling InlineObject590., must be bigger than or equal to 0.');
        }
    ...
    public function setMinorId($minor_id)
    {
        ...
        if (!is_null($minor_id) && ($minor_id > 65535)) {
            throw new \InvalidArgumentException('invalid value for $minor_id when calling InlineObject590., must be smaller than or equal to 65535.');
        }
        if (!is_null($minor_id) && ($minor_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $minor_id when calling InlineObject590., must be bigger than or equal to 0.');
        }
    ...
    public function setEddystoneNamespace($eddystone_namespace)
    {
        if (!is_null($eddystone_namespace) && (mb_strlen($eddystone_namespace) > 10)) {
            throw new \InvalidArgumentException('invalid length for $eddystone_namespace when calling InlineObject590., must be smaller than or equal to 10.');
        }
    ...
    public function setEddystoneInstance($eddystone_instance)
    {
        if (!is_null($eddystone_instance) && (mb_strlen($eddystone_instance) > 6)) {
            throw new \InvalidArgumentException('invalid length for $eddystone_instance when calling InlineObject590., must be smaller than or equal to 6.');
        }
    ...
    public function setEddystoneUrl($eddystone_url)
    {
        if (!is_null($eddystone_url) && (mb_strlen($eddystone_url) > 127)) {
            throw new \InvalidArgumentException('invalid length for $eddystone_url when calling InlineObject590., must be smaller than or equal to 127.');
        }
    ...
    public function setBeaconInterval($beacon_interval)
    {
        ...
        if (!is_null($beacon_interval) && ($beacon_interval > 3500)) {
            throw new \InvalidArgumentException('invalid value for $beacon_interval when calling InlineObject590., must be smaller than or equal to 3500.');
        }
        if (!is_null($beacon_interval) && ($beacon_interval < 40)) {
            throw new \InvalidArgumentException('invalid value for $beacon_interval when calling InlineObject590., must be bigger than or equal to 40.');
        }
