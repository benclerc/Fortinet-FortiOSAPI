 ...
 */
class InlineObject228 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject228., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($id) && ($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InlineObject228., must be bigger than or equal to 0.');
        }
    ...
    public function setLeaseTime($lease_time)
    {
        ...
        if (!is_null($lease_time) && ($lease_time > 8640000)) {
            throw new \InvalidArgumentException('invalid value for $lease_time when calling InlineObject228., must be smaller than or equal to 8640000.');
        }
        if (!is_null($lease_time) && ($lease_time < 300)) {
            throw new \InvalidArgumentException('invalid value for $lease_time when calling InlineObject228., must be bigger than or equal to 300.');
        }
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 35)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling InlineObject228., must be smaller than or equal to 35.');
        }
    ...
    public function setInterface($interface)
    {
        if (!is_null($interface) && (mb_strlen($interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $interface when calling InlineObject228., must be smaller than or equal to 15.');
        }
    ...
    public function setUpstreamInterface($upstream_interface)
    {
        if (!is_null($upstream_interface) && (mb_strlen($upstream_interface) > 15)) {
            throw new \InvalidArgumentException('invalid length for $upstream_interface when calling InlineObject228., must be smaller than or equal to 15.');
        }
    ...
    public function setPrefixRange($prefix_range)
    {
        ...
        if (!is_null($prefix_range) && (count($prefix_range) > 0)) {
            throw new \InvalidArgumentException('invalid value for $prefix_range when calling InlineObject228., number of items must be less than or equal to 0.');
        }
    ...
    public function setIpRange($ip_range)
    {
        ...
        if (!is_null($ip_range) && (count($ip_range) > 0)) {
            throw new \InvalidArgumentException('invalid value for $ip_range when calling InlineObject228., number of items must be less than or equal to 0.');
        }
