...
/**
 * InlineObject450 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject450 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_450';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject450., must be smaller than or equal to 35.');
        }
    ...
    public function setCert($cert)
    {
        if (!is_null($cert) && (mb_strlen($cert) > 35)) {
            throw new \InvalidArgumentException('invalid length for $cert when calling InlineObject450., must be smaller than or equal to 35.');
        }
    ...
    public function setEntityId($entity_id)
    {
        if (!is_null($entity_id) && (mb_strlen($entity_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $entity_id when calling InlineObject450., must be smaller than or equal to 255.');
        }
    ...
    public function setSingleSignOnUrl($single_sign_on_url)
    {
        if (!is_null($single_sign_on_url) && (mb_strlen($single_sign_on_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $single_sign_on_url when calling InlineObject450., must be smaller than or equal to 255.');
        }
    ...
    public function setSingleLogoutUrl($single_logout_url)
    {
        if (!is_null($single_logout_url) && (mb_strlen($single_logout_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $single_logout_url when calling InlineObject450., must be smaller than or equal to 255.');
        }
    ...
    public function setIdpEntityId($idp_entity_id)
    {
        if (!is_null($idp_entity_id) && (mb_strlen($idp_entity_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $idp_entity_id when calling InlineObject450., must be smaller than or equal to 255.');
        }
    ...
    public function setIdpSingleSignOnUrl($idp_single_sign_on_url)
    {
        if (!is_null($idp_single_sign_on_url) && (mb_strlen($idp_single_sign_on_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $idp_single_sign_on_url when calling InlineObject450., must be smaller than or equal to 255.');
        }
    ...
    public function setIdpSingleLogoutUrl($idp_single_logout_url)
    {
        if (!is_null($idp_single_logout_url) && (mb_strlen($idp_single_logout_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $idp_single_logout_url when calling InlineObject450., must be smaller than or equal to 255.');
        }
    ...
    public function setIdpCert($idp_cert)
    {
        if (!is_null($idp_cert) && (mb_strlen($idp_cert) > 35)) {
            throw new \InvalidArgumentException('invalid length for $idp_cert when calling InlineObject450., must be smaller than or equal to 35.');
        }
    ...
    public function setUserName($user_name)
    {
        if (!is_null($user_name) && (mb_strlen($user_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling InlineObject450., must be smaller than or equal to 35.');
        }
    ...
    public function setGroupName($group_name)
    {
        if (!is_null($group_name) && (mb_strlen($group_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling InlineObject450., must be smaller than or equal to 35.');
        }
