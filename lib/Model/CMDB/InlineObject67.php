...
class InlineObject67 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setReplacemsgGroup($replacemsg_group)
    {
        if (!is_null($replacemsg_group) && (mb_strlen($replacemsg_group) > 35)) {
            throw new \InvalidArgumentException('invalid length for $replacemsg_group when calling InlineObject67., must be smaller than or equal to 35.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject67., must be smaller than or equal to 35.');
        }
    ...
    public function setPreviewDataLength($preview_data_length)
    {
        ...
        if (!is_null($preview_data_length) && ($preview_data_length > 4096)) {
            throw new \InvalidArgumentException('invalid value for $preview_data_length when calling InlineObject67., must be smaller than or equal to 4096.');
        }
        if (!is_null($preview_data_length) && ($preview_data_length < 0)) {
            throw new \InvalidArgumentException('invalid value for $preview_data_length when calling InlineObject67., must be bigger than or equal to 0.');
        }
    ...
    public function setRequestServer($request_server)
    {
        if (!is_null($request_server) && (mb_strlen($request_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $request_server when calling InlineObject67., must be smaller than or equal to 35.');
        }
    ...
    public function setResponseServer($response_server)
    {
        if (!is_null($response_server) && (mb_strlen($response_server) > 35)) {
            throw new \InvalidArgumentException('invalid length for $response_server when calling InlineObject67., must be smaller than or equal to 35.');
        }
    ...
    public function setRequestPath($request_path)
    {
        if (!is_null($request_path) && (mb_strlen($request_path) > 127)) {
            throw new \InvalidArgumentException('invalid length for $request_path when calling InlineObject67., must be smaller than or equal to 127.');
        }
    ...
    public function setResponsePath($response_path)
    {
        if (!is_null($response_path) && (mb_strlen($response_path) > 127)) {
            throw new \InvalidArgumentException('invalid length for $response_path when calling InlineObject67., must be smaller than or equal to 127.');
        }
    ...
    public function setIcapHeaders($icap_headers)
    {
        ...
        if (!is_null($icap_headers) && (count($icap_headers) > 0)) {
            throw new \InvalidArgumentException('invalid value for $icap_headers when calling InlineObject67., number of items must be less than or equal to 0.');
        }
    ...
    public function setRespmodForwardRules($respmod_forward_rules)
    {
        ...
        if (!is_null($respmod_forward_rules) && (count($respmod_forward_rules) > 0)) {
            throw new \InvalidArgumentException('invalid value for $respmod_forward_rules when calling InlineObject67., number of items must be less than or equal to 0.');
        }
