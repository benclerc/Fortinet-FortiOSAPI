...
/**
 * InlineObject336 Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject336 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_336';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject336., must be smaller than or equal to 35.');
        }
    ...
    public function setSrcintf($srcintf)
    {
        if (!is_null($srcintf) && (mb_strlen($srcintf) > 15)) {
            throw new \InvalidArgumentException('invalid length for $srcintf when calling InlineObject336., must be smaller than or equal to 15.');
        }
    ...
    public function setServer($server)
    {
        ...
        if (!is_null($server) && (count($server) > 0)) {
            throw new \InvalidArgumentException('invalid value for $server when calling InlineObject336., number of items must be less than or equal to 0.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject336., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling InlineObject336., must be bigger than or equal to 1.');
        }
    ...
    public function setHttpGet($http_get)
    {
        if (!is_null($http_get) && (mb_strlen($http_get) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $http_get when calling InlineObject336., must be smaller than or equal to 1024.');
        }
    ...
    public function setHttpAgent($http_agent)
    {
        if (!is_null($http_agent) && (mb_strlen($http_agent) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $http_agent when calling InlineObject336., must be smaller than or equal to 1024.');
        }
    ...
    public function setHttpMatch($http_match)
    {
        if (!is_null($http_match) && (mb_strlen($http_match) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $http_match when calling InlineObject336., must be smaller than or equal to 1024.');
        }
    ...
    public function setInterval($interval)
    {
        ...
        if (!is_null($interval) && ($interval > 3600000)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling InlineObject336., must be smaller than or equal to 3600000.');
        }
        if (!is_null($interval) && ($interval < 500)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling InlineObject336., must be bigger than or equal to 500.');
        }
    ...
    public function setProbeTimeout($probe_timeout)
    {
        ...
        if (!is_null($probe_timeout) && ($probe_timeout > 5000)) {
            throw new \InvalidArgumentException('invalid value for $probe_timeout when calling InlineObject336., must be smaller than or equal to 5000.');
        }
        if (!is_null($probe_timeout) && ($probe_timeout < 500)) {
            throw new \InvalidArgumentException('invalid value for $probe_timeout when calling InlineObject336., must be bigger than or equal to 500.');
        }
    ...
    public function setFailtime($failtime)
    {
        ...
        if (!is_null($failtime) && ($failtime > 3600)) {
            throw new \InvalidArgumentException('invalid value for $failtime when calling InlineObject336., must be smaller than or equal to 3600.');
        }
        if (!is_null($failtime) && ($failtime < 1)) {
            throw new \InvalidArgumentException('invalid value for $failtime when calling InlineObject336., must be bigger than or equal to 1.');
        }
    ...
    public function setRecoverytime($recoverytime)
    {
        ...
        if (!is_null($recoverytime) && ($recoverytime > 3600)) {
            throw new \InvalidArgumentException('invalid value for $recoverytime when calling InlineObject336., must be smaller than or equal to 3600.');
        }
        if (!is_null($recoverytime) && ($recoverytime < 1)) {
            throw new \InvalidArgumentException('invalid value for $recoverytime when calling InlineObject336., must be bigger than or equal to 1.');
        }
    ...
    public function setProbeCount($probe_count)
    {
        ...
        if (!is_null($probe_count) && ($probe_count > 30)) {
            throw new \InvalidArgumentException('invalid value for $probe_count when calling InlineObject336., must be smaller than or equal to 30.');
        }
        if (!is_null($probe_count) && ($probe_count < 5)) {
            throw new \InvalidArgumentException('invalid value for $probe_count when calling InlineObject336., must be bigger than or equal to 5.');
        }
    ...
    public function setPacketSize($packet_size)
    {
        ...
        if (!is_null($packet_size) && ($packet_size > 1024)) {
            throw new \InvalidArgumentException('invalid value for $packet_size when calling InlineObject336., must be smaller than or equal to 1024.');
        }
        if (!is_null($packet_size) && ($packet_size < 64)) {
            throw new \InvalidArgumentException('invalid value for $packet_size when calling InlineObject336., must be bigger than or equal to 64.');
        }
    ...
    public function setHaPriority($ha_priority)
    {
        ...
        if (!is_null($ha_priority) && ($ha_priority > 50)) {
            throw new \InvalidArgumentException('invalid value for $ha_priority when calling InlineObject336., must be smaller than or equal to 50.');
        }
        if (!is_null($ha_priority) && ($ha_priority < 1)) {
            throw new \InvalidArgumentException('invalid value for $ha_priority when calling InlineObject336., must be bigger than or equal to 1.');
        }
