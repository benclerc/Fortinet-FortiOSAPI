...
/**
 * SystemPtpApi Class Doc Comment
 *
 * @category Class
 * @package  Fortigate\FortiOS
 * @author   OpenAPI Generator team
...
class SystemPtpApi
{
     ...
     * @return object
     */
    public function systemPtpGet($datasource = null, $start = null, $count = null, $with_meta = null, $with_contents_hash = null, $skip = null, $format = null, $filter = null, $key = null, $pattern = null, $scope = null, $exclude_default_values = null, $action = null, $vdom = null)
    {
        list($response) = $this->systemPtpGetWithHttpInfo($datasource, $start, $count, $with_meta, $with_contents_hash, $skip, $format, $filter, $key, $pattern, $scope, $exclude_default_values, $action, $vdom);
        return $response;
    }

    /**
     * Operation systemPtpGetWithHttpInfo
     *
     * Select all entries in a CLI table.  Access Group: sysgrp
     *
     * @param  bool $datasource Enable to include datasource information for each linked object. (optional)
     ...
     */
    public function systemPtpGetWithHttpInfo($datasource = null, $start = null, $count = null, $with_meta = null, $with_contents_hash = null, $skip = null, $format = null, $filter = null, $key = null, $pattern = null, $scope = null, $exclude_default_values = null, $action = null, $vdom = null)
    {
        $request = $this->systemPtpGetRequest($datasource, $start, $count, $with_meta, $with_contents_hash, $skip, $format, $filter, $key, $pattern, $scope, $exclude_default_values, $action, $vdom);
     ...
     */
    public function systemPtpGetAsync($datasource = null, $start = null, $count = null, $with_meta = null, $with_contents_hash = null, $skip = null, $format = null, $filter = null, $key = null, $pattern = null, $scope = null, $exclude_default_values = null, $action = null, $vdom = null)
    {
        return $this->systemPtpGetAsyncWithHttpInfo($datasource, $start, $count, $with_meta, $with_contents_hash, $skip, $format, $filter, $key, $pattern, $scope, $exclude_default_values, $action, $vdom)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation systemPtpGetAsyncWithHttpInfo
     *
     * Select all entries in a CLI table.  Access Group: sysgrp
     *
     * @param  bool $datasource Enable to include datasource information for each linked object. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemPtpGetAsyncWithHttpInfo($datasource = null, $start = null, $count = null, $with_meta = null, $with_contents_hash = null, $skip = null, $format = null, $filter = null, $key = null, $pattern = null, $scope = null, $exclude_default_values = null, $action = null, $vdom = null)
    {
        $returnType = 'object';
        $request = $this->systemPtpGetRequest($datasource, $start, $count, $with_meta, $with_contents_hash, $skip, $format, $filter, $key, $pattern, $scope, $exclude_default_values, $action, $vdom);
    ...
    /**
     * Create request for operation 'systemPtpGet'
     *
     * @param  bool $datasource Enable to include datasource information for each linked object. (optional)
     * @param  int $start Starting entry index. (optional)
     * @param  int $count Maximum number of entries to return. (optional)
     ...
     */
    public function systemPtpGetRequest($datasource = null, $start = null, $count = null, $with_meta = null, $with_contents_hash = null, $skip = null, $format = null, $filter = null, $key = null, $pattern = null, $scope = null, $exclude_default_values = null, $action = null, $vdom = null)
    {

        $resourcePath = '/system/ptp';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation systemPtpPut
     *
     * Update this specific resource.  Access Group: sysgrp
     *
     * @param  \Fortigate\FortiOS\Model\CMDB\InlineObject361 $body body (required)
     * @param  string[] $vdom Specify the Virtual Domain(s) from which results are returned or changes are applied to. If this parameter is not provided, the management VDOM will be used. If the admin does not have access to the VDOM, a permission error will be returned. The URL parameter is one of: vdom&#x3D;root (Single VDOM) vdom&#x3D;vdom1,vdom2 (Multiple VDOMs) vdom&#x3D;* (All VDOMs) (optional)
     ...
     * @return void
     */
    public function systemPtpPut($body, $vdom = null, $action = null, $before = null, $after = null)
    {
        $this->systemPtpPutWithHttpInfo($body, $vdom, $action, $before, $after);
    }

    /**
     * Operation systemPtpPutWithHttpInfo
     *
     * Update this specific resource.  Access Group: sysgrp
     *
     * @param  \Fortigate\FortiOS\Model\CMDB\InlineObject361 $body (required)
     * @param  string[] $vdom Specify the Virtual Domain(s) from which results are returned or changes are applied to. If this parameter is not provided, the management VDOM will be used. If the admin does not have access to the VDOM, a permission error will be returned. The URL parameter is one of: vdom&#x3D;root (Single VDOM) vdom&#x3D;vdom1,vdom2 (Multiple VDOMs) vdom&#x3D;* (All VDOMs) (optional)
     * @param  string $action If supported, an action can be specified. _move_: Move this specific resource. When *action&#x3D;move* is set, one of the extra parameters (*before*, *after*) must be provided. __*Note:*__ If this parameter is provided when not supported, the action will be ignored and an “invalid request” error will be returned. (optional)
     * @param  string $before If *action&#x3D;move*, use *before* to specify the ID of the resource that this resource will be moved before. For example, to move &#x60;object 1&#x60; to before &#x60;object 2&#x60;, use: __action&#x3D;move&amp;before&#x3D;2__ __*Note:*__ This parameter can only be used when the *action* parameter is set to *move*. (optional)
     * @param  string $after If *action&#x3D;move*, use *after* to specify the ID of the resource that this resource will be moved after. For example, to move &#x60;object 1&#x60; to after &#x60;object 3&#x60;, use: __action&#x3D;move&amp;after&#x3D;3__ __*Note:*__ This parameter can only be used when the *action* parameter is set to *move*. (optional)
     ...
     */
    public function systemPtpPutWithHttpInfo($body, $vdom = null, $action = null, $before = null, $after = null)
    {
        $request = $this->systemPtpPutRequest($body, $vdom, $action, $before, $after);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemPtpPutAsync($body, $vdom = null, $action = null, $before = null, $after = null)
    {
        return $this->systemPtpPutAsyncWithHttpInfo($body, $vdom, $action, $before, $after)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation systemPtpPutAsyncWithHttpInfo
     *
     * Update this specific resource.  Access Group: sysgrp
     *
     * @param  \Fortigate\FortiOS\Model\CMDB\InlineObject361 $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemPtpPutAsyncWithHttpInfo($body, $vdom = null, $action = null, $before = null, $after = null)
    {
        $returnType = '';
        $request = $this->systemPtpPutRequest($body, $vdom, $action, $before, $after);
    ...
    /**
     * Create request for operation 'systemPtpPut'
     *
     * @param  \Fortigate\FortiOS\Model\CMDB\InlineObject361 $body (required)
     * @param  string[] $vdom Specify the Virtual Domain(s) from which results are returned or changes are applied to. If this parameter is not provided, the management VDOM will be used. If the admin does not have access to the VDOM, a permission error will be returned. The URL parameter is one of: vdom&#x3D;root (Single VDOM) vdom&#x3D;vdom1,vdom2 (Multiple VDOMs) vdom&#x3D;* (All VDOMs) (optional)
     * @param  string $action If supported, an action can be specified. _move_: Move this specific resource. When *action&#x3D;move* is set, one of the extra parameters (*before*, *after*) must be provided. __*Note:*__ If this parameter is provided when not supported, the action will be ignored and an “invalid request” error will be returned. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function systemPtpPutRequest($body, $vdom = null, $action = null, $before = null, $after = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling systemPtpPut'
            );
        }
